...
GoBooks 是为各个级别的开发人员（从初学者到致力于并发、性能和系统设计的工程师）精选的最佳 Go 书籍合集。一个可以找到合适学习资源的地方。
...
- [最受欢迎的 Golang 书籍](#most-popular-go-books)
- [入门书籍](#starter-books)
- [进阶书籍](#advanced-books)
...
> 基于 Amazon、Goodreads 和 Go 社区的社区评分、专家推荐和开发者共识的最受欢迎和高度推荐的 Go 书籍
