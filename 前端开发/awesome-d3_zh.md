# 很棒的D3 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

此列表跟踪有趣的 [D3js](http://d3js.org) 库、插件和实用程序。
...
策展人：[webkid.io](http://www.webkid.io) 的 [Moritz Klack](https://twitter.com/moklick) 和 [Christopher Möller](https://twitter.com/chrtze)

您还可以使用我们的交互式 [D3 Discovery](https://d3-discovery.net/) 工具浏览该列表。


## 图表

- [billboard.js](https://github.com/naver/billboard.js) - 可重复使用的图表库 [条形图、折线图、面积图、圆环图、饼图、阶梯图、样条图]
- [britecharts](https://github.com/britecharts/britecharts) - 客户端可重用图表库 [条形图、折线图、圆环图、迷你图、步骤图]
- [chart-parts](https://github.com/Microsoft/chart-parts) - 用于数据可视化的灵活、反应友好的图形语法
- [cubism](https://github.com/square/cubism) - 时间序列可视化
- [c3](https://github.com/c3js/c3) - 可重复使用的图表库[线、样条线、步长、面积、堆叠、条形图、饼图、圆环图]
...
- [d3-bumps-chart](https://github.com/johnwalley/d3-bumps-chart) - 用于可视化凹凸图的插件
- [d3-dag](https://github.com/erikbrinkman/d3-dag) - 用于可视化有向无环图的布局算法
- [d3-ez](https://github.com/jamesleesaunders/d3-ez) - 易于重复使用的 D3 图表和组件 [条形图、甜甜圈图、饼图、气泡图、玫瑰图、热图]
- [d3-flame-graph](https://github.com/spiermar/d3-flame-graph) - 来自分层数据的火焰图
- [d3-funnel](https://github.com/jakezatecky/d3-funnel) - 漏斗图和金字塔图库
- [d3-gridding](https://github.com/romsson/d3-gridding) - 使用网格绘制图表模型
- [d3-heatmap](https://github.com/tj/d3-heatmap) - 热图
- [d3-message-sequence](https://github.com/koudelka/d3-message-sequence) - 动态/静态消息序列图
- [d3-upset](https://github.com/chuntul/d3-upset) - 用于绘制 UpSet 图的函数 [upset、bar、intersections、venn、relationships]
- [d3-x3d](https://github.com/jamesleesaunders/d3-x3d) - 使用 D3 和 X3D 的数据驱动 3D 图表 [气泡图、条形图、表面积、散点图、面积]
- [d3fc](https://github.com/d3fc/d3fc) - 交互式图表组件的集合 [line、bar、stacked、scatter、k 线、ohlc]
- [d3plus](https://github.com/alexandersimoes/d3plus) - 用于轻松创建可视化的扩展库 [散点图、堆叠图、线图、条形图、饼图、网络图、气泡图、方框图、地图]
- [d3panels](https://github.com/kbroman/d3panels) - 带有链接刷的交互式图表[点、散点图、线、热图、直方图]
- [d3pie](https://github.com/benkeen/d3pie) - 可配置的饼图库和生成器
- [D3xter](https://github.com/NathanEpstein/D3xter) - 直接绘图[绘图、时间线、条形图、直方图、饼图]
- [D4](https://github.com/heavysixer/d4) - 可重复使用的图表 DSL [条形图、圆环图、折线图、散点图、堆叠图、瀑布图]
- [dTree](https://github.com/ErikGartner/dTree) - 家谱库
- [EventDrops](https://github.com/marmelab/EventDrops) - 基于时间/事件系列的交互式可视化
- [metrics-graphics](https://github.com/metricsgraphics/metrics-graphics) - 针对时间序列数据的可视化进行了优化[线、散点、面积]
...
- [nvd3](https://github.com/novus/nvd3) - 可重复使用的图表和图表组件 [箱线图、巴特图、烛台、折线图、条形图、饼图、散点图、迷你图]
...
- [plottable](https://github.com/palantir/plottable) - 灵活的交互式网络图表 [面积图、条形图、折线图、饼图、散点图、堆积图]
- [rickshaw](https://github.com/shutterstock/rickshaw) - 用于创建交互式实时图表的工具包 [折线图、散点图、条形图]
- [taucharts](https://github.com/TargetProcess/tauCharts) - 注重设计和灵活性的图表 [折线图、条形图、面积图、堆叠图]
...
- [xkcdgraphs](https://github.com/imkevinxu/xkcdgraphs) - Xkcd风格图表[线]

##### 第三方

- [Layer Cake](https://github.com/mhkeller/layercake) - 构建在 Svelte 之上的图形框架。
- [nivo](https://github.com/plouc/nivo) - 具有同构能力的 React Dataviz 组件 [条形图、线形图、面积图、气泡图、弦图、热图]
- [ngx-charts](https://github.com/swimlane/ngx-charts) - Angular 的图表框架 [条形图、饼图、折线图、面积图、极坐标图、堆叠图、气泡图]
- [potion](https://github.com/finnfiddle/potion) - 用于组合可视化的 React 组件集合
- [react-d3-components](https://github.com/codesuki/react-d3-components) - D3 组件 [条形图、堆积图、散点图、线图、面积图、饼图]
- [react-d3-library](https://github.com/react-d3-library/react-d3-library) - 在 React 中使用 D3 的库 [面积、条形、线形、饼形、散点]
- [react-stockcharts](https://github.com/rrag/react-stockcharts) - 高度可定制的股票图表[面积图、折线图、散点图、气泡图、条形图、堆积图、烛台图]
- [react-vis](https://github.com/uber/react-vis) - 用于渲染可视化的 React 组件的集合 [区域、条形图、热图、线、散点图]
- [reaviz](https://github.com/reaviz/reaviz) - 基于D3的React数据可视化库
- [recharts](https://github.com/recharts/recharts) - 使用 React 重新设计的图表库
- [semiotic](https://github.com/nteract/semiotic) - 结合React & D3的数据可视化框架【散点、线型、面积】
- [victory](https://github.com/FormidableLabs/victory) - 用于构建可视化的可组合 React 组件 [面积、条形图、烛台、饼图、线图、散点图、voronoi]
- [vx](https://github.com/hshoff/vx) - React 的可视化组件 [条形图、折线图、散点图、堆叠图、面积图、图案、热图、饼图、径向图、地图、地理图]
- [Vs](https://github.com/GopherJ/Vs) - Vue.js 的声明式可视化组件 [bar、line、area、pie、donut、stacked、sankey、timeline]
- [v-chart-plugin](https://github.com/ignoreintuition/v-chart-plugin) - 轻松将图表绑定到 Vue.js 组件中存储的数据。


## 地图

- [d3-composite-projections](https://github.com/rveciana/d3-composite-projections) - 将国家遥远的土地连在一起的投影
...
- [d3-exploder](https://github.com/bsouthga/d3-exploder) - 让您轻松移动地理要素并调整其大小
- [d3-geo-polygon](https://github.com/d3/d3-geo-polygon) - 球面多边形的裁剪和几何操作
...
- [leaflet-d3](https://github.com/Asymmetrik/leaflet-d3) - 将 D3 与 Leaflet 结合使用的插件集合 [地图、地理]
- [Wikimaps-D3js Atlas](https://github.com/WikimapsAtlas/WikimapsAtlas-generator) - CLI 用于生成栅格、topojson 和 svg 地图 [地图、地理]
- [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) - React 的 SVG 映射组件库，构建于 d3-geo [map, geo] 之上
...
- [d3-voronoi-treemap](https://github.com/Kcnarf/d3-voronoi-treemap) - 基于 Voronoi 曲面细分计算树形图
- [d3-xray](https://github.com/vijithassar/d3-xray) - 当鼠标悬停时记录数据连接结果的书签
...
- [d3-force-gravity](https://github.com/sohamkamani/d3-force-gravity) - 实现万有引力（或类似力场的斥力）
- [d3-force-reuse](https://github.com/twosixlabs/d3-force-reuse) - 通过重用力近似来实现更快的力导向图形布局
- [d3-force-sampled](https://github.com/twosixlabs/d3-force-sampled) - 通过随机顶点采样实现超快速、线性时间力导向图形布局
...
- [mermaid](https://github.com/knsv/mermaid) - 从 Markdown 风格的文本生成图表和流程图
 ...
 * [亚当·皮尔斯 - 1wheel](https://bl.ocks.org/1wheel)
 * [科林·艾伯哈特 - 科林·艾伯哈特](https://bl.ocks.org/ColinEberhardt)
 * [哈里·史蒂文斯 - 哈里·史蒂文斯](https://bl.ocks.org/HarryStevens)
 * [路易斯·塞维利亚诺 - 路易斯·塞维利亚诺](https://bl.ocks.org/LuisSevillano)
 * [彼得·库克 - d3indeep](https://bl.ocks.org/d3indepth)
 * [伊利亚·米克斯 - emeeks](https://bl.ocks.org/emeeks)
 * [伊恩·约翰逊 - enjalot](https://bl.ocks.org/enjalot)
 * [菲利普·里维埃尔 - fil](https://bl.ocks.org/fil)
 * [迈克·博斯托克 - mbostock](https://bl.ocks.org/mbostock)
 * [马泰奥·菲利波尼 - mfilippo](https://bl.ocks.org/mfilippo)
 * [米卡·斯塔布斯 - micahstubbs](https://bl.ocks.org/micahstubbs)
 * [纳迪·布雷默 - nbremer](https://bl.ocks.org/nbremer)
 * [Matteo Abrate - 尼塔库](https://bl.ocks.org/nitaku)
 * [苏茜露 - 苏茜露](https://bl.ocks.org/susielu)
 * [吴雪莉 - sxywu](https://bl.ocks.org/sxywu)
 * [凯昌 - 组合](https://bl.ocks.org/syntagmatic)
 * [汤姆·尚利 - 汤姆·尚利](https://bl.ocks.org/tomshanley)
 * [瓦斯科·阿斯图里亚诺 - 瓦斯图里亚诺](https://bl.ocks.org/vasturiano)
 * [诺亚·维尔特曼 - 维尔特曼](https://bl.ocks.org/veltman)
 * [赞阿姆斯特朗 - 扎阿姆斯特朗](https://bl.ocks.org/zanarmstrong)
