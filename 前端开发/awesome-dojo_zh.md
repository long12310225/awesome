...
很棒的 [Dojo JavaScript Toolkit](http://dojotoolkit.org) 库、资源和其他闪亮东西的精选列表。

受到 GitHub 上“awesome-*”趋势的启发。

> 一个 JavaScript 工具包，可以节省您的时间并随着您的开发过程进行扩展。提供构建 Web 应用程序所需的一切。语言实用程序、UI 组件等全部集中在一处，旨在完美协同工作。


## 索引

* [DojoToolkit.org 资源和文档](#dojotoolkitorg-resources-and-documentation)
* [Tutorials](#tutorials)
* [引导程序和样板文件](#bootstraps-and-boilerplates)
* [包、库和脚本](#packages-libraries-and-scripts)
* [服务器端集成](#serverside-integrations)
* [Testing](#testing)
...
## DojoToolkit.org 资源和文档

* [API](http://dojotoolkit.org/api/) - Dojo Toolkit 的 API 参考
* [路线图](https://github.com/dojo/meta/wiki/Roadmap) Dojo 路线图（所有版本）
...
* [Dojo and Bootstrap FAQ](https://www.sitepen.com/blog/2014/08/13/dojo-faq-how-do-i-use-bootstrap-with-dijit/) - 如何将 Bootstrap 与 Dijit 一起使用
* [Dojo Toolkit 1.9 tutorial](https://github.com/cepa/dojo-tutorial) - 使用 Dojo Toolkit 1.9 的教程
* [Dojo the Good parts](https://github.com/DavidSpriggs/Dojo--The-Good-Parts) - ESRI 开发者峰会演讲于 2014 年 3 月 10 日至 13 日在棕榈泉举行。
* [Pluralsight's Dojo tutorial](https://www.pluralsight.com/courses/dojo-fundamentals) - 用于学习 Dojo Toolkit 的视频教程
...
* [dboostrap](https://github.com/atoha/dbootstrap) - Dojo 的 Bootstrap 主题
...
* [dojo.js](https://github.com/gpedro/dojo.js) - 用 Jasmine 和 Gulp 开始你的道场的简约样板。
...
* [AngularJS Dojo](https://github.com/adrobisch/angular-dojo) - dojo 小部件的 AngularJS 指令
* [delite](https://github.com/ibm-js/delite) - HTML 自定义元素/小部件基础设施
* [deliteful](https://github.com/ibm-js/deliteful) - 多渠道（桌面/移动）UI 自定义元素库
* [Dojo Foundation packages](http://packages.dojofoundation.org/) - Dojo Foundation 提供的软件包
...
* 网格
    ...
    * [gridx](http://oria.github.io/gridx/) - 一个快速渲染、良好模块化和基于插件架构的网格。
...
* [karma-dojo](https://github.com/garcimouche/karma-dojo) - 一个 [Karma](http://karma-runner.github.io/) 插件。 Dojo 工具包的适配器。
* [Leadfoot](https://github.com/theintern/leadfoot) - 一个 JavaScript 客户端库，为 Selenium WebDriver API 带来跨平台一致性
* [Sitepen dstore](https://github.com/SitePen/dstore) - 数据基础架构框架，提供用于建模以及与数据集合和对象交互的工具。
...
* [Dojo loader](https://github.com/dojo/loader) - Dojo2 的 AMD 加载程序。
...
* [Dojo shim](https://github.com/dojo/shim) - 提供 ES6+ 功能的模块化填充的模块
* [Dojo parse](https://github.com/dojo/parser) - 用于以声明方式实例化小部件的包。
...
* [Dojo Maven](https://github.com/cometd/dojo-maven) - Dojo 工具包的 Maven 打包
* ASP.NET
    ...
    * [Dojo.NET](https://github.com/lstratman/Dojo.NET) - .NET 类库，使用 Dojo 工具包提供到 ASP.NET 网站（WebForms 和 MVC，包括 Razor）的 WebControl 绑定。
    * [Reactive Extensions](https://github.com/Reactive-Extensions/RxJS-Dojo) - Dojo Toolkit 的响应式扩展绑定
* 爪哇
    * [Dojofaces](http://www.dojofaces.org) - 帮助 JSF 开发人员将 Dojo 小部件与 JSF 支持 bean 连接的项目
    * [DWR](http://directwebremoting.org/dwr/index.html) - 在服务器上启用 Java 并在浏览器中启用 JavaScript 的库
    * [Grails](https://grails.org/) - 开源全栈 Web 应用程序框架，通过 [插件] 支持 Dojo(http://grails.org/plugin/dojo)
    * [LightStreamer](http://www.lightstreamer.com/) - 集成 Dojo 的服务器
    * [Spring](https://www.sitepen.com/blog/2011/08/11/how-do-you-use-the-dojo-store-jsonrest-api-with-spring/) - 如何集成 Spring 和 Dojo
    * [Websphere](http://www-03.ibm.com/software/products/en/appserv-was) - 应用服务器集成了Dojo
* 节点.js
    * [dojo-node](https://github.com/agebrock/dojo-node) - Node.js 的 Lightwave Dojo 包装器
    * [Dojos](https://github.com/supnate/dojos) - NodeJS 上的服务器端 dojo
    * [Node.js integration](http://dojotoolkit.org/documentation/tutorials/1.10/node/) - 教程如何使用 Dojo 和 Node.js
* PHP
    * [Dojo & Composer](https://github.com/zoopcommerce/pixie) - Zoop 软件包（包括 Dojo）的自定义 Composer 安装程序
...
* [Intern](https://github.com/theintern/) - JavaScript 的下一代代码测试堆栈。
...
* [Intern Yeoman generator](https://github.com/naglalakk/generator-intern) - Yeoman 生成器 - 实习生
...
* [Dojox application](https://github.com/dmachi/dojox_application) - 适用于移动设备、平板电脑和台式机的 Dojox 应用程序框架
* [js-doc-parse](https://github.com/dojo/js-doc-parse) - 用于解析 dojo JavaScript 文件并提取内联文档的库
* [rstwiki](https://github.com/phiggins42/rstwiki) - 使用 Python 和 Dojo Toolkit 构建的简单 reST/wiki 系统
* [Scripted](https://github.com/scripted-editor) - Scripted 是一个快速、轻量级的代码编辑器，最初专注于 JavaScript 编辑
* [todomvc](https://github.com/tastejs/todomvc) - 帮助您选择 MV\* 框架 - todo 应用示例
* [Dojo2 Example](https://github.com/dojo/examples) - 道场 2 示例
* [xamiro](https://github.com/xblox/xamiro) - PHP 和 JavaScript 中的 IDE 类似文件管理器，具有最小的依赖性。
* [Windows-dist](https://github.com/flysurfer28/windows-dist) - 用于物联网和原型设计的完整自动化套件。
...
* [dijit-claro-stylus](https://github.com/kfranqueiro/dijit-claro-stylus) - Dijit 的 Claro 主题从 LESS 直接转换为 Stylus。
* [Flat Dojo Theme](http://yiweima.github.io/flatdojo/) - Esri 平面 Dijit 设计
* [Semantic Dojo Theme](http://websemantics.github.io/semantic-dojo/) - 响应式 Dojo 主题，利用 [Semantic UI](http://semantic-ui.com/) 框架的出色风格。
...
* [Definitive TypeScript Guide](https://www.sitepen.com/blog/2013/12/31/definitive-guide-to-typescript/) - 有关 TypeScript 特性和功能的指南
* [Dojo to Typescript Converter](https://github.com/stopyoukid/DojoToTypescriptConverter) - 一个打字稿脚本，它从 dojo api.json 文件创建打字稿兼容的声明。
* [Dojo-TypeScript](https://github.com/schungx/Dojo-TypeScript) - 将 Dojo 1.9 AMD 风格与 Microsoft TypeScript 0.9.5 结合使用
* [Dojo Typings](https://github.com/dojo/typings) - Dojo 1 TypeScript 类型存储库（包括 Dijit 和 DojoX）
...
* [Brazilian Facebook Group](https://www.facebook.com/groups/288220914564119/) - Facebook 上的巴西道场社区
* [Dojo mailing list](http://dojotoolkit.org/community/) - 问题和讨论的邮件列表
* [Dojo on StackOverflow](http://stackoverflow.com/questions/tagged/dojo) - StackOverflow 上的 Dojo Toolkit 支持
...
* [Reddit Community](https://www.reddit.com/r/dojo/) - 不断壮大的社区在 Reddit 上讨论 Dojo（仅限受邀者）。
* [SensioLabs Connect Club](https://connect.sensiolabs.com/club/dojo-toolkit) - Sensiolabs Connect Dojo Toolkit Club 面向 PHP 和 Symfony 开发人员
* [IRC](http://irc.lc/freenode/dojo) - 大型且活跃的 IRC 支持频道。
* [Meetup](https://www.meetup.com/topics/dojo/) - 参与当地并寻找当地用户群体。
...
也非常欢迎您[贡献](CONTRIBUTING.md) 这个很棒的 Dojo 工具包列表。非常感谢所有帮助构建此列表的[贡献者](https://github.com/petk/awesome-dojo/graphs/contributors)。

[![CC0](https://licensebuttons.net/p/zero/1.0/88x31.png)](https://creativecommons.org/publicdomain/zero/1.0/)

在法律允许的范围内，[Peter Kokot](https://github.com/petk) 已放弃本作品的所有版权以及相关或邻接权。
