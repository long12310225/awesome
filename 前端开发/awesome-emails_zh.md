...
- [JSX-email](https://jsx.email/) - JSX Mail 是一个使用 React 创建电子邮件模板的电子邮件框架。
...
- [Maizzle](https://maizzle.com) - 使用 Tailwind CSS 快速构建 HTML 电子邮件。
...
- [Free Responsive template : Slate](https://litmus.com/resources/free-responsive-email-templates/) - 五个经过预先测试的模板，适用于任何邮寄服务。
...
- [Postmark Transactional Email Templates](https://github.com/wildbit/postmark-templates) - 坚如磐石的应用程序电子邮件模板。
...
- [Topol](https://topol.io/) - 一分钟内即可创建令人惊叹的响应式 HTML 电子邮件。
- [MJML Desktop App](https://mjmlio.github.io/mjml-app/) - MJML 官方桌面应用程序。
- [Rollover](http://freshinbox.com/tools/rollover/) - 生成翻转图像的代码，当电子邮件收件人将光标悬停在图像上时，该图像会显示替代图像。
- [Bulletproof Email Buttons](http://buttons.cm/) - 使用逐渐增强的 VML 和 CSS 设计华丽的按钮。
- [Bulletproof Background Images](http://backgrounds.cm/) - 借助 VML 和 CSS 的帮助，为您的 HTML 电子邮件创建坚如磐石的背景图像。
...
- [Detergent](https://detergent.io) - 用于准备粘贴到 HTML 中的文本的工具：删除不可见的 Unicode 字符（例如可能来自 PSD 文件的 [ETX](https://www.fileformat.info/info/unicode/char/0003/index.htm)）、对特殊字符进行编码（例如将 £ 转换为 `&pound;`）并改进排版。
...
- [Email Link Builder](https://email-link-builder.samcarlton.com/) - 创建可打开电子邮件草稿的 mailto 链接，其中包含预填充的收件人、主题、正文等。
...
- [Resend](https://resend.com/) - 大规模构建、测试和发送交易电子邮件。
...
- [Mailscribe Mailmaker](https://mailscribe.com/page/mailmaker) - 由人工智能驱动的电子邮件营销平台，允许使用内置组件设计电子邮件。
- [Campaign monitor](https://www.campaignmonitor.com/) - Campaign Monitor 可让您轻松创建、发送和优化电子邮件营销活动。
...
- [Postmark](https://postmarkapp.com) - 您的申请电子邮件闪电般快速送达。 Postmark 每次都会准时将您的交易电子邮件发送给客户。
...
- [Campaign Cleaner](https://campaigncleaner.com) - 用于优化、高性能电子邮件营销活动的终极工具。
- [ForwardMX](https://forwardmx.net) - 为您的域名提供高级电子邮件转发。
- [Heybounce](https://www.heybounce.io) - 电子邮件验证服务，用于检查电子邮件是否存在并检测一次性电子邮件。

## 自托管服务

- [Cloud Seeder](https://ipv6.rs/cloudseeder) - 一键安装并升级 Postfix+Dovecot 或 Stalwart 邮件服务器实例，免提。
- [iRedMail](https://iredmail.org/) - 易于安装的开源邮件服务器解决方案。
- [Mail-in-a-box](https://mailinabox.email/) - 让您只需几个简单的步骤即可成为自己的邮件服务提供商。
...
- [My Wonderful HTML Email Workflow](https://www.joshwcomeau.com/react/wonderful-emails-with-mjml-and-mdx/) - 我精彩的 HTML 电子邮件工作流程，使用 MJML 和 MDX 进行响应式电子邮件。
...
- [CSS Support](https://www.campaignmonitor.com/css/) - 地球上每个流行的移动、网络和桌面电子邮件客户端的 CSS 支持的完整细分。
...
- [电子邮件八达通博客](https://emailoctopus.com/blog/)
- [石蕊博客](https://litmus.com/blog/)
- [风格活动博客](http://stylecampaign.com/blog/)
- [梅玛博客](http://myemma.com/content-hub)
- [Postmarkapp 博客](http://blog.postmarkapp.com/)
- [花费的博客](https://blog.spently.com/)
- [电子邮件僧侣博客](http://www.emailmonks.com/blog/)
- [Stripo.email Blog](http://www.emailmonks.com/blog/) - 电子邮件营销和电子邮件设计博客。
- [HTML 电子邮件博客](https://htmlemail.io/blog/)
...
- [Mailchimp](http://mailchimp.com/resources/) - Mailchimp 提供的超棒资源。
...
- [活动监控开发资源](https://www.campaignmonitor.com/dev-resources/)
...
- [Mailmodo](https://www.mailmodo.com/email-templates/) - 大型电子邮件模板库，您可以从中免费获取模板或自定义您自己的电子邮件模板

## 灵感

- [Email Copy](http://www.goodemailcopy.com/) - 来自伟大公司的电子邮件副本。
- [非常好的电子邮件 Codepen](http://codepen.io/reallygoodemails/)
...
- [WhoSentWhat](http://whosentwhat.com) - 我们将电子邮件通讯从收件箱转移到网络上

## 统计数据

- [Myemma Email Stats](http://myemma.com/brainiac/gate-free-stats) - 现代电子邮件营销人员必须了解的 18 个统计数据，作者：Emma, Inc.
...
- [Grunt Litmus](https://www.npmjs.com/package/grunt-litmus) - 使用 grunt 将电子邮件测试发送给 Litmus。
- [Gulp Litmus](https://www.npmjs.com/package/gulp-litmus) - 使用 gulp 将电子邮件测试发送给 Litmus。
...
- [Email Privacy Tester](https://www.emailprivacytester.com/) - 用于测试电子邮件客户端的隐私功能（加载远程内容）的工具。
