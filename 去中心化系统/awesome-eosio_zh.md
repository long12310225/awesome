# 很棒的 EOSIO [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
<p>欢迎贡献。通过拉取请求添加链接或创建问题以开始讨论。请先阅读<a href="https://github.com/DanailMinchev/awesome-eosio/blob/main/contributing.md">贡献指南</a>。</p>
...
- [Learn](#learn)
  - [Websites](#websites)
  - [Books](#books)
  - [互动学习、实验室](#interactive-learning-labs)
  - [课程、研讨会、网络研讨会、视频等](#courses-workshops-webinars-videos-and-others)
- [Tools](#tools)
  - [钱包和工具包](#wallets-and-toolkits)
  - [账户服务](#account-services)
  - [区块浏览器、投票门户](#block-explorers-voting-portals)
  - [General](#general)
...
- [Developers](#developers)
  ...
  - [代码示例](#code-examples)
  - [区块生产者工具](#block-producer-tools)
  - [开发者中的其他](#other-in-developers)
- [Community](#community)
  - [Blogs](#blogs)
  - [YouTube 频道](#youtube-channels)
  - [Forums](#forums)
- [EOSIO生态系统](#eosio-ecosystem)
- [DApps](#dapps)
  - [DApp目录](#dapp-directories)
  - [租赁平台](#leasing-platforms)
  - [Games](#games)
  - [DApp 中的其他内容](#other-in-dapps)

## 官方

官方资源。

- [EOS网络基金会](https://eosnetwork.com/)
- [GitHub](https://github.com/AntelopeIO/spring)
- [蓝皮书](https://eosnetwork.com/blog/category/eos-blue-papers/n)
- [StackExchange 问答](https://eosio.stackexchange.com/)
...
- [EOS智能合约开发安全最佳实践](https://github.com/slowmist/eos-smart-contract-security-best-practices/blob/master/README_EN.md)
- [EOS 学习资源 - EOS 哥斯达黎加](https://guide.eoscostarica.io/)
- [ESC - EOS研究中心](https://eosvenezuela.io/esc.html)

### 书籍

- [Learn EOS Development](https://learneos.dev/) - EOS 区块链上的 dapp 的最新、深入、完整的指南。

### 互动学习、实验室

- [Elemental Battles](https://battles.eos.io/) - 构建区块链游戏。学习 EOSIO。
  - [宣布元素之战：Block.one 为有抱负的区块链开发人员提供的新教程](https://medium.com/eosio/announcing-elemental-battles-block-ones-3215a8e2cdee)
- [Block.one: Getting Started with the EOSIO Blockchain and Smart Contracts](https://google.qwiklabs.com/catalog_lab/3743) - Google Cloud 培训实验室。

### 课程、研讨会、网络研讨会、视频等

- [EOSIO Training & Certification](https://training.eos.io/) - 官方 EOSIO 培训和认证。
- [EOSIO Webinars](https://eos.io/event-category/webinar/) - EOSIO 官方网络研讨会。
- [EOSIO Resource Library](https://eos.io/resources/) - EOSIO 官方资源。视频、案例研究和其他资源可帮助您学习 EOSIO 并不断成长。
...
- [Learn EOS Blockchain Smart Contracts & DApps with C++, EOSJS](https://www.udemy.com/course/learn-eos-blockchain-smart-contracts-dapps-with-c-eosjs/) - 乌德米课程。
- [Building DApps on EOS: A Hands-On Workshop](https://objectcomputing.com/services/training/catalog/blockchain/building-dapps-with-eos-workshop) - 车间。
...
- [EOS Programming 101](https://academy.moralis.io/courses/eos-programming-101) - 伊万科技视频课程。
- [Introduction to EOSIO for Developers](https://academy.b9lab.com/courses/course-v1:B9lab+EOSIO-FREE+2018-09/about) - 免费 B1 实验室视频课程。
...
- [锚钱包](https://greymass.com/en/anchor/)
...
- [EOS 权威网络钱包](https://eosauthority.com/dashboard)
- [eoscanada/eosc](https://github.com/eoscanada/eosc)
- [蜡云钱包](https://all-access.wax.io/)
...
- [EOS.IO 的 Android 客户端](https://github.com/playerone-id/EosCommander)

### 账户服务

- [获取账户交易提醒 - EOS Authority](https://eosauthority.com/alerts)
- [EOS 启动](https://eospowerup.io/)

### 区块浏览器、投票门户

- [EOS Network Monitor](http://eosnetworkmonitor.io/) - “CryptoLions”的 EOSIO 网络监控器。对开发人员有用。分散友好。
- [eosflare](https://eosflare.io/) - 流行的区块浏览器包括资源统计、最新的个人资料操作以及有关“热门出价”和“热门投票者”的统计数据。
...
- [EOSGO](https://www.eosgo.io/)
- [bdata.one](https://bdata.one/) - 有关多个 EOSIO 链的账户和代币的区块链数据。

### 一般

- [一切EOS](http://allthingseos.com)
- [EOS Authority 提供的工具](https://eosauthority.com/tools)
- [EOSIO 工具和信息](https://www.alohaeos.com/tools)
...
- [EOS 区块生产者研究门户](https://www.alohaeos.com/vote)
...
- [EOSIO Web IDE](https://github.com/EOSIO/eosio-web-ide) - Web IDE 为开发人员提供了用于开发和测试目的的个人单节点 EOSIO 区块链，该区块链在 [Gitpod.io](https://www.gitpod.io/) 云中运行 - 并可通过 Web 浏览器访问。
...
- [Jungle Testnet](https://jungletestnet.io/) - Jungle TestNet 由 EOSIO 诞生以来，由许多开发团队和 EOS 节点发起并充当沙箱。
- [CryptoKylin Testnet](https://www.cryptokylin.io/) - CryptoKylin 测试网是一个开发者友好的测试网，由一群 EOS 主网区块生产者维护。
- [Wax Testnet](https://wax-testnet.eosio.online/) - Wax 的官方测试网。
  - [Account Creation and Faucet](https://waxsweden.org/testnet/) - Wax 瑞典的测试网页面。
...
- [EOSIO/eos-vm](https://github.com/EOSIO/eos-vm) - 低延迟、高性能且可扩展的 WebAssembly 后端库。
...
- [Transit API for EOS](https://www.eostransit.com/) - 通过基于 EOSIO 的区块链的开源、模块化和简单标准连接签名提供商和 dApp。
...
- [SwiftyEOS](https://github.com/ProChain/SwiftyEOS) - 用 Swift 编写的与 EOS 交互的框架。

#### 身份验证和钱包签名库

- [EOSIO/universal-authenticator-library](https://github.com/EOSIO/universal-authenticator-library) - 允许应用程序轻松使用不同身份验证提供程序的库。
...
- [EOSIO/eosio-webauthn-example-app](https://github.com/EOSIO/eosio-webauthn-example-app) - 示例 Web 应用程序演示通过 WebAuthn 进行 EOSIO 签名。
...
- [greymass/ual-anchor](https://github.com/greymass/ual-anchor) - 身份验证器旨在与 Anchor 和通用身份验证器库一起使用。
- [greymass/anchor-link](https://github.com/greymass/anchor-link) - 基于 EOSIO 签名请求 (EEP-7) 构建的 EOSIO 链持久、快速且安全的签名提供程序。
...
[@cc32d9 的介绍博客](https://cc32d9.medium.com/history-and-notifications-in-eosio-blockchain-8255194af93)

- [EOSIO/history-tools](https://github.com/EOSIO/history-tools) - 官方 EOSIO 历史 API 插件。
- [Hyperion History API](https://github.com/eosrio/Hyperion-History-API) - 适用于基于 EOSIO 的区块链的可扩展完整历史 API 解决方案。
...
- [EOSLIME](https://github.com/LimeChain/eoslime) - 类似 Truffle 的框架，用于在 EOS 区块链上进行开发、部署和测试。
- [Hydra](https://docs.klevoya.com/hydra/about/getting-started/) - 用于测试 EOSIO 智能合约的 JavaScript 框架。
- [haderech/vert](https://github.com/haderech/vert) - 用于基于 WASM 的区块链合约的 JavaScript EOS-VM 模拟运行时。运行和测试智能合约。

#### 服务
- [Demux](https://github.com/EOSIO/demux-js) - Demux 是一种后端基础设施模式，用于获取区块链事件以确定性地更新可查询的数据存储并触发副作用。
...
- [Liquid Apps](https://docs.liquidapps.io) - 智能合约服务 vRAM、oracle、cron、IPFS 和 ICB。
- [WAX 随机数生成器](https://developer.wax.io/es/tutorials/wax-rng)
- [DelphiOracle](https://github.com/eostitan/delphioracle) - 多方事实来源，旨在向其他智能合约或外部用户提供资产对的近实时价格。
...
- [maxifom/eos-abigen](https://github.com/maxifom/eos-abigen) - Typescript 和 Golang 代码生成器，用于为 EOS 兼容合约生成类型安全的客户端和表。
...
- [poorman.token](https://github.com/generEOS/poorman.token) - 带有燃烧和注册功能的 EOSIO 代币（为了使代币 RAM 便宜）。
...
- [ipfs-eos-demo](https://github.com/wpuricz/ipfs-eos-demo) - 演示将文本和图像保存到 ipfs 并将哈希值存储在 EOSIO 区块链上。
- [eosnewyork/erp](https://github.com/eosnewyork/erp) - EOS 资源规划器。
- [greymass/anchor-link-demo](https://github.com/greymass/anchor-link-demo) - 集成 greymass/anchor-link 的 VueJS 应用程序示例。
- [greymass/anchor-link-demo-multipass](https://github.com/greymass/anchor-link-demo-multipass) - 集成 greymass/anchor-link 的 ReactJS 应用程序示例。
...
- [theblockstalk/eosio-contracts](https://github.com/theblockstalk/eosio-contracts) - 示例智能合约、dapp 和系统合约模板。

### 区块生产者工具

- [GoogleCloudPlatform/eos-block-producer](https://github.com/GoogleCloudPlatform/eos-block-producer) - Terraform 模块用于在 Google Cloud Platform (GCP) 上创建 EOS 区块生产者 (BP) 节点。
...
- [eosdetroit/bp-playbook](https://github.com/eosdetroit/bp-playbook) - 一组让管理 EOS.IO 节点变得更容易的手册。
- [eoseoul/eos-ramcost](https://github.com/eoseoul/eos-ramcost) - 在启动的最后阶段调整 bancor 的代币供应和连接器平衡。
- [eosdetroit/nodesuite](https://github.com/eosdetroit/nodesuite) - Nodesuite 是一个通过使用 Ansible playbook 来简化 eosio 节点的管理和配置的工具。
...
- [Crypto Dunker](https://www.youtube.com/user/clamantfever) - 加密扣篮者频道。 EOSIO DApps 相关内容和新闻。
- [EOS Authority](https://www.youtube.com/channel/UCCBylil96ibgcBC1FDcMouw) - EOS 权威。有用的教程，与开发人员相关。
...
- [EOSCommunity.org 论坛](https://forums.eoscommunity.org/)
- [EOS-Reddit](https://www.reddit.com/r/eos/)
- [EOSDev-Reddit](https://www.reddit.com/r/EOSDev/)
- [EOSIO 开发者电报](https://t.me/joinchat/0uhWYfXVpPlkNTA1)
- [WAX 开发者 Telegram](https://t.me/waxdevelopers)
- [Teloso 开发者 Telegram](https://t.me/dappstelos)

## EOSIO生态系统

- [EOS infographic](https://twitter.com/EOS_Bees/status/1518996327664918531/photo/1) - EOS 生态系统信息图。
- [公共 EOSIO 链及其电报聊天](https://github.com/eosio-ecosystem/chains)
- [EOSIO Ecosystem](https://github.com/eosio-ecosystem/eosio-ecosystem-resources) - EOSIO多链生态系统信息。
...
- [Dapp 的现状](https://www.stateofthedapps.com/platforms/eos)
