...
- <a href="https://github.com/ossu/computer-science" target="_blank" rel="noopener noreferrer">开源社会大学</a> - OSSU 课程是使用在线材料的完整计算机科学教育。这不仅仅是为了职业培训或专业发展。
- <a href="https://github.com/prakhar1989/awesome-courses" target="_blank" rel="noopener noreferrer">精彩课程</a> - 此列表试图揭示那些精彩的计算机科学课程，这些课程使其高质量的材料（即作业、讲座、笔记、阅读材料和考试）可免费在线获取。
- <a href="https://github.com/learn-anything/books" target="_blank" rel="noopener noreferrer">书籍</a> - Learn Anything 收集所有以计算机科学为重点的材料，但您会发现从神经科学到哲学的其他主题。
- <a href="https://github.com/karlhorky/learn-to-program" target="_blank" rel="noopener noreferrer">学习编程</a> - 此列表旨在成为一组精选的高质量教育资源，重点关注 Web 开发的基础。
