# 很棒的黑客 - 一个了不起的项目 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

精彩黑客精选列表。受到 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) 的启发

如果您想对此列表做出贡献（请这样做），请向我发送拉取请求！

有关可供下载的免费黑客书籍列表，请转到[此处](https://github.com/Hack-with-Github/Free-Security-eBooks)
...
## 教程
 * [Ropers 计算基础知识](https://www.roppers.org/courses/fundamentals)
* 免费、自定进度的课程，构建计算机和网络知识基础。旨在让没有任何技术知识的学生对自己学习任何东西并继续接受安全教育的能力充满信心。全文可作为 [gitbook](https://www.hoppersroppers.org/fundamentals/) 获取。
 * [Corelan团队的Exploit编写教程](https://www.corelan.be/index.php/2009/07/19/exploit-writing-tutorial-part-1-stack-based-overflows/)
 * [渗透测试人员利用编写教程](http://web.archive.org/web/20140916085343/http://www.punter-infosec.com/exploit-writing-tutorials-for-pentesters/)
 * [了解 Linux 二进制利用的基础知识](https://github.com/r0hi7/BinExp)
 * [Shells](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuloKGG59rS43e29ro7I57J)
 * [缺席学期](https://missing.csail.mit.edu/2020/course-shell/)
...
* `docker pull Citizenstig/nowasp` - [OWASP Mutillidae II Web 渗透测试实践应用](https://hub.docker.com/r/citizenstig/nowasp/)
...
## 教程
* [开始 RE：逆向工程教程研讨会](https://www.begin.re/the-workshop)
* [恶意软件分析教程：逆向工程方法](http://fumalwareanalysis.blogspot.kr/p/malware-analysis-tutorials-reverse.html)
* [恶意软件独角兽逆向工程教程](https://malwareunicorn.org/workshops/re101.html#0)
* [Lena151：与莉娜一起倒车](https://archive.org/details/lena151)
 ...
 * [ScratchABit](https://github.com/pfalcon/ScratchABit) - 具有 IDAPython 兼容插件 API 的可轻松重定向和破解的交互式反汇编器
...
* 基于JVM的语言
  ...
  * [JAD](http://varaneckas.com/jad/) - JAD Java 反编译器（闭源、无人维护）
 ...
 * [JS美化器](https://github.com/beautify-web/js-beautify)
 ...
 * [usbmon](https://www.kernel.org/doc/Documentation/usb/usbmon.txt) - 适用于 Linux 的 USB 捕获。
...
* [综合化](https://www.synaanalysis.net/)/[Hexinator](https://hexinator.com/) -
 ...
 * [VHostScan](https://github.com/codingo/VHostScan) - 执行反向查找的虚拟主机扫描仪可以与数据透视工具一起使用，检测包罗万象的场景、别名和动态默认页面。
 ...
 * [Git-Scanner](https://github.com/HightechSec/git-scanner) - 一种用于错误搜寻或渗透测试的工具，用于针对具有公开可用的开放“.git”存储库的网站
 * [CSP Scanner](https://cspscanner.com/) - 分析网站的内容安全策略 (CSP) 以查找绕过和缺失的指令。
 * [Shodan](https://www.shodan.io/) - 网络爬行搜索引擎，可让用户搜索连接到互联网的各种类型的服务器。
 * [masscan](https://github.com/robertdavidgraham/masscan) - 互联网规模端口扫描仪。
 * [Keyscope](https://github.com/SpectralOps/keyscope) - 一个可扩展的密钥和秘密验证工具，用于针对多个 SaaS 供应商审核活动秘密
 ...
 * [findsubdomains](https://findsubdomains.com) - 非常快速的子域名扫描服务，比简单的子域名查找器（使用 OSINT 工作）有更多的机会。
 ...
 * [ssh-mitm](https://github.com/jtesta/ssh-mitm) - 一种 SSH/SFTP 中间人工具，用于记录交互式会话和密码。
 ...
 * [RustScan](https://github.com/rustscan/rustscan) - 使用 Rust 构建的极快端口扫描器，旨在在几秒钟内扫描所有端口，并利用 nmap 在一小部分时间内执行端口枚举。
 * [PETEP](https://github.com/Warxim/petep) - 可扩展的 TCP/UDP 代理，具有 GUI，可通过 SSL/TLS 支持进行流量分析和修改。

# 法医

## 工具
 * [Autopsy](http://www.sleuthkit.org/autopsy/) - 数字取证平台和 [The Sleuth Kit](http://www.sleuthkit.org/sleuthkit/index.php) 和其他数字取证工具的图形界面
 ...
 * [CyLR](https://github.com/orlikoski/CyLR) - NTFS 取证图像收集器
 * [CAINE](https://www.caine-live.net/) - CAINE 是一个基于 Ubuntu 的应用程序，提供完整的取证环境，并提供图形界面。该工具可以作为模块集成到现有的软件工具中。它会自动从 RAM 中提取时间线。
 ...
 * [OverTheWire - 涡流](http://overthewire.org/wargames/vortex/)
 * [OverTheWire - 漂流者](http://overthewire.org/wargames/drifter/)
 * [pwnable.kr](http://pwnable.kr/) - 提供有关系统安全的各种pwn挑战
 * [漏洞利用练习 - 星云](https://exploit-exercises.com/nebula/)
 ...
 * [Crackmes.de](http://crackmes.de/) - 世界上第一个也是最大的裂纹和逆向社区网站。

## 网络
 * [Hack This Site!](https://www.hackthissite.org/) - 一个免费、安全、合法的黑客训练场，测试和拓展他们的黑客技能
 * [Hack The Box](https://www.hackthebox.eu) - 一个在各种不同系统中执行渗透测试的免费站点。
 * [Webhacking.kr](http://webhacking.kr/)
 * [0xf.at](https://0xf.at/) - 一个没有登录或广告的网站，您可以在其中解决密码谜语（所谓的黑客攻击）。
...
## 密码学
 * [越线 - 氪](http://overthewire.org/wargames/krypton/)

## 错误赏金
  * [EdOverflow 提供的很棒的错误赏金资源](https://github.com/EdOverflow/bugbounty-cheatsheet)

## 漏洞赏金 - 赚点钱
  * [Bugcrowd](https://www.bugcrowd.com/)
  * [Hackerone](https://www.hackerone.com/start-hacking)
* [Intigriti](https://www.intigriti.com/) 欧洲排名第一的道德黑客和错误赏金计划。


#CTF

## 竞争
 * [防御控制](https://legitbs.net/)
 * [埋弧焊CTF](https://ctf.isis.poly.edu/)
 * [hack.lu CTF](http://hack.lu/)
 * [格子CTF](http://www.plaidctf.com/)
 * [RuCTFe](http://ructf.org/e/)
 * [Shellcode 中的幽灵](http://ghostintheshellcode.com/)
 * [博士CTF](http://www.phdays.com/)
 * [安全内 CTF](http://secuinside.com/)
 * [代码门CTF](http://ctf.codegate.org/html/Main.html?lang=eng)
 * [波士顿钥匙派对 CTF](http://bostonkeyparty.net/)
 * [零日 CTF](https://zerodays.ie/)
 * [Insomni’hack](https://insomnihack.ch/)
 * [皮克CTF](https://picoctf.com/)
 ...
 * [Roppers CTF Fundamentals Course](https://www.roppers.org/courses/ctf) - 免费课程旨在让学生尽快完成 CTF。教授加密、取证等所需的心态和技能。全文可作为 [gitbook](https://www.hoppersroppers.org/ctf/) 获取。
...
## 工具
* [empire](https://github.com/EmpireProject/Empire) - 适用于 powershell 和 python 的后期开发框架。
 ...
 * [Roppers Security Fundamentals](https://www.roppers.org/courses/security) - 免费课程，向初学者讲授安全在现实世界中如何运作。学习安全理论并执行防御措施，以便您更好地应对在线和物理世界的威胁。全文可作为 [gitbook](https://www.hoppersroppers.org/security/) 获取。
 * [Roppers Practical Networking](https://www.roppers.org/courses/networking) - 对网络和数据包跳舞的亲身实践、非常实用的介绍。没有浪费时间，没有记忆，只是学习基础知识。
 * [Rawsec's CyberSecurity Inventory](https://inventory.raw.pm/) - 有关网络安全的工具、资源、CTF 平台和操作系统的开源清单。 ([来源](https://gitlab.com/rawsec/rawsec-cybersecurity-list))
 * [The Cyberclopaedia](https://cr0mll.github.io/cyberclopaedia/) - 网络安全的开源百科全书。 [GitHub 存储库](https://github.com/cr0mll/cyberclopaedia)