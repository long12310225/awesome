# 很棒的蜜罐 [![Awesome Honeypots](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

很棒的蜜罐以及相关组件等的精选列表，分为 Web、服务等类别，重点关注免费和开源项目。

每个类别中的项目没有预先设定的顺序，顺序是按贡献顺序排列的。如果您想贡献，请阅读[指南](CONTRIBUTING.md)。

在 [sindresorhus/awesome](https://github.com/sindresorhus/awesome) 中发现更多精彩列表。

# 内容

- [很棒的蜜罐 ](#awesome-honeypots-)
- [Contents](#contents)
  - [相关列表](#related-lists)
  - [Honeypots](#honeypots)
  - [霍尼德工具](#honeyd-tools)
  - [网络和工件分析](#network-and-artifact-analysis)
  - [数据工具](#data-tools)
  - [Guides](#guides)
...
## 商业蜜罐
- [honerix](https://www.honerix.com) - Honerix 是一个用于捕获基于 Web 的攻击的分布式系统。 Honerix 的工作原理是模拟易受攻击的应用程序，目的是促使攻击者部署其恶意负载。
...
- [CyberBriefing IOC Feeds API](https://cyberbriefing.info) - REST API 具有来自 20 多个源的 63K 多个活动 IOC。对于根据已知恶意指标交叉引用蜜罐捕获的 IP 和域非常有用。提供免费套餐。

## 蜜罐

- 数据库蜜罐
    - [Acra](https://github.com/cossacklabs/acra) - 有效的SQL数据库保护套件：强选择性加密、SQL注入预防、基于数据库中的蜜罐/毒记录的入侵检测系统。
    - [Delilah](https://github.com/Novetta/delilah) - 用 Python 编写的 Elasticsearch 蜜罐。
    - [ESPot](https://github.com/mycert/ESPot) - 用 NodeJS 编写的 Elasticsearch 蜜罐，用于捕获每次利用 CVE-2014-3120 的尝试。
    - [Elastic honey](https://github.com/jordan-wright/elastichoney) - 一个简单的 Elasticsearch 蜜罐。
    - [HoneyMysql](https://github.com/xiaoxiaoleo/HoneyMysql) - 一个简单的Mysql蜜罐项目。
    ...
    - [mysql-honeypotd](https://github.com/sjinks/mysql-honeypotd) - 用 C 语言编写的低交互 MySQL 蜜罐。
    - [MysqlPot](https://github.com/schmalle/MysqlPot) - 一个 mysql 蜜罐，仍处于非常非常早期的阶段。
  ...
  - [MongoDB-HoneyProxy](https://github.com/Plazmaz/MongoDB-HoneyProxy) - MongoDB 蜜罐代理。
  - [NoSQLpot](https://github.com/torque59/nosqlpot) - 蜜罐框架构建在 NoSQL 风格的数据库上。
  - [mysql-honeypotd](https://github.com/sjinks/mysql-honeypotd) - 用 C 语言编写的低交互 MySQL 蜜罐。
...
- 区块链蜜罐
    - [Ethereum-honey-pot](https://github.com/jeremyfritzen/Ethereum-honey-pot) - 攻击试图窃取代币的黑客的工具。

- 网络蜜罐

  - [Krawl](https://github.com/BlessedRebuS/Krawl) - 轻量级欺骗服务器和反爬虫，可部署具有低漏洞和随机生成的诱饵数据的真实虚假 Web 应用程序。
  - [Cloud Active Defense](https://github.com/SAP/cloud-active-defense?tab=readme-ov-file) - 云主动防御可让您将诱饵直接部署到云应用程序中，使对手陷入两难境地：攻击还是不攻击？
  ...
  - [FCaptcha](https://github.com/WebDecoy/FCaptcha) - 自托管 CAPTCHA，充当内联蜜罐，通过 40 多个行为信号、无头浏览器指纹识别和 SHA-256 工作证明来检测机器人和视觉 AI 代理。
  ...
  - [Laravel Application Honeypot](https://github.com/msurguy/Honeypot) - 适用于 Laravel 应用程序的简单垃圾邮件防护包。
  - [Lophiid](https://github.com/mrheinen/lophiid/) - 分布式 Web 应用程序蜜罐，用于与大规模利用尝试进行交互。
  ...
  - [WebTrap](https://github.com/IllusiveNetworks-Labs/WebTrap) - 旨在创建欺骗性网页来欺骗攻击者并将其重定向到远离真实网站的位置。
  ...
  - [flux](https://github.com/andrewmichaelsmith/flux) - 具有 Canary 令牌集成的动态 Web 蜜罐，由法学硕士积极维护。
  - [galah](https://github.com/0x4D31/galah) - 使用 OpenAI API 的 LLM 支持的网络蜜罐。
  ...
  - [modpot](https://github.com/referefref/modpot) - Modpot 是一个用 Golang 编写并使用 gin 框架的模块化 Web 应用程序蜜罐框架和管理应用程序。
  - [nginx-honeypot](https://github.com/GetPageSpeed/nginx-honeypot) - 一个基于 NGINX 配置的简单蜜罐，可记录并阻止机器人扫描漏洞。
  - [owa-honeypot](https://github.com/joda32/owa-honeypot) - 一个基于 Flask 的 Outlook Web 蜜罐。
  - [phpmyadmin_honeypot](https://github.com/gfoss/phpmyadmin_honeypot) - 简单有效的 phpMyAdmin 蜜罐。
  - [shockpot](https://github.com/threatstream/shockpot) - 用于检测 Shell Shock 漏洞尝试的 WebApp Honeypot。
...
- WordPress 蜜罐
    - [HonnyPotter](https://github.com/MartinIngesen/HonnyPotter) - WordPress 登录蜜罐用于收集和分析失败的登录尝试。
    ...
    - [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) - 零配置 WordPress 插件，具有不可见的蜜罐字段、行为分析和 SHA-256 工作证明挑战，可检测机器人、无头浏览器和自动化框架。
...
- 服务蜜罐
  ...
  - [dionaea](https://github.com/DinoTools/dionaea) - 捕蝇草蜜罐的故乡。
  ...
  - [GenAIPot](https://github.com/ls1911/GenAIPot) - 第一个基于人工智能的开源蜜罐。支持POP3和SMTP协议，并根据用户描述使用A.I生成内容。
  - [Helix](https://github.com/Zeerg/helix-honeypot) - 具有主动防御能力的K8s API蜜罐。
...
- [honeydb] (https://honeydb.io/downloads) - 易于部署和配置的多服务蜜罐。可以配置为将交互数据发送到 HoneyDB 的集中收集器，以便通过 REST API 进行访问。
  ...
  - [rdppot](https://github.com/kryptoslogic/rdppot) - RDP蜜罐
  - [RDPy](https://github.com/citronneur/rdpy) - 用 Python 实现的 Microsoft 远程桌面协议 (RDP) 蜜罐。
  - [SMB Honeypot](https://github.com/r0hi7/HoneySMB) - 高交互的 SMB 服务蜜罐能够捕获类似恶意软件的恶意软件。
...
- 反蜜罐的东西
  ...
  - [canarytokendetector](https://github.com/referefref/canarytokendetector) - Thinkst CanaryTokens 检测和失效工具
  - [honeydet](https://github.com/referefref/honeydet) - 用 Golang 编写的基于签名的蜜罐检测器工具
  - [kippo_detect](https://github.com/andrew-morris/kippo_detect) - 检测 kippo 蜜罐存在的攻击性组件。
  - [potsnitch](https://github.com/f0rw4rd/potsnitch) - 蜜罐检测工具包，具有适用于 25 种以上蜜罐类型的协议指纹识别。
...
- ICS/SCADA 蜜罐
  ...
  - [HoneyPLC](https://github.com/sefcom/honeyplc) - 模仿多种 PLC 设备，包括西门子和洛克威尔

- 太空/卫星蜜罐

  - [HoneySat](https://github.com/HoneySat/honeysat-deploy) - 模拟多个卫星任务
...
- 其他/随机
  ...
  - [Masscanned](https://github.com/ivre/masscanned) - 我们来扫描一下。专注于网络扫描仪和机器人的低交互蜜罐。它与 IVRE 集成得很好，可以构建 GreyNoise 的自托管替代方案。
  ...
  - [OpenCanary](https://github.com/thinkst/opencanary) - 模块化和去中心化的蜜罐守护进程，运行多个金丝雀版本的服务，当服务被（滥用）使用时发出警报。
- [ciscoasa_honeypot](https://github.com/cymmetria/ciscoasa_honeypot) 用于 Cisco ASA 组件的低交互蜜罐，能够检测 CVE-2018-0101、DoS 和远程代码执行漏洞。
  ...
  - [FortiGate SSL-VPN Honeypot](https://github.com/PeterGabaldon/Fortigate.VPN-SSL.Honeypot) - 模仿 FortiGate SSL-VPN 设备来捕获暴力尝试、符号链接漏洞探测和恶意 IP 遥测。
...
- 分布式传感器部署
  ...
  - [Modern Honey Network](https://github.com/threatstream/mhn) - 多 Snort 和蜜罐传感器管理，使用虚拟机网络、小型 SNORT 安装、隐形捕蝇器和集中管理服务器。
...
- 记录匿名器
  ...
  - [LogAnon](http://code.google.com/archive/p/loganon/) - 日志匿名库有助于使匿名日志在日志和网络捕获之间保持一致。

- 动态欺骗工具

  - [Mimicry](https://github.com/chaitin/mimicry) - 模仿是一种动态欺骗工具，在利用过程中和利用后主动欺骗攻击者。
...
- 数据收集
  ...
  - [Kippo2MySQL](https://bruteforcelab.com/kippo2mysql) - 从 Kippo 的基于文本的日志文件中提取一些非常基本的统计信息并将其插入 MySQL 数据库中。
...
- 低交互蜜罐
  ...
  - [Honeyperl](https://sourceforge.net/projects/honeyperl/) - 基于 Perl 的蜜罐软件，带有为许多功能开发的插件，如：wingate、telnet、squid、smtp 等。
  - [T-Pot](https://github.com/dtag-dev-sec/tpotce) - 来自电信提供商 T-Mobile 的多合一蜜罐设备
  - [beelzebub](https://github.com/mariocandela/beelzebub) - 一个安全的蜜罐框架，通过 yaml 非常容易配置
...
- 服务器
  ...
  - [Artillery](https://github.com/BinaryDefense/artillery) - 开源蓝队工具，旨在通过多种方法保护 Linux 和 Windows 操作系统。
  ...
  - [Honeyd](https://github.com/provos/honeyd) - 请参阅[honeyd 工具](#honeyd-tools)。
  - [Honeysink](http://www.honeynet.org/node/773) - 开源网络污水坑提供了一种检测和预防给定网络上恶意流量的机制。
...
- AS 编号和前缀的查找服务
  ...
  - [CC2ASN](http://www.cc2asn.com/) - 针对属于世界上任何给定国家/地区的 AS 编号和前缀的简单查找服务。

- 数据收集/数据共享

  - [HPfriends](http://hpfriends.honeycloud.net/#/home) - 蜜罐数据共享平台。
    - [hpfriends - real-time social data-sharing](https://heipei.io/sigint-hpfriends/) - 有关 HPFriends feed 系统的演示
...
- 网络连接分析器
  ...
  - [Impost](http://impost.sourceforge.net/) - 网络安全审核工具，旨在分析受损和/或易受攻击的守护进程背后的取证。

- 蜜罐部署

  - [honeyfs](https://github.com/referefref/honeyfs) - 为中/高交互蜜罐创建人工文件系统的工具。
...
- 客户
  ...
  - [CWSandbox / GFI 沙箱](https://www.gfi.com/products-and-solutions/all-products)
  ...
  - [Rumal](https://github.com/thugs-rumal/) - 暴徒鲁马尔：暴徒的衣服和武器。
  - [Shelia](https://www.cs.vu.nl/~herbertb/misc/shelia/) - 用于攻击检测的客户端蜜罐。
  - [Thug](https://buffer.github.io/thug/) - 基于Python的低交互honeyclient。
  - [Thug 分布式任务队列](https://thug-distributed.readthedocs.io/en/latest/index.html)
...
- 蜜罐
  ...
  - [欺骗工具包](http://www.all.net/dtk/dtk.html)
...
- SSH 蜜罐
  ...
  - [InnerWarden](https://github.com/InnerWarden/innerwarden) - 具有内置 SSH 和 HTTP 蜜罐的安全代理，具有 LLM 支持的交互式假 shell，可捕获凭据和攻击者命令。
  - [Kippo](https://github.com/desaster/kippo) - 中等交互的 SSH 蜜罐。
  - [Kippo_JunOS](https://github.com/gregcmartin/Kippo_JunOS) - Kippo 配置为后门网络屏幕。
  - [Kojoney2](https://github.com/madirish/kojoney2) - 由 Jose Antonio Coret 用 Python 编写并基于 Kojoney 的低交互 SSH 蜜罐。
  ...
  - [sshesame](https://github.com/jaksi/sshesame) - 允许每个人登录并记录他们的活动的假 SSH 服务器。
  - [sshhipot](https://github.com/magisterquis/sshhipot) - 高交互 MitM SSH 蜜罐。
  - [sshlowpot](https://github.com/magisterquis/sshlowpot) - Go 中的另一个简单的低交互 SSH 蜜罐。
...
- 分布式传感器项目
  ...
  - [DShield Web 蜜罐项目](https://sites.google.com/site/webhoneypotsite/)
...
- 文件雕刻
  ...
  - [测试磁盘和照片记录](https://www.cgsecurity.org/)

- win32行为分析工具

  - [捕获BAT](https://www.honeynet.org/node/315)
...
- 垃圾邮件陷阱
  ...
  - [Shiva](https://github.com/shiva-spampot/shiva) - 带有智能虚拟分析器的垃圾邮件蜜罐。
    - [Shiva 垃圾邮件蜜罐启动和运行的提示和技巧](https://www.pentestpartners.com/security-blog/shiva-the-spam-honeypot-tips-and-tricks-for-getting-it-up-and-running/)
  - [SMTPLLMPot](https://github.com/referefref/SMTPLLMPot) - 使用GPT3.5构建的超级简单的SMTP蜜罐
  - [SpamHAT](https://github.com/miguelraulb/spamhat) - 垃圾邮件蜜罐工具。
  - [Spamhole](http://www.spamhole.net/)
  - [honeypot](https://github.com/jadb/honeypot) - Honey Pot 项目非官方 PHP SDK。
  - [spamd](http://man.openbsd.org/cgi-bin/man.cgi?query=spamd%26apropos=0%26sektion=0%26manpath=OpenBSD+Current%26arch=i386%26format=html)

- 商业蜜网

  - [Cymmetria Mazerunner](ttps://cymmetria.com/products/mazerunner/) - 引导攻击者远离真实目标并创建攻击足迹。
...
- Docker化的低交互包装
  ...
  - [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - Dockerized [Thug](https://github.com/buffer/thug) 来分析恶意网页内容。
...
- SIP服务器
  ...
  - [青蒿VoIP](http://artemisa.sourceforge.net)
...
- 物联网蜜罐
  ...
  - [Kako](https://github.com/darkarnium/kako) - 针对许多众所周知的和已部署的嵌入式设备漏洞的蜜罐。

- 蜜币
  - [CanaryTokens](https://github.com/thinkst/canarytokens) - 自托管蜜币生成器和报告仪表板；演示版本可在 [CanaryTokens.org](https://canarytokens.org/generate) 获取。
  ...
  - [Tracebit Community Edition](https://community.tracebit.com) - 在线免费金丝雀令牌（AWS、SSH、电子邮件、Web）
...
- 沙盒
  ...
  - [COMODO自动化沙箱](https://help.comodo.com/topic-72-1-451-4768-.html)
  - [Cuckoo](https://cuckoosandbox.org/) - 领先的开源自动化恶意软件分析系统。
  - [Pylibemu](https://github.com/buffer/pylibemu) - Libemu Cython 包装器。
  - [RFISandbox](https://monkey.org/~jose/software/rfi-sandbox/) - PHP 5.x 脚本沙箱构建在 [funcall](https://pecl.php.net/package/funcall) 之上。
...
- 沙盒即服务
  ...
  - [Hybrid Analysis](https://www.hybrid-analysis.com) - 由 Payload Security 提供支持的免费恶意软件分析服务，可使用独特的混合分析技术检测和分析未知威胁。
  - [Joebox Cloud](https://jbxcloud.joesecurity.org/login) - 分析 Windows、Android 和 Mac OS X 上的恶意文件（包括 PE、PDF、DOC、PPT、XLS、APK、URL 和 MachO）的行为，以发现可疑活动。
...
- 前端
  ...
  - [Wordpot-Frontend](https://github.com/GovCERT-CZ/Wordpot-Frontend) - 功能齐全的脚本，用于可视化 Wordpot 蜜罐中的统计数据。
...
- 可视化
  ...
  - [余辉云](https://github.com/ayrus/afterglow-cloud)
  - [Afterglow](http://afterglow.sourceforge.net/)
  - [Glastopf Analytics](https://github.com/katkad/Glastopf-Analytics) - 简单的蜜罐统计。
  - [HoneyMalt](https://github.com/SneakersInc/HoneyMalt) - Maltego 转变为映射蜜罐系统。
  ...
  - [Kippo-Graph](https://bruteforcelab.com/kippo-graph) - 用于可视化 Kippo SSH 蜜罐统计数据的全功能脚本。
  ...
  - [SSH-Radar](https://github.com/antonsatt/ssh-radar) - 使用地理位置和 Grafana 仪表板实时监控和可视化失败的 SSH 登录尝试。

## 指南

- [T-Pot：多蜜罐平台](https://dtag-dev-sec.github.io/mediator/feature/2015/03/17/concept.html)
- [蜜罐（Dionaea 和 kippo）设置脚本](https://github.com/andrewmichaelsmith/honeypot-setup-script/)
- [安全金丝雀成熟度模型](https://tracebit.com/blog/the-security-canary-maturity-model)
...
- 部署
  ...
  - [honeypotpi](https://github.com/free5ty1e/honeypotpi) - 将 Raspberry Pi 转变为 HoneyPot Pi 的脚本。
...
- 研究论文
  ...
  - [图拉罗萨研究：量化网络欺骗有效性的实验设计和实施](https://www.osti.gov/servlets/purl/1524844)
  - [“如果他们真的在追捕你，那不是偏执狂”：当宣布欺骗技术可以改变攻击者的决定时](https://scholarspace.manoa.hawaii.edu/items/88cd00a5-914f-456e-a322-01c22fd5b7d7)
  - [何时进行欺骗：用于网络欺骗战略时机的跨层 Stackelberg 博弈框架](https://arxiv.org/pdf/2505.21244)
