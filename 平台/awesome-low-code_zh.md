...
# 很棒的低代码 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- [Platforms](#platforms)
   - [公民自动化和开发平台](#citizen-automation-and-development-platform)
   - [低代码应用平台](#low-code-application-platform)
   - [业务流程管理](#business-process-management)
   - [机器人过程自动化](#robotic-process-automation)
   - [智能虚拟代理](#intelligent-virtual-agent)
   - [集成平台即服务](#integration-platform-as-a-service)
   - [低代码API管理平台](#low-code-api-management-platform)
- [工具、扩展和框架](#tools-extensions-and-frameworks)
- [参考资源](#reference-resources)
- [学习资源](#learning-resources)
- [示例、模板和解决方案](#samples-templates-and-solutions)
- [Community](#community)
- [Blogs](#blogs)
- [其他清单](#other-lists)
...
- [Power Automate (Microsoft)](https://flow.microsoft.com/) - 一种在线工作流程服务，可自动执行最常见的应用程序和服务中的操作。
- [Zapier](https://zapier.com/) - 允许用户轻松连接和自动化他们使用的应用程序。
- [Einstein Automate (Salesforce)](https://www.salesforce.com/products/platform/einstein-automate/) - 通过轻松自动化业务流程，让您的员工能够做更多重要的事情，而无需专业的开发技能。
...
- [Flow (Zoho)](https://www.zoho.com/flow/) - 一个集成平台，可帮助您无需任何代码即可连接应用程序。
- [FormNX](https://formnx.com) - 一个无代码平台，无需免费编码即可帮助创建表单。它还提供与 webhook、Mailchimp 的集成选项，您可以轻松地将表单嵌入到您的网站或 Web 应用程序中，而无需任何编码。
- [Postman Flows](https://learning.postman.com/docs/postman-flows/overview/#get-started-with-flows) - 一个低代码编辑器，用于在协作环境中原型化、构建和部署 API 优先的应用程序。创建流程模块，以自动执行任务、集成系统，并通过 Postman API Network 向团队中的其他人或全世界展示您的 API。
...
- [Tabidoo](https://tabidoo.cloud/) - 强大的低代码平台，具有成熟的工作流程、权限管理和集成（REST API）。许多预定义的模板。每个用户不收费。
- [Power Apps (Microsoft)](https://powerapps.com/) - 只需数小时（而不是数月）即可构建应用程序，轻松连接到数据，使用类似 Excel 的表达式添加逻辑，并在 Web、iOS 和 Android 设备上运行。
- [Power BI](https://powerbi.microsoft.com/) - 统一来自多个来源的数据，创建交互式、沉浸式仪表板和报告，提供可行的见解并推动业务成果。
- [Appian](https://appian.com/) - 提供低代码软件开发平台，使组织能够快速开发功能强大的应用程序。
- [Mendix](https://mendix.com/) - 用于大规模创建和持续改进多渠道应用程序的最快、最简单的高生产力平台。
- [OutSystems](https://www.outsystems.com/) - 一个低代码平台，使企业能够开发、部署和管理企业级应用程序。
- [Now Platform (ServiceNow)](https://www.servicenow.com/now-platform.html) - 通过更多的创建者和更低的复杂性快速构建任务关键型应用程序。轻松在整个企业范围内扩展，以提供用户喜爱的体验。
- [Creator (Zoho)](https://www.zoho.com/creator/low-code-platform/) - 从头开始构建应用程序，而无需编写无休止的代码行。
- [BettyBlocks](https://www.bettyblocks.com/) - 排名第一的无代码平台，实现创新、敏捷性和赋权。用于以闪电般的速度创建移动、商业和 Web 应用程序。
- [APEX (Oracle)](https://apex.oracle.com/en/platform/low-code/) - 低代码开发平台使您能够构建可扩展、安全的企业应用程序，具有世界一流的功能，并且可以部署在任何地方。
- [Salesforce Platform, prev. Force.com (Salesforce)](https://www.salesforce.com/products/platform) - 使用低代码从任何地方点击、创建和发货。
- [KAI-Flow](https://www.kaiflow.io/) - KAI Flow 是一个开源低代码平台，专为设计和扩展复杂的人工智能工作流程而开发。
- [n8n](https://n8n.io/) - 具有许多集成和公平代码许可证的工作流程自动化工具。
...
- [Loopple](https://www.loopple.com) - 低代码拖放仪表板构建器。
- [Appsheet (Google)](https://about.appsheet.com/home/) - Google AppSheet 是一个无代码开发平台，使用户无需具备丰富的编程知识即可创建自定义移动和 Web 应用程序。它提供了用于构建应用程序的拖放界面，并且可以与各种数据源和 API 集成以自动化工作流程并提高生产力。
- [YepCode](https://yepcode.io) - 一体化平台，可直接使用 JavaScript 或 Python 在无服务器环境中连接 API 和服务。它允许开发、执行和监控集成和自动化流程。
- [DronaHQ](https://www.dronahq.com/) - 一个低代码平台，可帮助工程团队和产品经理构建内部工具、自定义用户旅程、数字体验、自动化、自定义管理面板、操作应用程序，速度提高 10 倍。
- [REI3](https://rei3.de/en/home) - 开放的低代码应用程序平台。它几乎可以在任何系统上运行，无论是本地还是云端，并且可供个人和组织免费使用。
- [Iotellect](https://iotellect.com) - 用于构建设备集成、数据收集和实时可视化解决方案的低代码物联网平台。通过拖放式 UI 构建器支持 50 多种工业协议（MQTT、OPC UA、Modbus）。
- [TemplateFox](https://pdftemplateapi.com/) - 低代码 PDF 生成平台，具有拖放模板编辑器和 REST API，可自动大规模自动创建文档。
- [Rierino](https://rierino.com/) - 开发人员优先的低代码平台，用于构建和编排企业后端应用程序、微服务和 API，具有可视化流程设计、可组合架构和嵌入式 AI 功能。提供免费的自托管社区版。
...
- [AgilePoint](https://agilepoint.com/) - 借助 AgilePoint 数字流程自动化平台，只需几分钟（而不是几个月）即可部署改变业务的想法。
...
- [Naologic](https://naologic.com/) - 由业务用户和流程驱动的专业人员构建的生产力应用程序，用于简化和自动化复杂的流程。
...
- [UiPath](https://www.uipath.com/) - 机器人流程自动化 (RPA) 软件的领先提供商，使组织能够自动执行重复且耗时的任务，例如数据输入和数据处理。其平台包括用于构建自动化工作流程的可视化设计器、用于执行工作流程的机器人以及用于监控和优化性能的分析工具。
...
- [AnveVoice](https://anvevoice.app) - 网站无代码人工智能语音代理，只需一行 JS 嵌入，支持 50 多种语言，无需任何编码技能。
...
- [Azure Logic Apps (Microsoft)](https://azure.microsoft.com/en-us/services/logic-apps/) - 一个基于云的平台，用于创建和运行集成应用程序、数据、服务和系统的自动化工作流程。
- [MuleSoft (Salesforce)](https://mulesoft.com/) - 提供集成和 API 平台，可以轻松连接来自任何系统的数据以创建互联体验。
- [Workato](https://www.workato.com) - 一个企业自动化平台，可帮助组织更快、更智能地工作，而不影响治理和安全性。
...
- [XrmToolBox](https://github.com/MscrmTools/XrmToolBox) - 该应用程序汇集了多种工具，可简化 Microsoft Dynamics CRM/365/Dataverse/PowerApps 的自定义和配置。
...
- [SharePoint Workflow Converter](https://github.com/TracyGH/SharePointWorkflowConverter) - 概念验证 C# 控制台应用程序，用于检索旧版 2010 和 2013 自定义 SharePoint 工作流定义文件，并以编程方式创建新的 Power Automate 流。

## 参考资源

### 电源平台（微软）

- [Power Platform Connectors](https://github.com/microsoft/PowerPlatformConnectors) - 这是 Microsoft Power Automate、Power Apps 和 Azure 逻辑应用连接器的存储库。
...
- [Automatic travel time](https://github.com/wortell/PowerAutomate-AutomatischeReistijd) - 将自动旅行时间添加到您的 Office 365 日历中。
- [Message Center in Teams](https://github.com/ericsche/MCinTeams) - 一个简单的 PowerAutomate 解决方案，用于收集消息中心公告并将其发布到 Teams 频道中。
...
- [Microsoft Power Apps 官方社区](https://powerusers.microsoft.com/t5/Power-Apps-Community/ct-p/PowerApps1)
- [Microsoft Power Automate 官方社区](https://powerusers.microsoft.com/t5/Microsoft-Power-Automate/ct-p/MPACommunity)
- [Microsoft Power Virtual Agents 官方社区](https://powerusers.microsoft.com/t5/Power-Virtual-Agents-Community/ct-p/PVACommunity)
- [微软Power BI官方社区](https://community.powerbi.com/)
...
- [Awesome Microsoft Power Platform](https://github.com/Power-Maverick/awesome-power-platform) - 有关 Power Platform 生态系统的精彩内容的集合。
