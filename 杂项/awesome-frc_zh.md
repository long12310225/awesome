# 很棒的FRC [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- [State Space Guide](https://github.com/calcmogul/state-space-guide) - 状态空间控制实用指南：高中生研究生水平控制理论。
...
- [254 2016 Vision Talk](https://www.youtube.com/watch?v=rLwOkAJqImo) - 关于视觉跟踪的最完整的课程。
...
- [QDriverStation](https://github.com/FRC-Utilities/QDriverStation) - 适用于所有桌面平台的流行开源 Driver Station 克隆。虽然不允许参加比赛，但对于希望在另一个平台上行驶或提高开源信誉的团队来说至关重要。
...
- [Chief Delphi](https://www.chiefdelphi.com/forums/portal.php) - 关于 FRC 一切的重要论坛。
...
- [Sertain](https://github.com/SouthEugeneRoboticsTeam/sertain) - 一个基于 WPILib 构建的框架，使用 Kotlin 编写机器人变得更加美观。
...
- [BaseBot](https://github.com/frc5024/basebot) - 完全重写 barebonesFRC，经过严格优化，可以尽可能快地运行，并在定期函数期间使用最少的资源。

### C#

- [WPILib (C#)](https://github.com/robotdotnet/WPILib) - 用于用 C# 编写机器人代码的非官方 WPILib 端口。
- [NetworkTables (C#)](https://github.com/robotdotnet/NetworkTables) - C# 的非官方 NetworkTables 端口。
- [FRC-Extension (Visual Studio)](https://github.com/robotdotnet/FRC-Extension) - Visual Studio 扩展使编写 C# 机器人变得轻而易举。
...
- [FRC Bot](https://github.com/FRC-Bot/FRCBot-ChatBot) - Facebook Messenger 机器人可获取有关 FRC 团队、活动和比赛的信息。
