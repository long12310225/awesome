...
# 很棒的游戏制作者 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> GameMaker 的精彩库、片段、指南和项目的精选列表。 😎

[GameMaker](https://gamemaker.io/) 是 YoYo Games 推出的一款用户友好的跨平台游戏引擎，允许初学者和高级游戏开发人员为桌面、HTML5 和控制台平台创建 2D 和 3D 游戏。

您可以在 GameMaker 中制作什么类型的游戏？ [查看此列表。](https://steamdb.info/tech/Engine/GameMaker/)

## 内容

- [开始使用](#getting-started)
- [数据处理](#data-manipulation)
- [本机扩展](#native-extensions)
- [Timing](#timing)
- [Async](#async)
- [Utilities](#utilities)
- [Tools](#tools)
...
- [游戏制作手册](https://manual.gamemaker.io/)
- [GameMaker 发行说明](https://gms.yoyogames.com/ReleaseNotes.html)
- [游戏制作商市场](https://marketplace.gamemaker.io/)
...
- [Advanced GameMaker Tutorials](https://www.youtube.com/watch?v=n8-MuIuOQFE&list=PL_hT--4HOvrfuDcYrTufdpgwoALAczPR2) - 来自 DragoniteSpam 的教程深入探讨了与 GML 语言相关的更高级主题。他们还有全面的 3D 和着色器介绍视频。 ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)

### 建议

- 如果您已经有编程经验，请学习 GameMaker 语言 (GML)，而不是视觉（拖放）功能。
- 对于像素艺术，[Aseprite](https://www.aseprite.org/) 是原生精灵编辑器的流行替代品。 💸
- [Aseprite的源代码](https://github.com/aseprite/aseprite)可以免费编译。
...
- [Map](https://github.com/GameMakerDiscord/Map.gml) - 哈希表的实现。
...
- [Cottonwool](https://github.com/JujuAdams/Cottonwool) - 无内存泄漏的安全表面。
- [BSONGML](https://github.com/LAGameStudio/BSONGML) - 在二进制文件中保存和加载 GML 结构化数据，避免与将 JSON 作为字符串加载相关的内存和性能问题。
- [Binder](https://github.com/Homunculus84/Binder) - 用于对大型数据集进行高效查找的二分搜索库。
- [Airkiver](https://github.com/AlubJ/Airkiver) - 游戏文件存档工具。
- [OKColor](https://github.com/KeeVeeGames/OKColor.gml) - 一个不错的颜色管理器，用于实现 OKLab/OKLCH 颜色。
- [Exception](https://github.com/KeeVeeGames/Exception.gml) - 自定义异常的基类。
- [ArrayList](https://github.com/KeeVeeGames/ArrayList.gml) - 最全的列表类。垃圾收集、快速排序函数、[] 访问器和数组引用。
- [Bit Buffers](https://yellowafterlife.itch.io/gamemaker-bit-buffers) - 以每位粒度读取和写入缓冲区。
- [sprite_add_gif](https://yellowafterlife.itch.io/gamemaker-sprite-add-gif) - 将动画 GIF 作为精灵动态加载。
- [Managix](https://foxyofjungle.itch.io/managix) - 异步内存和资源管理器（纹理组、音频组等）。 💸
- [Ngrams](https://github.com/tinkerer-red/Ngrams) - 用于模糊搜索、预测文本或标记序列建模的轻量级 n-gram 库。

## 本机扩展

它们在特定平台上运行，使游戏能够完成一些单独使用 GML 不可能、不切实际或低效的事情。与特定任务（例如输入处理）相关的本机扩展可以在这些部分中找到。
...
- [GM Sysinfo](https://github.com/SpikeHD/gm-sysinfo) - 用于获取系统信息和资源使用情况的跨平台扩展。
...
- [window_shape](https://yellowafterlife.itch.io/gamemaker-window-shape) - Windows 上的自定义形状窗口。 💸
- [Windows' windows](https://yellowafterlife.itch.io/gamemaker-winwin) - Windows 上的多个窗口。 💸
- [winMenu](https://yellowafterlife.itch.io/gamemaker-winmenu) - Windows 上的本机菜单。 💸
- [window_set_icon](https://yellowafterlife.itch.io/window-set-icon) - 更改 Windows 上的窗口和/或任务栏图标。
- [file_dropper](https://yellowafterlife.itch.io/gamemaker-file-dropper) - 接受将文件拖放到 Windows 上的游戏窗口上。
- [file_dragger](https://github.com/YAL-GameMaker/file_dragger) - 在 Windows 上将文件拖放到“游戏窗口外”。
- [Window Commands](https://yellowafterlife.itch.io/gamemaker-window-commands) - 调度/拦截窗口控件，例如最小化（以及其他与窗口相关的功能）。
- [wasm-bridge](https://github.com/Sidorakh/wasm-bridge) - 一种在 GX/WASM 游戏中使用 JS 扩展的方法。
- [Web Dynamic Textures](https://yellowafterlife.itch.io/gamemaker-web-dyn-textures) - HTML5 的动态纹理页面加载系统。
- [GMWinBackdrop](https://topherlicious.itch.io/gmwinbackdrop) - Windows 11 背景材料。
- [GMSDLL.rs](https://github.com/YAL-GameMaker/GMSDLL.rs?) - 有关如何在 Rust 中创建本机 DLL 扩展的示例。

## 时机

自定义计时器、时间线和任务调度。

- [Iota](https://github.com/JujuAdams/iota) - 轻量级时间步长库。
...
- [SimThreads](https://github.com/tabularelf/SimThreads) - GameMaker 的模拟线程。
- [MultiProcessing](https://github.com/tinkerer-red/MultiProcessing) - GameMaker 中多重处理的概念证明。
- [Promises](https://github.com/YAL-GameMaker/Promise.gml) - JavaScript Promise 的改编版。
- [GML Promise](https://github.com/tinkerer-red/GML-Promise) - 另一个 JS 风格的 Promise 库。
...
- [Twerp](https://pixelatedpope.itch.io/twerp) - 缓动函数类似于 lerp()。
...
- [CoreExtension](https://github.com/blueburncz/CoreExtension) - CC0 编程库的集合。 （已存档）
...
- [JITSpeak](https://github.com/BenjaminUrquhart/JITSpeak) - 提高 Catspeak 性能。
- [GMBenchmark](https://github.com/DragoniteSpam/GMBenchmark) - 对 GML 代码进行基准测试的工具。
- [Figgy](https://github.com/glebtsereteli/Figgy) - 集中且持久的实时配置可实现无缝游戏调整和平衡。
- [RenderStack](https://github.com/FoxyOfJungle/RenderStack) - 将游戏的渲染组织为可自定义的顺序。
- [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) - 快速、灵活的 GameMaker 全文搜索。专为中小型数据集（10k-50k+ 文档）而构建，具有实时索引、模糊搜索、n-gram、BM25/TF-IDF 评分和持久性。

## 工具

与项目文件或 GameMaker 本身一起使用的东西，而不是在游戏中使用的东西。

- [Stitch for VSCode](https://marketplace.visualstudio.com/items?itemName=bscotch.bscotch-stitch-vscode) - 在 VSCode 中编辑 GameMaker 项目。
...
- [Rubber](https://github.com/GameMakerDiscord/Rubber) - 通过命令行编译 GameMaker 项目。这是关于如何使用它的[很棒的指南](https://www.patreon.com/posts/how-to-build-36556955)。
- [GMSnip](https://manta-ray.itch.io/gmsnip) - 用于在 IDE 中定义无限代码片段的实验工具。
- [vim-GML](https://github.com/JafarDakhan/vim-gml) - 适用于 GameMaker 的高质量 Vim 语法突出显示。
- [sfGML](https://yellowafterlife.itch.io/gamemaker-haxe) - 从强类型 Haxe 生成 GML 代码。
- [Win7 patcher for GM2024.11+](https://yellowafterlife.itch.io/gm2024-win7-patcher) - 使新 GM 版本制作的游戏可以在 Windows 7 上运行。
- [RerouteAudio](https://yellowafterlife.itch.io/gamemaker-reroute-audio) - 将编译的游戏音频文件组织到子目录中。 💸
- [GMLC](https://github.com/tinkerer-red/GMLC) - 运行时编译器和解释器在运行时加载、编译和执行 GML 代码。
- [GMLVM](https://github.com/erkan612/GMLVM) - 一个易于使用的完整 GML 解释器，可在运行时执行 GML。
...
- [Duck](https://github.com/imlazyeye/duck) - 一个快速 GML 分析器，用于强制代码样式并检测错误。
- [Gobo](https://github.com/Pizzaandy/Gobo/) - GML 的固执己见的代码格式化程序。
- [Gobo (EttyKitty fork)](https://github.com/EttyKitty/Gobo/) - 一个不太固执的 GML 代码格式化程序，具有更多选项和功能。
- [Inspectron](https://github.com/shdwcat/Inspectron) - 流畅的 API，可轻松创建 GameMaker 调试视图。
- [GMPulse](https://topherlicious.itch.io/gmpulse) - 运行时检查器和控制面板。 💸
- [Lookout](https://github.com/glebtsereteli/Lookout) - 有助于调试覆盖视图。

## 输入处理

- [Input](https://codeberg.org/offalynne/Input) - 没有废话的游戏手柄/键盘库。
- [XeroInput](https://www.reddit.com/r/gamemaker/comments/icoh6m/xeroinput_gms23_input_handler/) - 另一个库可以处理单个操作的多个输入。
- [InputCandy](https://github.com/LAGameStudio/InputCandy) - 与输入类似，它充当 SDL 的包装器，具有操作和信号，但也提供测试、屏幕诊断和一些与外设相关的其他 UI 组件，以及可以轻松重新设计的预构建最终用户配置菜单。
...
- [Native Mouselock](https://yellowafterlife.itch.io/gamemaker-native-mouselock) - 系统级鼠标锁定。 💸
- [Raw Input](https://yellowafterlife.itch.io/gamemaker-raw-input) - 使用多个鼠标和键盘。 💸
...
- [GMUI](https://github.com/erkan612/GMUI) - 立即模式 GameMaker UI 库，大量 UI 组件。
- [MajorGUI](https://github.com/erkan612/MajorGUI_GML) - 基于 Surface 的 GUI，允许 100% 控制 UI 样式和功能。
- [GMS2-UI-Library](https://github.com/nabilatsoulcade/GMS2-UI-Library) - 一个库，其中包含用于在 GameMaker 中实现 UI 设计的有用脚本。
...
- [GUI Framework](https://niris.itch.io/gui-framework) - Niris Games 的 GUI 实现。
...
- [Smart Clickable GUI](https://www.youtube.com/watch?v=RbBgE3cUShc) - 像素化的教皇。 ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
...
- [SimpleUI](https://github.com/evolutionleo/SimpleUI) - 简约的 UI 框架。
- [LimeUI](https://github.com/Limekys/LimeUI) - Flexpanel 系统适用于现代、触摸友好的界面。
- [Bento](https://github.com/JujuAdams/Bento) - 跨平台 UI 框架。
- [InteractiveBooks](https://marketplace.gamemaker.io/assets/4858/now-free-interactive-books) - 高度灵活、可交互的书籍。
- [SimpleBook](https://github.com/Gizmo199/SimpleBook) - 简单的书籍渲染框架。
...
- [Lexicon](https://github.com/tabularelf/lexicon) - 另一个本地化解决方案侧重于简化实施。
- [GMLocalize](https://github.com/DragoniteSpam/GMLocalize2) - 不是完整的本地化解决方案。从 GameMaker Studio 2 项目中提取用于本地化的文本字符串并将其保存到 JSON 文件。
- [Small Pentapop Localization Tool](https://github.com/AntonBergaker/small_pp_localization_tool) - 与 GMLocalize 类似的导出工具，但导出为 csv。
- [gms2-mofile](https://github.com/pmarincak/gms2-mofile) - 用于本地化的 Mofile 阅读器。
- [cmnLoc](https://yellowafterlife.itch.io/gamemaker-cmn-loc) - 具有文本提取器、短语法和 ICU/复数支持的本地化库。 💸
- [MythLoco](https://mythloco.co.uk) - 带有基于网络的字符串编辑器的本地化系统。
- [Krug's Localize System](https://krug-dev.itch.io/localize-system-for-gamemaker) - 具有实时 Google Sheets API 同步功能的本地化系统。
...
- [Verlet Integration Library](https://jamjamteam.itch.io/verlet-integration-gamemake-studio-2) - 由 Sarek Lambert 进行的 Verlet 集成。
- [GMVerlet-Integration](https://github.com/tabularelf/GMVerlet-Integration) - 用于视觉效果的 Verlet 集成示例。
- [Top-Down Movement & Collision](https://pixelatedpope.itch.io/tdmc/devlog/156556/converting-tdmc-to-use-tiles) - Pixelated Pope 的强大的基于对象的碰撞系统。
- [GMPhysX](https://bytecauldron.itch.io/gmphysx) - 将 NVIDIA PhysX 添加到 GameMaker，用于基于物理的 2D/3D 游戏。 💸
...
- [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) - 用于创建艺术资产管道的实用程序。
- [PixelUpscaler](https://github.com/JujuAdams/Pixel-Art-Upscaling) - 像素艺术升级着色器，为 GameMaker 提供尴尬的分辨率。
- [ASESync](https://sahaun.itch.io/asesync) - 自动同步 GameMaker 中的 aseprite 文件。
- [conveyorbelt](https://github.com/imissmyfriends/conveyorbelt) - 与 ASESync 类似。将 Aseprite 文件导出到 GameMaker 精灵。
- [Collage](https://github.com/tabularelf/Collage) - 纹理页面生成器和图像管理器。模仿 GameMaker 的纹理页面打包，同时提供更高的灵活性。
- [GM Animate](https://github.com/KormexGit/GM-Animate) - 精灵动画管理器。

## 音频

- [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) - GameMaker 中对 FMOD 的官方支持。
...
- [LineAudio](https://github.com/WangleLine/LineAudio) - 音频辅助功能。
- [Bard](https://github.com/gl326/bard-audio) - 用于在 GameMaker 中设计和实现优质音频的引擎。已更新以利用更新的 GameMaker 音频效果。
- [SynthEngine](https://topherlicious.itch.io/synthengine) - 适用于 GameMaker 的全功能音乐合成器。
- [MusicTheoryLib](https://topherlicious.itch.io/musictheorylib) - 适用于 GameMaker 的便捷音乐理论实用程序。
- [WaveForm](https://topherlicious.itch.io/waveform) - 在 GameMaker 中渲染音频缓冲区中的音频波形。
- [WaveWrite](https://topherlicious.itch.io/wavewrite) - 在 GameMaker 中读取和写入 WAV 文件。
- [GMMidi](https://topherlicious.itch.io/gmmidi) - 在 GameMaker 中读取和写入 MIDI 文件。
- [EZAFX](https://topherlicious.itch.io/ezafx) - GameMaker 的即时预设音频效果。
- [GMSync](https://topherlicious.itch.io/gmsync) - 将游戏元素与音乐节奏完美同步。
- [MicVol](https://topherlicious.itch.io/micvol) - 在 GameMaker 中轻松实时监控麦克风音量。 💸
...
- [Random Dungeon Generator](https://github.com/BlaXun/Random-Dungeon-Generator-GMS-2.3) - 组合用户定义的房间来创建地牢。
...
- [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) - 简化运行时的房间加载。非常适合可重复使用的房间预制件和程序生成。

## 颗粒

- [Particle Editor](https://gamemakercasts.itch.io/particle-editor) - 使用简单的 UI 创建粒子并导出到 GML 代码。
...
- [Pulse](https://github.com/Delfos1/Pulse) - 用于创建更复杂的粒子发射器、系统和粒子的库。
- [Burrn](https://github.com/FoxyOfJungle/Burrn) - 内置粒子系统，使用 IDE 中内置的粒子资源。
...
- [Crystal](https://foxyofjungle.itch.io/crystal-2d-lighting-engine) - 完整高效的 2D 照明和阴影解决方案。 💸

## 着色器

- [TransFX](https://short-bread.itch.io/transfx) - 过渡图书馆。
- [Post-Processing FX](https://foxyofjungle.itch.io/post-processing-fx) - 50 多种高品质、可定制的效果。 💸
- [Lens Distortion FOV](https://foxyofjungle.itch.io/lens-distortion-fov-shader) - 有用的 FOV 深度效果。 💸
- [Fast Blur Area](https://foxyofjungle.itch.io/foxey-blur-area) - 只需两行代码即可快速实现 alpha 模糊着色器效果。 💸
- [Transitions Pro](https://foxyofjungle.itch.io/foxey-transitions-pro) - 42 个可定制的过渡。 💸
- [Sketch Cartoon Shader](https://foxyofjungle.itch.io/sketch-cartoon-shader) - 将您的游戏视觉效果转变为绘画/素描风格。 💸
- [2D Water Reflections](https://foxyofjungle.itch.io/water-reflective) - 可定制的水对象可以轻松显示倒影。 💸
...
- [Depth Sorted Silhouettes](https://pixelatedpope.itch.io/depth-sorted-silhouette-example) - 演示基于着色器的深度排序轮廓的示例项目。在 PC、Mac、HTML5 和 Android 上进行了测试。
...
- [Dual-Kawase](https://github.com/XorDev/Dual-Kawase/wiki) - 限制半径但非常高效的模糊着色器。
- [Xor's Halftone](https://xordev.itch.io/halftone) - 一款出色的多功能半色调着色器。许多可调整的设置。
...
- [Jump Flooding](https://terohannula.itch.io/jump-flooding-algorithm) - 使用着色器制作的 GameMaker 跳跃洪泛算法。
...
- [Shadertoy to GameMaker](https://github.com/jfkn1ght/Shadertoy2GM) - 转换shadertoy.com 着色器以在GameMaker (GLSL ES) 中运行。
...
- [DopeFish Respawned](https://lemontoast-games.itch.io/dopefish-respawned) - 广泛的 WAD 管理器可在 GameMaker 中加载《DOOM》地图。
- [Blender to GameMaker](https://github.com/blender-to-gmstudio) - 用于将 Blender 模型导出到 GameMaker 以及从 GameMaker 导入 Blender 模型的脚本集合。
- [DmrVBM](https://github.com/Dreamer13sq/DmrVBM-blender-to-gms2) - 导入/导出工具可将顶点缓冲区数据从 Blender 加载到 GMS 中。
...
- [Collisions](https://dragonite.itch.io/collisions) - 与原生 GML 配合使用的 3D 碰撞系统。
- [Bonk](https://github.com/JujuAdams/Bonk) - 另一个很酷的碰撞库，处理大多数碰撞形状用例。
...
- [glTF parser](https://bitbucket.org/tijit/gltf-parser-for-gamemaker-lts/src/main/) - 支持动画的模型加载器。
- [GMFlux](https://github.com/Fanatrick/GMFlux) - Heightfield 流体模拟求解器。
...
- [Sprite Stacking Tutorials](https://www.youtube.com/watch?v=VIDN-nG3EOU&list=PL3Kbpztq9qwT9MbW_k4yyJU__or1r8P2j) - 小发明199。 ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
...
- [Patchwire-GM](https://github.com/gm-core/patchwire-gm) - 如果您想在不使用整个 gm-core 套件的情况下使用此实现，请使用 gm-core 的网络库。
...
- [Multiplayer Networking Tutorial](https://www.youtube.com/watch?v=NbsXRuNijlo&list=PLxaJReoxlrY_S4MrCYjzFCSrNX1TUX626) - 维齐尔迪。 ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
- [Good GameMaker Rollback](https://springrollgames.itch.io/ggmr) - 回滚网络代码库。
- [GM Networking](https://github.com/gmclan-org/gm_networking) - 非常简单的网络代码演示。
- [Boomers Networking](https://github.com/gmclan-org/gm_boomers_networking) - 使用 GM 本机函数模仿 GM 之前的网络库：Studio 最喜欢的网络扩展 39dll。
- [Rocket Networking Engine](https://marketplace.gamemaker.io/assets/11424/rocket-networking-engine) - 简单的低代码多人游戏引擎。

## 集成

- [DHook](https://github.com/tabularelf/DHook) - 不和谐整合。
- [GMS2_RPC](https://github.com/Mtax-Development/GMS2_RPC) - 另一个 Discord 集成。
- [NekoPresence](https://marketplace.yoyogames.com/assets/9526/nekopresence) - 哎呀，所有 Discord 都集成了。
- [GMHook](https://github.com/Kruger0/GMHook) - 我们真的很喜欢 Discord 集成。
...
- [GameMaker Cameras: As Simple as Possible](https://www.youtube.com/watch?v=_g1LQ6aIJFk) - Pixelated Pope 关于 GameMaker 相机系统的指南。 ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
...
- [REZOL](https://foxyofjungle.itch.io/rezol) - 完整的分辨率和屏幕管理器（支持分屏）。 💸
...
- [DuplicateSequence](https://github.com/KeeVeeGames/DuplicateSequence.gml) - 制作序列资产/结构的深层副本，以便在运行时进行编辑。
...
- [True State](https://pixelatedpope.itch.io/truestate) - 功能丰富的有限状态机可以处理复杂的对象。
- [Pinocchio](https://github.com/JujuAdams/Pinocchio) - 基于状态的动画系统。
- [BehaviorTree](https://github.com/Gizmo199/BehaviorTree) - 一个简单的行为树系统。
- [FSM AI](https://github.com/gmclan-org/FSM-AI-module) - NPC AI 的有限状态机。
...
- [Pathfinding in graph](https://github.com/gmclan-org/dijkstra-graph) - （加权）图中的最短寻路系统，使用 Dijkstra 算法。
- [PathPlus](https://delfos1.itch.io/pathplus-for-gamemaker/devlog/1115089/pathplus-220-follower-and-spriter) - 使用 CatmullRom 和 Bezier 插值增强 GameMaker 路径。
...
- [GameMaker Kitchen](https://www.gamemakerkitchen.com/) - 开源库、资产和片段的另一个重要资源。
...
- [GitHub Yacc to GML Fix](https://www.reddit.com/r/gamemaker/comments/n5m35l/a_simple_fix_for_github_incorrectly_detecting/) - 告诉 GitHub 你的仓库全部是 GML，而不是 Yacc。
- [GameMaker Repo Badges](https://github.com/matthiaszarzecki/MadeWithGameMakerStudioBadges) - 添加到您的自述文件中的精美徽章。
- [GameMaker Discord Community GitHub](https://github.com/GameMakerDiscord) - 您制作过想要分享的游戏制作工具吗？考虑将其提交到官方 Discord 的 GitHub。
...
- [Game Resolution & Aspect Ratio Management](https://www.youtube.com/watch?v=_g1LQ6aIJFk&list=PLXkVsacazW2qvdnKNzgBLkUwlgi3FU-VO) - 像素化的教皇。 ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
...
- [Tome](https://github.com/chesrowe/Tome/) - 从 GameMaker 项目自动生成文档站点。
- [Piano example](https://github.com/gmclan-org/piano_example) - 仅使用一个音频文件通过改变音高来演奏乐器音符的示例。
- [Compatibility scripts](https://github.com/gmclan-org/compatibility-scripts) - GM 在导入 GM:S 1.4 项目时使用的脚本，直接从运行时文件获取。
- [Pause example](https://github.com/gmclan-org/pause_no_surface) - 不使用表面的暂停屏幕的简单示例。
- [Build Automation, CI/CD](https://gist.github.com/shichen85/887d237cdc4338fa3f4e4749a14990db) - 有关使用 GitHub Actions 作为 CI/CD 管道来自动构建游戏的教程。
- [BROKVN](https://cowcat.itch.io/brokvn-engine) - 视觉小说引擎。
- [AssParser](https://github.com/DecadeDecaf/AssParser) - 视频播放支持字幕。
- [Ultimate Optimization Tier List](https://forum.gamemaker.io/index.php?threads/the-ultimate-gamemaker-optimization-tier-list.122141/) - 关于 GameMaker 优化的优秀论坛帖子。

## 博客

- [RefresherTowel](https://refreshertowelgames.wordpress.com/category/tutorial/) - 包含多个有关关卡生成的帖子。
- [Tony Str](https://tonystr.net/) - 一些关于使用 JSON、正则表达式 *(regex)* 以及在 GML 中绘制圆圈的精彩文章。
- [Katsaii](https://www.katsaii.com/content/blog/posts.html) - 一些关于更高级 GML 主题的文章。
- [Meseta on Game Dev](https://meseta.dev/) - 经验丰富的 GameMaker 开发人员对 GameMaker 概念和库的想法。
- [Thoughts On GameMaker](https://github.com/JujuAdams/ThoughtsOnGameMaker) - 不是传统博客，但提供有关不同 GML 技术的大量信息。
- [YellowAfterlife](https://yal.cc/category/gm/) - 中级/高级主题的教程。

## YouTube

- [Jordan Guillou](https://www.youtube.com/channel/UCBmOLRTaPrfOxnTqpCLrwdQ) - 业余爱好者独立开发者，拥有一些与 GameMaker 相关的教程。
- [DragoniteSpam](https://www.youtube.com/c/DragoniteSpam) - 涵盖 GameMaker 的高技术元素，重点关注 3D。
...
- [Pixelated Pope](https://www.youtube.com/c/PixelatedPope) - 有关 GameMaker 分辨率管理、相机、GUI 等的指南。
...
- [TheSnidr](https://www.youtube.com/c/TheSnidr) - 许多精彩的 GameMaker 3D 展示和教程。
- [Peyton Burnham](https://www.youtube.com/channel/UCfh2Q3TsvlxM1S2GvXQ4eeQ) - 针对自上而下的射击游戏和角色扮演游戏的 GameMaker 教程。
...
- [Matharoo](https://www.youtube.com/c/GameMakerStationMatharoo) - 大量免费 GameMaker 教程和有关 GameMaker 的新闻。
...
- [gentoo's iceberg Playlist](https://www.youtube.com/playlist?list=PLks6h7R6jAUGrofUAQB178r6K8h43Ml5-) - 系列基于 Iceberg 展示 GameMaker 中的高级编程思想。
...
- 这是基于 [GameMaker Libraries](https://github.com/FaultyFunctions/GameMakerLibraries) 和 Gleb Tsereteli 的列表以及其他链接/详细信息。
- 由于 GML 语法更改，大多数链接资源仅适用于“GameMaker 2.3+”。然而，如果您使用 GameMaker 1.4，如果有人对其项目进行向后移植，大多数库创建者都会很感激。 🙂
- 如果您需要更多通用游戏开发资源，请查看 [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) 或 [MagicTools](https://github.com/ellisonleao/magictools#readme)。

*GameMaker® 是 YoYo Games™ 的财产。此列表与 YoYo Games 无关。*

## 贡献

有什么很棒的东西要分享吗？查看[贡献指南](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md)。
