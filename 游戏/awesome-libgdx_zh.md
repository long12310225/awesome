...
# 很棒的 libGDX [![Awesome](https://awesome.re/badge-flat2.svg)](https://awesome.re)

> <a href="https://libgdx.com/"><img src="https://libgdx.com/assets/images/logo.png" alt="libGDX 徽标"align="right" style="margin-right: 25px" height=40></a>
>
> [libGDX](https://libgdx.com/) 是一个用 Java 编写的相对较低级别的、免费的、开源的跨平台游戏开发框架。
>
> 此列表是精选的资源、工具、教程和项目的集合，使用 [libGDX](https://libgdx.com/) 游戏框架帮助开发人员制作 _awesome_ 游戏，符合 [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/master/awesome.md)。
>
> 贡献_非常欢迎_但首先请参阅[贡献](#contributing)。
...
- [Resources](#resources)
  - [人工智能](#algorithms-and-ai)
  - [Controllers](#controllers)
  - [Editors](#editors)
  - [实体组件系统（ECS）](#entity-component-system-ecs)
  - [Physics](#physics)
  - [Services](#services)
  - [设置和部署](#setup-and-deployment)
  - [用户界面](#user-interface)
  - [视觉效果](#visual-effects)
  - [Audio](#audio)
  - [Others](#others)
...
### 算法和人工智能
- [gdx-ai](https://github.com/libgdx/gdx-ai) - 人工智能框架具有转向行为、编队运动、寻路、行为树和有限状态机。
- [Simple Graphs](https://github.com/earlygrey/simple-graphs) - 一个用于图形数据结构和算法（包括快速寻路）的java库。
...
- [Mundus](https://github.com/JamesTKhan/Mundus) - 用于 3D 世界的世界/关卡编辑器，具有 libGDX 运行时。
...
- [jbump](https://github.com/tommyettinger/jbump) - 易于实现 AABB 碰撞检测，对于平台游戏和其他简单的 2D 游戏很有用。
...
- [libgdx-library-template](https://github.com/tommyettinger/libgdx-library-template) - 用于创建新库的骨架项目，因为它们需要不同的配置。
...
- [InGameConsole](https://github.com/StrongJoshua/libGDX-inGameConsole) - 允许开发人员将控制台（类似于 Source 游戏中的功能）添加到他们的游戏中。
...
- [Ray3K Skins](https://ray3k.wordpress.com/artwork/) - 免费的 Scene2D.UI 皮肤，包含示例代码、自定义绘图和实验功能。
- [Skin Composer](https://github.com/raeleus/skin-composer) - 使用图形界面为 libGDX scene2d.ui 创建外观。
- [TenPatch](https://github.com/raeleus/TenPatch) - libGDX 9patch 实现的替代方案，可实现多个拉伸区域。
...
### 视觉效果
- [Box2DLights](https://github.com/libgdx/box2dlights) - 使用 Box2D 进行光线投射并使用 OpenGL ES 2.0 进行渲染的 2D 照明框架。
...
- [Particle Park](https://github.com/raeleus/Particle-Park) - 展示可下载的粒子效果并提供实时预览。
...
### 音频
- [TuningFork](https://github.com/Hangman/TuningFork) - 适合 libGDX 桌面用户的高级 3D 音频功能。
- [gdx-miniaudio](https://github.com/rednblackgames/gdx-miniaudio) - 基于 MiniAudio 的 libGDX 高级跨平台音频引擎。
- [gdx-sfx](https://github.com/spookygames/gdx-sfx) - libGDX 中一些可以带来更好音效的好东西。
- [gdx-pd](https://github.com/mgsx-dev/gdx-pd) - libGDX 的纯数据扩展。

### 其他
- [anim8-gdx](https://github.com/tommyettinger/anim8-gdx) - 允许从 Pixmap 序列中保存（动画）GIF 和 PNG，并在需要时使用可配置的抖动。
- [gdx-dbgagent](https://github.com/PokeMMO/gdx-dbgagent) - 用于调试常见问题的 Java 代理，例如未处理的对象和修改的 Color.WHITE 等常量。
...
- [libGDX Plugin](https://github.com/BlueBoxWare/LibGDXPlugin) - IntelliJ IDEA 和 Android Studio 的插件，添加了许多 libGDX 功能和工具，例如颜色预览和常见错误的附加检查。
...
- [Tann's Hello libGDX](https://colourtann.github.io/HelloLibgdx/) - 关于如何从头开始创建游戏的初学者的优秀指南。
- [Development Tutorial Playlist by Phillip Mod Dev](https://www.youtube.com/playlist?list=PLLwCf-qdpyEnB_FO_1HkUFh7smwGNjAaC) - 介绍 libGDX 基础知识的一系列视频。
- [Brandon Grasley's Space Shooter Game](https://www.youtube.com/playlist?list=PLfd-5Q3Fwq0WKrkEKw12nqpfER3MG5_Wi) - 有关从头开始制作完整 Android 游戏的视频教程系列。
- [Creating a Launcher](https://youtu.be/3l5F7f7vfTU) - 有关使用 libGDX 制作游戏启动器的视频教程。
...
- [Scene2D.UI From the Ground Up](https://github.com/raeleus/skin-composer/wiki/From-the-Ground-Up:-Scene2D.UI-Tutorials) - 涵盖了 Scene2D（libGDX 的首屈一指的场景图和布局工具包）中 UI 设计的基础知识。
...
### 一般学习材料
- [Book of Shaders](https://github.com/patriciogonzalezvivo/thebookofshaders) - 逐步指导片段着色器的抽象和复杂的世界。 GLSL。
- [Game Programming Patterns](https://gameprogrammingpatterns.com/) - 游戏的架构和设计模式。

## 资产

_免费且高质量的资源集合，让您的游戏更上一层楼。_

- [Kenney Assets](https://kenney.nl/) - 为您的游戏提供从 2D 和 3D 艺术到音效的高质量资源。
- [OpenGameArt.org](https://opengameart.org/) - 提供各种开放内容资产的存储库。
- [Game-Icons.net](http://game-icons.net/) - 包含大量酷炫游戏相关图形的存储库。
- [Jsfxr](https://chr15m.itch.io/jsfxr) - 只需按几个按钮即可快速创建独特的音效，非常适合原型制作。
...
- [Discord](https://discord.gg/4S8pQqc) - 每天都可以与社区的各个领导人进行积极的聊天。 **推荐**
...
- [Game Accessibility Guidelines](http://gameaccessibilityguidelines.com/) - 包容性游戏设计的简单参考，以确保游戏对尽可能多的人来说都一样有趣。 **推荐**
- [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) - 用于制作精彩游戏的免费软件和免费文化资源的集合。
