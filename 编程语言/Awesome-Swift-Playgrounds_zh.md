# 很棒的 Swift Playgrounds！[156 个游乐场](https://img.shields.io/badge/Playgrounds:-156-orange.svg) [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re)

> 精彩的 Swift 游乐场精选列表。

### 贡献

请先快速浏览一下[贡献指南](https://github.com/uraimo/awesome-swift-playgrounds/blob/master/CONTRIBUTING.md)。感谢所有[贡献者](https://github.com/uraimo/awesome-swift-playgrounds/graphs/contributors)；你摇滚！
...
所有 Playgrounds 都可以作为 `playgrounds/` 目录中的子模块提供，要一次性下载它们，只需使用 `git clone --recursive https://github.com/uraimo/Awesome-Swift-Playgrounds.git` 克隆此存储库，或者在以通常的方式克隆存储库后执行 `git submodule update --init` 。
...
- [WWDC 学生提交的材料](#wwdc-students-submissions)
- [PlaygroundBooks](#playgroundbooks)
- [学习斯威夫特](#learning-swift)
- [学习 Swift：高级主题](#learning-swift-advanced-topics)
  - [设计模式](#design-patterns)
  - [面向协议的编程](#protocol-oriented-programming)
  - [函数式反应式编程](#functional-reactive-programming)
- [苹果的游乐场](#apples-playgrounds)
- [游乐场 关于游乐场](#playgrounds-about-playgrounds)
- [Playgroundbooks 中的游乐场](#playgrounds-from-playgroundbooks)
- [理论计算机科学](#theoretical-computer-science)
    - [算法和数据结构](#algorithms-and-data-structures)
    - [Languages](#languages)
    - [机器学习](#machine-learning)
- [UIKit 和图形](#uikit-and-graphics)
  - [核心形象](#core-image)
  - [Metal](#metal)
...
- [库和 API](#libraries-and-apis)
- [游乐场套装](#playground-sets)
...
- 最新：[2026](https://github.com/wwdc/2026)
- 过去的版本：[2025](https://github.com/wwdc/2025)、[2024](https://github.com/wwdc/2024)、[2023](https://github.com/wwdc/2023)、[2022](https://github.com/wwdc/2022)、 [2021](https://github.com/wwdc/2021)、[2020](https://github.com/wwdc/2020)、[2019](https://github.com/wwdc/2019)、[2018](https://github.com/wwdc/2018)、[2017](https://github.com/wwdc/2017)、 [2016](https://github.com/wwdc/2016)、[2015](https://github.com/wwdc/2015)、[2014](https://github.com/wwdc/2014)

## 游乐场书籍
*可以在 iPad 上运行的游乐场*

* [Guilloche Pattern Playground Book](https://github.com/TheWildHorse/GuillochePlayground) - 了解更多有关您每天看到的这种模式的信息，但可能从来不知道它是经过精心设计的。 🍁
...
* [What's new in Swift 4](https://github.com/ole/whats-new-in-swift-4) - Xcode 游乐场展示了 Swift 4.0 中的新功能。 🍁🌟
* [What's new in Swift 4.2](https://github.com/ole/whats-new-in-swift-4-2) - Xcode 游乐场展示了 Swift 4.2 中的新功能。 🍁🌟
...
* [The Swift Summary Book](https://github.com/jakarmy/swift-summary) - Apple Swift 语言摘要。 🌟
...
* [Katan](https://github.com/marciok/katan) - 一个回复“Hello world!”的微型网络服务器对于每个请求，都有一个如何在 Swift 中使用套接字的示例。
...
* [Swift Memory Management](https://github.com/ndethore/swift-memory-management) - 如何避免循环引用，来自[这篇文章](http://detho.re/2016/01/21/writing-memory-efficient-swift-code/)。 ⏳
...
* [Swift Reactive Playground](https://github.com/ColinEberhardt/SwiftReactivePlayground) - 本文配套内容：ReactiveCocoa 使用 Swift 变得简单。 ⏳


## 苹果的游乐场
*Apple 的 Playground，通常在某些 WWDC 上展示*

* [Apple's Mandelbrot Playground](https://github.com/palmerc/Mandelbrot-Swift-Playground) - 带有曼德尔布罗分形的游乐场（由 @palmerc、@kemalenver 更新至 Swift 3）。
...
* [Apple's Balloons Playground](https://developer.apple.com/swift/blog/downloads/Balloons.zip) - 气球游乐场在 WWDC14 上亮相。 ⏳
* [Apple's Crustacean Playground](https://developer.apple.com/sample-code/wwdc/2015/downloads/Crustacean.zip) - 使用值类型进行面向协议的编程。 ⏳
...
* [Functional Debug View](https://github.com/tomquist/DebugView) - 使用图形序列可视化函数式编程的 Playground。 🍁🌟
...
* [Swift Functors, Applicatives, and Monads in Pictures](https://github.com/mokacoding/Swift-Functors-Applicative-Monads-In-Pictures-Playground) - 本文配套内容：图片中的 Swift Functors、Applicatves 和 Monad。 ⏳
...
* [Swift Algorithm Club](https://github.com/raywenderlich/swift-algorithm-club) - Swift 中的算法和数据结构及其解释。 🌟
* [Sorting Experiments](https://github.com/adrfer/Sort) - 在 Swift 中进行排序算法的实验有点诱人。
...
* [Turtle Playground](https://github.com/dimsumthinking/TurtlePlayground) - 具有类似徽标命令的游乐场。 🌟⏳
* [Swift Brainfuck](https://github.com/xavieryao/Swift-Brainfuck) - Brainfuck 解释器使用 Playground 用 Swift 编写。 ⏳
...
* [UIStackView Playground](https://github.com/dasdom/UIStackViewPlayground) - UIStackViews 的有趣使用示例。🌟
* [Bezier Path Playgrounds](https://github.com/DigitalLeaves/BezierPathPlaygrounds) - 一些游乐场可以更好地理解 UIBezierPaths。
* [UIKit playground](https://github.com/ralfebert/uikit-playground) - 使用 UIKit 视图进行交互实验的游乐场。
* [UIDynamic Playground](https://github.com/andresbrun/UIDynamicsPlayground) - 多个 Playgrounds 几乎使用了 UIDynamic 的所有行为。
...
* [RPClarity](https://github.com/RobotsAndPencils/RPClarity) - 展示了一种用于模糊一个或多个 UILabels 后面的字符后面的图像的技术。 ⏳
...
* [Ray tracing Playground](https://github.com/mhorga/Raytracing) - 有关光线追踪的游乐场和一系列文章，另请参阅第 [2](https://github.com/mhorga/Raytracing2)、[3](https://github.com/mhorga/Raytracing3)、[4](https://github.com/mhorga/Raytracing4)、[5](https://github.com/mhorga/Raytracing5) 🌟 ⏳
...
* [CoreImage for Swift Playgrounds](https://github.com/FlexMonkey/CoreImageForSwiftPlaygrounds) - 即将出版的书“CoreImage For Swift”中不断增加的 CoreImage 游乐场集合。 🌟⏳
* [Image Processor](https://github.com/mortenbrudvik/ImageProcessor) - 实现不同的图像过滤算法。 ⏳

### 金属

* [Metalbrot](https://github.com/jtbandes/metalbrot-playground) - 用 Metal 绘制 Mandelbrot 分形的交互式游乐场。 🌟
...
* [WWDC Crowd Simulator 2017](https://github.com/neilsardesai/WWDC-Crowd-Simulator-2017) - 一个模拟 WWDC2017 标志人群的 SpriteKit 实验。
...
* [Bach Playground](https://github.com/dreamwieber/BachPlayground) - 一个简单的 Swift Playground，使用 AVAudioEngine 和 AVMIDIPlayer 播放巴赫的一段简短作品。
...
* [Swift Natural Numbers](https://github.com/jakebromberg/Swift-Natural-Numbers) - 用于实现自然数和更多数论概念的游乐场。
* [Polydoxical](https://github.com/kirkbyo/Polydoxical) - 用于实验轮盘赌和多边形的互动游乐场。
...
* [Parks And Recreation](https://github.com/zwaldowski/ParksAndRecreation) - 有趣的游乐场的大集合，既有趣又有利可图。 🍁🌟
* [URaimo's Playgrounds](https://github.com/uraimo/Swift-Playgrounds) - 我的游乐场，各种主题。 🍁
* [Public Extensions](https://github.com/Jasdev/Public-Extension) - 来自 [@PublicExtension](https://twitter.com/publicextension) 的一组有用扩展。 🌟
...
* [Dmikusa's Playgrounds](https://github.com/dmikusa/swift_playgrounds) - 展示基本 Swift、JSON 解析、发送 HTTP 请求和基本文件 IO 的 Playground。 ⏳
...
* [2048 Playground](https://github.com/robin/2048_Playground) - 2048 游戏是用游乐场实现的。
...
* [Tic Tac Toe](https://github.com/aabosh/Tic-Tac-Toe) - 操场上的井字游戏。
...
* [Game Boards](https://github.com/joalbright/Gameboard) - 操场上有国际象棋、西洋跳棋、井字游戏、数独等等。 🌟⏳
* [StarWars Seals](https://github.com/jeremyconkin/StarWarsSeals) - 通过 CoreGraphics 和 UIViews 在 Swift 游乐场中展示星球大战的徽章。 ⏳
