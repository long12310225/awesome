...
> [AutoIt](https://www.autoitscript.com/) 的精彩 UDF、示例脚本、工具和有用资源的精选列表。

由 [Juno_okyo](https://twitter.com/juno_okyo) 创建。受到 [awesome](https://github.com/sindresorhus/awesome) 列表的启发。
...
- [很棒的 AutoIt](#awesome-autoit-)
  - [UDF/Libraries](#udflibraries)
    - [Automation](#automation)
      - [Browsers](#browsers)
      - [微软办公软件](#microsoft-office)
      - [OpenOffice](#openoffice)
    - [数据库和网络连接](#databases-and-web-connections)
    - [数据压缩](#data-compression)
    - [加密和哈希](#encryption-and-hash)
    - [图形用户界面添加](#gui-additions)
    - [Controls](#controls)
    - [Hardware](#hardware)
    ...
    - [Maths](#maths)
    - [Media](#media)
    - [图形和图像](#graphics-and-image)
    - [Players](#players)
    - [Sound](#sound)
    - [PDF](#pdf)
    - [Security](#security)
    - [社交媒体和其他网站 API](#social-media-and-other-website-api)
    - [Windows](#windows)
    - [Misc](#misc)
  - [Tools](#tools)
...
**[用户定义函数](https://en.wikipedia.org/wiki/User-defined_function)** (UDF) 的库列表。这些库的编写可以轻松集成到您自己的脚本中，对于任何程序员来说都是非常有价值的资源。
...
- [WiFi (by MattyD)](https://www.autoitscript.com/forum/index.php?showtopic=91018) - 对无线 LAN 的低级控制。
- [AutoItMonkey](https://github.com/ohtejera/AutoItMonkey) - AutoItMonkey 是一个 UDF，它在 Android 模拟器或设备上运行，并生成用户事件的伪随机流，例如单击、触摸或手势，以及许多系统级事件。
- [ImperiusAutoIt](https://ohtejera.github.io/ImperiusAutoIt/) - Imperius AutoIt 是一个 [ImperiusGeorge](https://github.com/lookout/ImperiusGeorge) 客户端，用于支持本机 Android 应用程序的移动测试自动化。
- [3270 (by Worlor)](https://github.com/Worlor/AutoIt-3270) - 使用 AutoIT 实现 3270 终端自动化的库

#### 浏览器

- [Chrome (by seangriffin)](https://www.autoitscript.com/forum/index.php?showtopic=154439) - 与上面的 Google Chrome 相同。使用 Chrome UDF 自动执行 Chrome 中最常见的任务。
- [Firefox (by Stilgar)](https://www.autoitscript.com/forum/index.php?showtopic=95595) - 对自动化的支持比 IE 少一点，但仍然非常好。
- [FireFox Profile Backup 1.0 (by careca)](https://www.autoitscript.com/forum/files/file/224-firefox-profile-backup/) - 备份或恢复您的 Firefox 配置文件，应用程序会在主驱动器中搜索配置文件，这将是要备份的配置文件。
...
- [_FF_FoxBox (by Stilgar)](https://www.autoitscript.com/forum/index.php?showtopic=91650) - UDF 使用 FF.au3 控制 Fox!Box（AVM FRITZ!Box 的 Mozilla Firefox 扩展）。
...
- [_HTML (by Stilgar)](https://www.autoitscript.com/forum/topic/124330-_htmlau3-v101/) - 无需任何浏览器即可从任何 HTML (XML) 源获取信息。
...
- Microsoft Office Excel（由 water 等人提供） - 此 UDF 包含在 AutoIt 中。链接到[文档](https://www.autoitscript.com/wiki/Excel_UDF)页面。
...
- [Microsoft Office Outlook (by water)](https://www.autoitscript.com/forum/index.php?showtopic=126305) - 自动化 Microsoft Outlook。链接到[文档](https://www.autoitscript.com/wiki/OutlookEX_UDF_-_General)页面。
- [Microsoft Office PowerPoint (by Toady)](https://www.autoitscript.com/forum/index.php?showtopic=50254) - 自动化 Microsoft PowerPoint。
- Microsoft Office Word（由 water 等人提供） - 此 UDF 包含在 AutoIt 中。链接到[文档](https://www.autoitscript.com/wiki/Word_UDF)页面。
...
- [DBF (by funkey)](https://www.autoitscript.com/forum/index.php?showtopic=145142) - dBase数据库通过DLL进行读写。
- [EzMySql (by oriz)](https://www.autoitscript.com/forum/index.php?showtopic=116072) - EzMySql - 通过 autoit 使用 MySql 数据库.
...
- [SQLite (by ptrex)](https://www.autoitscript.com/forum/index.php?showtopic=17099) - SQLite 是一个实现独立、可嵌入、零配置的 SQL 数据库引擎的库。
- [SQLite Array Functions (by SmOke_N)](https://www.autoitscript.com/forum/index.php?showtopic=142977) - SQLite 数组函数 - 一种更快的独特数组和排序方法。
- [XML DOM Wrapper (by eltorro)](https://www.autoitscript.com/forum/index.php?showtopic=19848) - 支持对 XML 的 CRUD 操作。包括XSL和XPath。
...
- [MessagePack (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=166634) - MessagePack 是一种高效的二进制序列化格式。它允许您在多种语言之间交换数据，例如 JSON。但它更快、更小。
- [Package (by Yashied)](https://www.autoitscript.com/forum/index.php?showtopic=138838) - 封装 UDF。
...
- [Zip plugin (by eltorro)](https://www.autoitscript.com/forum/index.php?showtopic=44524) - 邮编插件。
- [ZIP (by torels)](https://www.autoitscript.com/forum/index.php?showtopic=73425) - 纯 AutoIt 中的 ZIP.au3 UDF。
- [zip (by wraithdu)](https://www.autoitscript.com/forum/index.php?showtopic=116565) - 创建 ZIP 文件并解压 ZIP 文件。
- [ZIP (by joakim)](https://www.autoitscript.com/forum/index.php?showtopic=135565) - ZIP 结构 UDF（从头开始）。
- [zLib (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=128962) - zLib（收缩/膨胀/GZIP）UDF。
- [XZip (by eltorro)](https://www.autoitscript.com/forum/index.php?showtopic=17727) - 另一个“XStandard XZIP 组件”的 UDF。
...
- [MD5,SHA1,CRC32,RC4,BASE64,XXTEA (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=76976) - 多种加密和哈希函数。
...
- [ContextHelp.au3 (by Yashied)](https://www.autoitscript.com/forum/index.php?showtopic=96258) - 上下文帮助管理（[原文](https://www.autoitscript.com/forum/index.php?showtopic=72152-contexthelp/)）。
- [Easy Scrollbars (by Melba23)](https://www.autoitscript.com/forum/index.php?showtopic=113723) - 在 GUI 中轻松创建可滚动部分。
- [ExtMsgBox (by Melba23)](https://www.autoitscript.com/forum/index.php?showtopic=109096) - MsgBox 的一个非常可定制的替代品。
- [GUICtrlOnChangeRegister (by Mat)](https://www.autoitscript.com/forum/index.php?showtopic=105582) - 当编辑内容改变时调用函数。
- [GUIExtender (by Melba23)](https://www.autoitscript.com/forum/index.php?showtopic=145149) - 展开和收缩 GUI 的部分（[原始](https://www.autoitscript.com/forum/index.php?showtopic=117909)）。
...
- [Modern tray menu (by Holger)](https://www.autoitscript.com/forum/index.php?showtopic=20967) - 允许创建现代、精美的 GUI 和带有图标和颜色的托盘菜单。
- [Pie chart (by Andreik)](https://www.autoitscript.com/forum/index.php?showtopic=161750) - 饼图。
- [SetOnEvent (by martin)](https://www.autoitscript.com/forum/index.php?showtopic=71811) - 为事件提供一种简单的方法来调用带有参数的函数。
- [Uskin (by JScript)](https://www.autoitscript.com/forum/index.php?showtopic=132864) - 允许用户使用 Windows _.MSstyles_ 文件为其应用程序 GUI 设计外观的库。
- [Toast (by Melba23)](https://www.autoitscript.com/forum/index.php?showtopic=108445) - 从系统托盘中弹出的小消息 GUI。
- [XSkin (by Valuater)](https://www.autoitscript.com/forum/index.php?showtopic=32494) - 一个大型库，允许为 GUI 设计皮肤并应用自定义皮肤。
- [Real Vista Aero Glass (by James)](https://www.autoitscript.com/forum/index.php?showtopic=75429) - Real Vista Aero Glass UDF - 您可以将玻璃效果应用于您的 GUI。
...
- [GUICtrlCreateFinder (by Mat)](https://www.autoitscript.com/forum/index.php?showtopic=105682) - 允许您创建一个窗口查找器控件，如 AutoIt 窗口信息中看到的那样。
- [GUITreeViewEx (by Melba23)](https://www.autoitscript.com/forum/index.php?showtopic=166594) - 检查/清除 TreeView 中的父级和子级复选框。
...
- [Hotkey input control (by Yashied)](https://www.autoitscript.com/forum/index.php?showtopic=90598) - 热键输入控制 UDF 库（非本机）。
...
- [Ribbon (by trancexx)](https://www.autoitscript.com/forum/index.php?showtopic=128242) - Windows Ribbon 框架的 UDF。
...
- [CommAPI](/wiki/CommAPI "CommAPI")（by therealhanuta） - 串行和并行通信（COM 端口、RS-232、LPT 端口） - 无需安装 DLL（使用 Windows API 调用）。
...
- [Mouse (by AlmarM)](https://www.autoitscript.com/forum/index.php?showtopic=155469) - AutoIt 支持鼠标事件。
- [MouseTrapEvent (by ozmike)](https://www.autoitscript.com/forum/index.php?showtopic=147325) - MouseTrapEvent UDF。
- [NetInfo (by Nessie)](https://www.autoitscript.com/forum/index.php?showtopic=149083) - UDF 用于测试互联网下载速度和上传速度。
...
- [Computer information (by JSThePatriot)](https://www.autoitscript.com/forum/index.php?showtopic=29404) - 一个通用库，用于获取有关 Windows 计算机的各种详细信息。
...
- [cURL (by Ward)](https://www.autoitscript.com/forum/topic/173067-curl-udf-autoit-binary-code-version-of-libcurl-with-ssl-support/) - 支持 SSL 的 libcurl AutoIt 二进制代码版本。
...
- [JSON (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=148114) - JSMN - 非严格 JSON UDF。
- [JSON (by ozmike)](https://www.autoitscript.com/forum/index.php?showtopic=156794) - 桥接本机 Windows JSON 以及 AutoIt 的 OO 扩展。
...
- [Prowl (by mrflibblehat)](https://www.autoitscript.com/forum/index.php?showtopic=154530) - 使用 Prowl（iOS 版 Growl 客户端）将通知推送到 iPhone、iPod touch 或 iPad。
...
- [SFTP (by Lupo73)](https://www.autoitscript.com/forum/index.php?showtopic=138095) - UDF 使用 PSFTP 支持 SFTP 协议。
- [SMTP (by Jos)](https://www.autoitscript.com/forum/index.php?showtopic=23860) - 支持 Html 和附件的 Smtp 邮件程序。
- [SNMP (by enaiman)](https://www.autoitscript.com/forum/index.php?showtopic=81687) - SNMP_UDF 用于 SNMPv1 和 SNMPv2c。
- [SNMP - MIB protocol (by ptrex)](https://www.autoitscript.com/forum/index.php?showtopic=70759) - 使用 WMI 从 SNMP 设备读取墨粉状态。
...
- [WinHTTP (by trancexx)](https://www.autoitscript.com/forum/index.php?showtopic=84133) - 访问HTTP协议以创建GET和POST请求并以符合标准的方式提交它们，不支持cookie。
...
- [Advanced Math UDF (by scintilla4evr)](https://www.autoitscript.com/forum/index.php?showtopic=170658) - 这是一个充满高级数学函数的UDF。它允许使用素数、创建数字序列、插值、计算黎曼 zeta 等函数的值。
- [Advanced rounding (by Mat)](https://www.autoitscript.com/forum/index.php?showtopic=102686) - 支持不同的准确度衡量标准以及 8 种解决抢七的方法。
- [Big number (by eukalyptus)](https://www.autoitscript.com/forum/index.php?showtopic=83529) - 使用 AutoIt 通常无法支持的极大数字进行计算。
- [Decimal To fraction (by Malkey)](https://www.autoitscript.com/forum/index.php?showtopic=106551) - 将任何小数转换为分数。示例：1.2 至 6/5。
- [Number base conversion (by james3mg)](https://www.autoitscript.com/forum/index.php?showtopic=81189) - From、to 和之间的正碱基数小于 63（支持小数）。
...
- [Root function (by Mat)](https://www.autoitscript.com/forum/index.php?showtopic=98160) - 计算数字的实根。
...
- [OCR (by ptrex)](https://www.autoitscript.com/forum/index.php?showtopic=50608) - AU3 中的真正 OCR - MODI 与 MS Office 2003。
...
- [Printer controller (by martin)](https://www.autoitscript.com/forum/index.php?showtopic=51054) - 在页面上的任何位置以任何字体、大小和颜色打印文本，以任何颜色绘制线条、曲线、椭圆、饼图以及打印图像。
...
- [Simple DirectMedia Layer (by AdmiralClaws)](https://www.autoitscript.com/forum/index.php?showtopic=94834) - 添加了对操纵杆、CD、2D 图形、计时器的支持。请参阅 [SDL 网站](http://www.libsdl.org/) 了解更多信息。
...
- [au3Irrlicht2 (by JRowe)](https://www.autoitscript.com/forum/index.php?showtopic=113881) - 另一个将 Irrlicht 和 au3 结合在一起的 UDF。历史上是上述 UDF 的某种追随者，技术上采用完全不同的方法。
...
- [OpenGL (by LarsJ)](https://www.autoitscript.com/forum/index.php?showtopic=151011) - OpenGL，无需外部库等。对于 JPEG 文件，UDF 还检索各种 Exif 信息。
- [OpenGL (2.0) (by minx)](https://www.autoitscript.com/forum/index.php?showtopic=148129) - OpenGL + AutoIt 的新 UDF 集。
...
- [TTS (by Beege)](https://www.autoitscript.com/forum/index.php?showtopic=100439) - 文本转语音 UDF。
- [libZPlay (by Danyfirex)](https://www.autoitscript.com/forum/index.php?showtopic=173808) - UDF for libZPlay - 用于播放 mp3、mp2、mp1、ogg、flac、ac3、aac、oga、wav 和 pcm 文件和流的多媒体库。
...
- [Debenu PDF Viewer SDK (by mLipok)](https://www.autoitscript.com/forum/index.php?showtopic=164469) - 使用 Debenu PDF Viewer SDK 在应用程序中显示 PDF 文件的功能集合。
...
- [PDFCreator (by mLipok)](https://www.autoitscript.com/forum/index.php?showtopic=170550) - PDFCreator v1.x.x 的 UDF 具有工作事件处理程序。
...
- [CrowdinAPI (by mLipok)](https://www.autoitscript.com/forum/index.php?showtopic=169333) - UDF 使用 [crowdin.net 网站 API](https://crowdin.com/page/api) 实现某些功能（创建项目、添加和更新文件、下载翻译或集成本地化）。
...
- [eBay (by seangriffin)](https://www.autoitscript.com/forum/index.php?showtopic=114801) - eBay UDF（来自“Shopping API”的 GetItemStatus 和 GetSingleItem 函数）。
...
- [Imgur](https://github.com/J2TeaM/AutoIt-Imgur-UDF) - AutoIt UDF 可帮助您使用 Imgur API 上传图像。
...
- [No-IP (by Nessie)](https://www.autoitscript.com/forum/index.php?showtopic=150985) - 使用此 UDF，您可以简单地更新您的 no-ip 主机名并检索 no-ip 地址的 IP 地址。
...
- [TeamViewer API (by mLipok)](https://www.autoitscript.com/forum/index.php?showtopic=166205) - TeamViewer API 的 UDF - 一个温和的开始。
...
- [System restore (by FredAI)](https://www.autoitscript.com/forum/index.php?showtopic=134628) - 系统恢复UDF。
...
- [Task Scheduler (by dbzfanatic)](https://www.autoitscript.com/forum/index.php?showtopic=83355) - 任务调度器 UDF。
...
- [WIMGAPI (by Homes32)](https://www.autoitscript.com/forum/index.php?showtopic=127075) - 用于在不使用 ImageX.exe 的情况下操作 Windows 映像文件 (.wim) 的 UDF。
...
- [Atom Table (by Ascend4nt)](https://www.autoitscript.com/forum/index.php?showtopic=163577) - 使用唯一的数字标识符在本地（程序级别）或全局（操作系统级别）存储字符串。该 UDF 允许您添加、查找、删除和查询这些原子。
- [Barcode generators (by willichan)](https://www.autoitscript.com/forum/index.php?showtopic=170087) - 根据提供的数据创建 Code128A/B/C 或创建 Code39 或 Code39Extended 优化条形码。
- [Binary (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=131037) - 二进制 UDF。
- [BinaryCall (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=162366) - BinaryCall UDF - 用 C 编写子例程，在 AutoIt 中调用。
- [Clipboard History (by wraithdu)](https://www.autoitscript.com/forum/index.php?showtopic=81267) - 保存并恢复整个剪贴板内容。受到 AHK 的 ClipboardAll 的启发。
- [CmdLine (by Jefrey)](https://www.autoitscript.com/forum/index.php?showtopic=169610) - 用于解析命令行参数的函数集合。
- [Copy (by Yashied)](https://www.autoitscript.com/forum/index.php?showtopic=121833) - 复制或移动文件和目录，无需暂停脚本。复制时检索当前状态（复制的字节、错误代码等）。
- [DDEML (by doudou)](https://www.autoitscript.com/forum/index.php?showtopic=55994) - 通过 DDEML UDF，我们可以使用 AutoIt 脚本作为 DDE 客户端或服务器。
...
- [FindMimeFromData (by twbradio)](https://www.autoitscript.com/forum/index.php?showtopic=157241) - 使用 urlmon.dll FindMimeFromData。
- [Hotkey.au3 (by Yashied)](https://www.autoitscript.com/forum/index.php?showtopic=90492) - 管理热键 UDF，与 HotkeySet() 相比具有多个优点。
- [Inline Assembly (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=86672) - 将代码组装为二进制机器代码并运行它。
- [LFN (by orbs)](https://www.autoitscript.com/forum/index.php?showtopic=161628) - LFN UDF - 克服 256 个字符的 MAX_PATH 限制。
- [LASM - Light Assembler (by minxomat)](https://www.autoitscript.com/forum/index.php?showtopic=173946) - 这是汇编器的内联 UDF
- [MemoryDll (by Ward)](https://www.autoitscript.com/forum/index.php?showtopic=77463) - 将 DLL 嵌入脚本并从内存中调用函数。
- [NoFocusLines (by Melba23)](https://www.autoitscript.com/forum/index.php?showtopic=101733) - 删除按钮、滑块、单选按钮和复选框中的虚线焦点线，这些线会破坏 GUI 的外观。
...
- [AutoItAppveyor (by KyleChamberlin)](https://github.com/AutoItMicro/AutoItAppveyor) - 该库包含用于将 AutoIt 脚本和程序与 Appveyor CI 集成的函数。
- [Micro Unit Testing Framework (by KyleChamberlin)](https://github.com/AutoItMicro/MicroUnitTestingFramework) - Micro 是一个 xUnit 风格的测试框架设计，与 AutoIt 一起使用。
- [TeenyScript (by tarretarretarre)](http://teenyscript.tarre.nu/documentation) - TeenyScript 是 AutoIt 的超集，这使得它更加先进。 TeenyScript 代码被解析为本机 AutoiT 代码。
- [Logger (by Worlor)](https://github.com/Worlor/AutoIt-Logger) - Logger 是一款非常易于使用的一体化日志实用程序！它启用日志每天轮换并在 x 天后对其进行压缩

## 工具

- [SciTE4AutoIt3](https://www.autoitscript.com/site/autoit-script-editor/downloads/) 包含 SciTE，包含在单个安装程序中，其中包含所有需要的配置设置和许多实用程序，例如 [AutoIt3Wrapper](https://www.autoitscript.com/autoit3/scite/docs/SciTE4AutoIt3/AutoIt3Wrapper.html)， [SciTEConfig]（https://www.autoitscript.com/autoit3/scite/docs/SciTE4AutoIt3/SciTEConfig.html），[Tidy]（https://www.autoitscript.com/autoit3/scite/docs/SciTE4AutoIt3/Tidy.html）， [Au3Stripper](https://www.autoitscript.com/autoit3/scite/docs/SciTE4AutoIt3/Au3Stripper.html) 等增强的 SciTE 与 AutoIt3 一起使用。
...
- [AutoIt 在线文档](https://www.autoitscript.com/autoit3/docs/)
- [SciTE4AutoIt3在线文档](https://www.autoitscript.com/autoit3/scite/docs/SciTE4AutoIt3.html) | [维基百科](https://www.autoitscript.com/wiki/SciTE4AutoIt3)

### 网站

- [官方网站](https://www.autoitscript.com/)
- [官方论坛](https://www.autoitscript.com/forum/)
+ [越南论坛](http://autoitvn.com/)
+ [法语论坛](http://www.autoitscript.fr/)
+ [巴西论坛](http://forum.autoitbrasil.com/)
+ [德国论坛](https://autoit.de/)
+ [俄语论坛](http://autoit-script.ru/)
+ [西班牙语论坛](http://www.emesn.com/autoitforum/)
- [维基百科](https://www.autoitscript.com/wiki)
- [Programs](https://www.autoitscript.com/wiki/AutoIt_Programs) - 在 AutoIt 中创建的程序列表。
- [Facebook 上的 AutoIt 群组](https://www.facebook.com/groups/autoitscript/)（越南语）。

### 指南/教程

- [Tutorials](https://www.autoitscript.com/wiki/Tutorials) - 有许多适用于 AutoIt 的教程。本页概述了一些已知的教程。
- [Best coding practices](https://www.autoitscript.com/wiki/Best_coding_practices) - 详细解释了 AutoIt 中什么是最佳编码实践。这些建议基于许多其他编程语言常见的公认编码实践。您不需要遵循它们，但建议您这样做。
- [Snippets](https://www.autoitscript.com/wiki/AutoIt_Snippets) - 通常是单个函数或小段代码，可以将其合并到脚本中以添加额外的功能。

### 视频

- [AutoIt 教程](https://www.youtube.com/playlist?list=PL1DCD109B801D0DE6) 由 403forbidden403 提供。
- AutoItFrench 的 [AutoIt 教程](https://www.youtube.com/user/AutoitFrench/videos)。
- [AutoIt 初学者](https://www.youtube.com/playlist?list=PLNeDQQ_ukvRoz5IKgFy1pgfZVqDuZf5X2) 作者：Lee Sai。
- [AutoIt 初学者](https://www.youtube.com/playlist?list=PLADZ5XR0fS9B1AL1FmLUCfrXoRu2nYOKu) 作者：Hai The Luong。
- [高级 AutoIt 教程](https://www.youtube.com/playlist?list=PL_-NI9iPtoB741rTw1hjNPirk3jTMKtrQ) 作者：Juno\_okyo [[订阅](https://www.youtube.com/channel/UCEETpUrNm5qI-LENbBON2Gw/?sub_confirmation=1)]。

### 书籍

- [AutoIt v3：您的快速指南](http://shop.oreilly.com/product/9780596515126.do)，作者：Andy Flesner（[下载 PDF](https://www.google.com/search?q=AutoIt+v3%3A+Your+Quick+Guide+filetype%3Apdf)）。
- [即时 AutoIt 脚本](https://books.google.com.vn/books?id=TgY2-RSxhDUC) 作者：Emilio Aristides de Fez Laso。
- [AutoIT 初学者脚本](https://books.google.com.vn/books?id=ugdeCgAAQBAJ) 作者：Rajan。
- [学习使用带有 AutoIt 1.2 的免费工具进行编程](https://www.autoitscript.com/forum/files/file/351-learn-to-program-using-free-tools-with-autoit/)，作者：Jfish。

### 语法荧光笔

- [GeSHi - 通用语法荧光笔](http://qbnz.com/highlighter/)
- [Highlight.js](https://highlightjs.org/) - 从 8.7 版本开始添加 AutoIt
- [Crayon 语法荧光笔](https://wordpress.org/plugins/crayon-syntax-highlighter/)（WordPress 插件） - 自 1.8.2 版起添加了 AutoIt
- [WP 语法](https://wordpress.org/plugins/wp-syntax/)（WordPress 插件）- 基于 GeSHi。
- [PrismJS](http://prismjs.com/) - 自 1.1.0 版本起添加了 AutoIt
...
- [真棒](https://github.com/sindresorhus/awesome) 作者：@sindresorhus
- [awesome-all](https://github.com/bradoyler/awesome-all) 作者：@bradoyler
- [真棒-真棒](https://github.com/emijrp/awesome-awesome) 作者：@emijrp
- [真棒-真棒](https://github.com/erichs/awesome-awesome) 作者：@erichs
- [真棒-真棒](https://github.com/oyvindrobertsen/awesome-awesome) 作者：@oyvindrobertsen
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) 作者：@bayandin
- [awesome-awesomes](https://github.com/fleveque/awesome-awesomes) 作者：@fleveque
- [awesome-collection](https://github.com/flyhigher139/awesome-collection) 作者：@flyhigher139
- [列表](https://github.com/jnv/lists) 作者：@jnv
