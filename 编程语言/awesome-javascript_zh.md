# 很棒的 JavaScript [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sorrycc/awesome-javascript/)

一系列很棒的浏览器端 [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript) 库、资源和闪亮的东西。

* [很棒的 JavaScript](#awesome-javascript)
  ...
  * [节点驱动的 CMS 框架](#node-powered-cms-frameworks)
...
* 用户界面
    ...
    * [键盘包装](#keyboard-wrappers)
    * [旅游和指南](#tours-and-guides)
    * [Notifications](#notifications)
    * [Sliders](#sliders)
    * [范围滑块](#range-sliders)
    * [表单小部件](#form-widgets)
    * [Tips](#tips)
    * [模态框和弹出窗口](#modals-and-popups)
    * [Scroll](#scroll)
    * [Menu](#menu)
...
* [yarn](https://yarnpkg.com/) - 快速、可靠且安全的依赖关系管理。
* [pnpm](https://pnpm.io/) - 快速、节省磁盘空间的包管理器。
* [bun](https://bun.sh/) - Bun 是一个快速的 JavaScript 一体化工具包。
...
* [ESL](https://github.com/ecomfe/esl) - 模块加载浏览器优先，支持惰性定义和AMD。
...
* [bundle](https://bundle.js.org) - 一个快速的在线 npm 包大小检查器。
* [Vite](https://vite.dev/) - 下一代前端工具。

# 最小化器

* [Terser](https://github.com/terser/terser) - ES6+ 的解析器、修饰器和压缩器工具包
* [Uglify](https://github.com/mishoo/UglifyJS) - 解析器/管理器/压缩器/美化器工具包
...
* [Zod](https://github.com/colinhacks/zod) - 使用内置静态类型推断进行 TypeScript 优先模式验证。
* [Yup](https://github.com/jquense/yup) - JavaScript 模式构建器和验证器。
...
* [Cypress](https://www.cypress.io/) - 适用于在浏览器及其他环境中运行的任何内容的完整端到端测试框架。
* [WebdriverI/O](https://webdriver.io/) - Node.js 的下一代浏览器和移动自动化测试框架
* [Suites](https://suites.dev) - 用于处理控制反转和依赖注入的后端单元测试框架
...
* [Supertest](https://github.com/visionmedia/supertest) - 用于测试 REST API 的流行 HTTP 断言库，通常与 Mocha 或 Jest 等其他测试框架一起使用
* [Pocket Mocker](https://github.com/tianchangNorth/pocket-mocker) - 浏览器内可视化网络模拟工具，支持fetch/XHR拦截。
...
* [zombie](https://github.com/assaf/zombie) - 使用 Node.js 进行极其快速、全栈、无头的浏览器测试。
...
* [JavaScript Standard Style](https://github.com/feross/standard) - 有主见的、无配置的样式指南、样式检查器和格式化程序
...
* [Rev-dep](https://github.com/jayu/rev-dep) - 跟踪导入、识别循环依赖、查找未使用的代码、清理节点模块——所有这些都来自快速的 CLI。
* [fallow](https://github.com/fallow-rs/fallow) - 查找 JavaScript 和 TypeScript 项目中的死代码、重复、循环依赖和复杂性热点。
...
* [svelte](https://github.com/sveltejs/svelte) - Svelte 是一种构建 Web 应用程序的新方法。它是一个编译器，可以获取声明性组件并将它们转换为高效的 JavaScript，从而彻底更新 DOM。
...
* [thorax](https://github.com/walmartlabs/thorax) - 加强你的脊椎。
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) - 类似于 PD 或 UDK 蓝图的图形节点引擎和编辑器，在 HTML5 Canvas2D 中附带其自己的编辑器。
...
* [Million](https://github.com/aidenybai/million) - <1kb 以编译器为中心的虚拟 DOM。速度很快！
* [Whatsup](https://github.com/whatsup/whatsup) - 用于休闲模式开发的前端框架🥤。生成器上的 JSX 组件、快速的类似 mobx 的状态管理和独特的 cssx 风格系统。
* [Remult](https://github.com/remult/remult) - 用于全栈 TypeScript 的 CRUD 框架。
...
* [Apostrophe](https://github.com/punkave/apostrophe) - 具有内容编辑和基本服务的 CMS。
...
* [hmpl](https://hmpl-lang.dev) - 面向服务器的可定制 JavaScript 模板。
...
* [Chart.js](https://github.com/chartjs/Chart.js) - 使用 <canvas> 的简单 HTML5 图表标签。
...
* [two.js](https://github.com/jonobr1/two.js) - 用于 Web 的与渲染器无关的二维绘图 API。
...
* [dc.js](https://github.com/dc-js/dc.js) - 多维图表构建为与 d3.js 渲染的交叉过滤器一起本地工作
...
* [trianglify](https://github.com/qrohlf/trianglify) - 使用 d3.js 的低聚风格背景生成器。
...
* [mxGraph](https://github.com/jgraph/mxgraph) - 图表库可以快速创建交互式图表和图表应用程序，并在其供应商支持的任何主要浏览器中本机运行。
...
* [G6](https://github.com/antvis/g6) - 图形可视化引擎。
* [Infographic](https://github.com/antvis/Infographic) - 下一代声明性信息图表可视化引擎。
 ...
 * [RevoGrid](https://github.com/revolist/revogrid) - RevoGrid 是一个快速、响应灵敏的类似于 Excel 的数据网格库，适用于现代 Web 应用程序。
...
* [bootstrap-wysiwyg](https://github.com/mindmup/bootstrap-wysiwyg) - 小型引导兼容的 WYSIWYG 富文本编辑器。
...
* [EpicEditor](https://github.com/OscarGodson/EpicEditor) - 一个嵌入式 JavaScript Markdown 编辑器，具有分割全屏编辑、实时预览、自动草稿保存、离线支持等功能。
...
* [raptor-editor](https://github.com/PANmedia/raptor-editor) - Raptor，HTML5 所见即所得内容编辑器！
...
* [Beautiful docs](https://github.com/beautiful-docs/beautiful-docs)是一个基于markdown文件的文档查看器。
...
* [jBinary](https://github.com/jDataView/jBinary) - 使用声明性语法描述文件类型和数据结构的二进制文件的高级 I/O（加载、解析、操作、序列化、保存）。
...
* [underscore](https://github.com/jashkenas/underscore) - JavaScript的实用工具_带。
...
* [sweet-monads](https://github.com/JSMonk/sweet-monads) - 包含流行的 monad 和惰性迭代器的实用程序库。
...
* [Kefir](https://github.com/pozadi/kefir) - JavaScript 的 FRP 库受到 Bacon.js 和 RxJS 的启发，专注于高性能和低内存消耗。
...
* [Cycle.js](https://cycle.js.org) - 一个函数式和反应式 JavaScript 库，可实现更简洁的代码。
* [concent](https://github.com/concentjs/concent) - 绝对是❤️最简单但⚡️最强的React状态管理，可预测、渐进且高效。
* [stunk](https://github.com/I-am-abdulazeez/stunk) 一个与框架无关的状态管理库，可以保持应用程序的状态干净简单。它使用细粒度的状态模型，将状态分解为独立的、可管理的块。

## 数据结构
*用于构建更复杂的应用程序的数据结构库。*

* [immutable-js](https://github.com/facebook/immutable-js) - 不可变数据集合，包括序列、范围、重复、映射、有序映射、集合和稀疏向量。
* [mori](https://github.com/swannodette/mori) - 一个使用 ClojureScript 的持久数据结构并通过普通 JavaScript 支持 API 的库。
...
* [date](https://github.com/MatthewMueller/date) - Date() 对于人类来说。
...
* [map-countdown](https://github.com/dawidjaniga/map-countdown) - 构建在 Google 地图之上的浏览器倒计时。
...
* [tempo](https://github.com/formkit/tempo) - 解析、格式化和时区 - Tempo 是一个用于原生 Date 对象的小型可树摇动库。
...
* [query-string](https://github.com/sindresorhus/query-string) - 解析并字符串化 URL 查询字符串。
...
* [pouchdb](https://github.com/pouchdb/pouchdb) - Javascript db 受 Apache CouchDB 启发，可在浏览器中良好运行。
...
* [Lovefield](https://google.github.io/lovefield) - Lovefield 是一个用于网络应用程序的关系数据库，由 Google 开发。
...
* [PostgreSQL Browser](https://github.com/datawan-labs/pg) - 浏览器 PostgreSQL Playground，没有服务器，只有客户端和 pglite (postgresql wasm)
...
* [i18next](https://github.com/i18next/i18next) - 使用 JavaScript 实现国际化 (i18n) 的简单方法。
...
* [q](https://github.com/kriskowal/q) - 用于在 JavaScript 中制定和编写异步 Promise 的工具。
* [step](https://github.com/creationix/step/) - 一个异步控制流库，可以轻松地逐步执行逻辑。
* [contra](https://github.com/bevacqua/contra/) - 具有函数式风格的异步流控制。
...
* [sporadic](https://github.com/marcoonroad/sporadic) - 针对 Node 和浏览器引擎，基于 Promise 的可组合并发抽象（例如流、协程和类似 Go 的通道）。
...
* [pompelmi](https://github.com/pompelmi/pompelmi) - 针对 Node.js 的快速文件上传恶意软件扫描。
...
* [LogTape](https://logtape.org/) - 简单的日志库，对 Deno、Node.js、Bun、浏览器和边缘函数具有零依赖性。
...
* [Regulex](https://jex.im/regulex/) - JavaScript 正则表达式解析器和可视化工具。
* [Regex-Vis](https://regex-vis.com/) - 正则表达式可视化工具和编辑器。
...
* [oauth-signature-js](https://github.com/bettiolo/oauth-signature-js) - JavaScript OAuth 1.0a 用于节点和浏览器的签名生成器。
* [amygdala](https://github.com/lincolnloop/amygdala) - 适用于 JavaScript 支持的 Web 应用程序的 RESTful HTTP 客户端。
...
* [FarFetch](https://github.com/WebsiteBeaver/far-fetch) - 现代 Fetch API 包装器为了简单起见，提供简洁的文件上传。
* [Optic](https://github.com/opticdev/optic) - Optic 会自动记录和测试您的 API。
...
* [SWRV](https://github.com/Kong/swrv) - Vue 的重新验证时过时数据获取。
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) - 一个 CLI 工具，用于将经过训练的经典 ML 模型转换为零依赖的本机 JavaScript 代码。
* [JS-PyTorch](https://github.com/eduardoleao052/js-pytorch) - GPU 加速 JavaScript 中的 PyTorch。
...
## 操作系统
* [os.js](https://github.com/os-js/OS.js) - 一个开源 Web 桌面平台，具有窗口管理器、应用程序 API、GUI 工具包、文件系统抽象等。

## 基准测试

* [benchmark.js](https://github.com/bestiejs/benchmark.js) - 一个基准测试库。正如 jsPerf.com 上所使用的。
* [matcha](https://github.com/logicalparadox/matcha) - 一种由咖啡因驱动、简单化的基准测试方法。
...
* [workly](https://github.com/pshihn/workly) - 将函数或类移至 Web Worker 的一种非常简单的方法。
...
* [shiki](https://github.com/shikijs/shiki) - 由 VS Code TextMate 语法提供支持的代码荧光笔。准确，可主题化，适用于 Node 或浏览器，非常适合 JS 和 TS。
...
* [topbar](https://github.com/buunguyen/topbar) - 小巧而美丽的全站进度指示器。
...
* [css-loaders](https://github.com/lukehaas/css-loaders) - 使用 CSS 进行动画加载的旋转器集合

## 验证

* [Parsley.js](https://github.com/guillaumepotier/Parsley.js) - 无需编写任何 JavaScript 代码即可验证您的表单、前端。
...
* [jwerty](https://github.com/keithamus/jwerty) - 出色的键盘事件处理能力。
...
* [bootstrap-tour](https://github.com/sorich87/bootstrap-tour) - 使用 Twitter Bootstrap Popover 快速轻松地浏览产品。
...
* [driver.js](https://github.com/kamranahmedse/driver.js) - 强大而轻量级的普通 JavaScript 引擎可驱动用户在整个页面上的注意力
...
* [smoke.js](https://github.com/hxgf/smoke.js) - JavaScript 与框架无关的警报系统。
* [notie](https://github.com/jaredreich/notie) - 简单的通知和输入，没有依赖性。
* [notifire](https://github.com/notifirehq/notifire) - 产品的开源通知基础设施。
* [toastify-js](https://github.com/apvarun/toastify-js) - 纯 JavaScript 库提供更好的通知消息。
...
* [Flickity](https://github.com/metafizzy/flickity) - 触摸式、响应式、可滑动的画廊。
...
* [fancyInput](https://github.com/yairEO/fancyInput) - 使用 CSS3 效果让输入字段中的输入变得有趣。
...
* [awesomplete](https://github.com/LeaVerou/awesomplete) - 超轻量级、可用、美观的自动完成功能，零依赖性。 - https://projects.verou.me/awesoplete/
...
* [tui.calendar](https://github.com/nhn/tui.calendar) - 一个功能齐全的 JavaScript 日程日历。现在您的服务刚刚获得了可定制的日历。
* [Schedule-X](https://github.com/schedule-x/schedule-x) - 材料设计活动日历。具有拖放、深色模式、多视图等功能。

### 选择

* [selectize.js](https://github.com/selectize/selectize.js) - Selectize 是文本框和“<select>”框的混合体。它基于 jQuery，具有自动完成和原生键盘导航功能；对于标记、联系人列表等很有用。
* [select2](https://github.com/select2/select2) - 基于 jQuery 的选择框替代品。它支持搜索、远程​​数据集和结果的无限滚动。
* [chosen](https://github.com/harvesthq/chosen) - 一个让又长又笨重的选择框变得更加友好的库。

### 文件上传器

* [jQuery-File-Upload](https://github.com/blueimp/jQuery-File-Upload) - 文件上传小部件具有多个文件选择、拖放支持、进度条、验证和预览图像、jQuery 音频和视频。
...
* [Garlic.js](https://github.com/guillaumepotier/Garlic.js) - 自动在本地保留表单文本并选择字段值，直到提交表单。
* [Countable](https://github.com/RadLikeWhoa/Countable) - 一个 JavaScript 函数，用于向 HTML 元素添加实时段落、单词和字符计数。
* [card](https://github.com/jessepollak/card) - 只需一行代码即可让您的信用卡表单变得更好。
* [stretchy](https://github.com/LeaVerou/stretchy) - 表单元素自动调整大小，就应该这样。
...
* [opentip](https://github.com/enyo/opentip) - 一个基于原型框架的开源 JavaScript 工具提示。
...
* [hint.css](https://github.com/chinchang/hint.css) - 一个 CSS 工具提示库，适合您可爱的网站。

## 模态框和弹出窗口

* [Magnific-Popup](https://github.com/dimsemenov/Magnific-Popup) - 轻巧且响应灵敏的灯箱脚本，注重性能。
...
* [vex](https://github.com/HubSpot/vex) - 一个高度可配置且易于设计样式的现代对话框库。
...
* [fancyBox](https://github.com/fancyapps/fancyBox) - 该工具提供了一种漂亮而优雅的方式来为网页上的图像、HTML 内容和多媒体添加缩放功能。
...
* [stroll](https://github.com/hakimel/stroll.js) - CSS列表滚动效果的集合通过javascript绑定到dom。
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) - 检测视口中的元素并平滑滚动视差。
* [elevator.js](https://github.com/tholman/elevator.js) - 最后，还有一个“返回顶部”按钮，其行为就像真正的电梯一样。
...
* [Ink](https://github.com/sapo/Ink) - SAPO 使用 HTML5/CSS3 框架进行快速高效的网站设计和原型设计。
...
* [OpenLayers3](https://openlayers.org/) - 一个高性能、功能齐全的库，可满足您的所有绘图需求。
 ...
 * [mediaelement](https://github.com/johndyer/mediaelement) - HTML5 <audio> 或 <video> 播放器，带有 Flash 和 Silverlight 填充程序，模仿 HTML5 MediaElement API，从而在所有浏览器中实现一致的 UI。 <http://www.mediaelementjs.com/>
 ...
 * [ts-audio](https://github.com/EvandroLG/ts-audio) - 一个与“AudioContext” API 配合使用的不可知且易于使用的库。
 ...
 * [flv.js](https://github.com/bilibili/flv.js) - 一个用纯 JavaScript 编写的 HTML5 Flash 视频 (FLV) 播放器，不含 Flash。
 * [hls.js](https://github.com/video-dev/hls.js) - 实现 HTTP Live Streaming 客户端的 JavaScript 库。它依赖 HTML5 视频和 MediaSource Extensions 进行播放。
 ...
 * [simple-text-rotator](https://github.com/peachananr/simple-text-rotator) - 向您的网站添加超级简单的旋转文本，几乎不需要任何标记。
 * [novacancy.js](https://github.com/chuckyglitch/novacancy.js) - 文本霓虹金色效果 jQuery 插件。
 * [jquery-responsive-text](https://github.com/ghepting/jquery-responsive-text) - 让您的文字大小响应灵敏！
...
* [animate.css](https://github.com/daneden/animate.css) - 一个跨浏览器的 CSS 动画库。使用起来就像一件简单的事情一样简单。
...
* [typicaljs](https://github.com/camwiegert/typical) - JavaScript 的动画输入约 400 字节🐡
...
* [ECMAScript 6 compatibility table](https://compat-table.github.io/compat-table/es6/) - 各种环境下所有 ECMAScript 6 功能的兼容性表。
...
* [Astro](https://github.com/withastro/astro) - 内容驱动网站的网络框架。
* [Nuxt](https://github.com/nuxt/nuxt) - 直观的 Vue 框架。

## 软件开发工具包

* [javascript-sdk-design](https://github.com/huei90/javascript-sdk-design) - JavaScript SDK 设计指南提取自工作和个人经验。
...
* [OpenAI SDK](https://github.com/openai/openai-node) - OpenAI API 的官方 JavaScript / TypeScript 库。
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) - Stripe Node.js SDK 可让您将付款、订阅和计费集成到 JavaScript/TypeScript 应用程序中。

## 全文搜索

* [lunr](https://github.com/olivernn/lunr.js) - 用于浏览器的库，它索引 JSON 文档，并提供一个简单的搜索界面，用于检索与文本查询最匹配的文档。
* [flexsearch](https://github.com/nextapps-de/flexsearch) - 它是浏览器和 Node.js 的下一代全文搜索库。
* [Elasticlunr](https://github.com/weixsong/elasticlunr.js) - 该库基于 lunr.js，但更加灵活和可定制。
...
* [Sequelize](https://github.com/sequelize/sequelize) 适用于现代 Node.js 和 TypeScript 的功能丰富的 ORM | PostgreSQL、MySQL、MariaDB、SQLite、MS SQL Server、Snowflake、Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) MongoDB 对象建模设计用于异步环境。
* [TypeORM](https://github.com/typeorm/typeorm) 适用于 TypeScript 和 JavaScript 的 ORM，适用于 NodeJS、浏览器、Ionic、Cordova 和 Electron 平台。
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) 有头的无头 TypeScript ORM。在 Node、Bun 和 Deno 上运行。
* [Kysely](https://github.com/kysely-org/kysely) 类型安全的打字稿 SQL 查询生成器。
* [Knex](https://github.com/knex/knex) 一个适用于 PostgreSQL、MySQL、CockroachDB、SQL Server、SQLite3 和 Oracle 的查询构建器，设计灵活、可移植且使用起来有趣。
* [MikroORM](https://github.com/mikro-orm/mikro-orm) TypeScript ORM for Node.js 基于数据映射器、工作单元和身份映射模式。
* [Objection.js](https://github.com/Vincit/objection.js) 一个基于 Knex.js 构建的 SQL 友好的 Node.js ORM，具有强大的关系支持。


## WebSockets

* [Socket.io](https://github.com/socketio/socket.io) 用于实时应用程序的最广泛使用的 WebSocket 库。支持自动重新连接、房间和后备（例如轮询）。
* [ws](https://github.com/websockets/ws) 使用简单、速度极快且经过彻底测试的 Node.js WebSocket 客户端和服务器。

## 生成式人工智能

* [KaibanJS](https://github.com/kaiban-ai/KaibanJS) - KaibanJS 是一个开源框架，兼容浏览器，使用受看板启发的架构来编排多代理人工智能系统。

## 杂项

* [echo](https://github.com/toddmotto/echo) - 具有 data-* 属性的延迟加载图像。
* [picturefill](https://github.com/scottjehl/picturefill) - 用于<图片>、srcset、尺寸的响应式图像填充。
...
* [iooxa](https://github.com/iooxa/article) - 用于交互式科学写作、反应性文档和探索性解释的组件。
* [Idyll](https://github.com/idyll-lang/idyll) - 创建可探索的解释和交互式讲故事的文章。可以[嵌入 HTML](https://github.com/idyll-lang/idyll-embed)。
...
* [jsemu](https://github.com/fcambus/jsemu) - 用 JavaScript 编程语言编写的模拟器列表。
...
* [Functional-Light JavaScript](https://github.com/getify/Functional-Light-JS) - JavaScript 中的务实、平衡的 FP。
* [Clean Code JavaScript](https://github.com/ryanmcdermott/clean-code-javascript) - 适用于 JavaScript 的干净代码概念。
* [Roadmap.sh JavaScript Roadmap](https://roadmap.sh/javascript) - 从社区来源的学习路线图学习 JavaScript。
* [JavaScript Info](https://javascript.info) - 现代 JavaScript 教程，带有简单的解释。
...
在法律允许的范围内，[chen Cheng](https://github.com/sorrycc) 已放弃本作品的所有版权以及相关或邻接权。
