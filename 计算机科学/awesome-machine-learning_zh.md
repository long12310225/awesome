# 很棒的机器学习 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

精彩的机器学习框架、库和软件的精选列表（按语言）。受到“awesome-php”的启发。

## 关于 PR 的重要说明：

截至 2026 年 4 月，法学硕士产生了太多 PR，这不再有趣或难以管理。如果您想为此存储库做出贡献，请发送电子邮件至 joseph dot missiti @ hey dot com，以证明您是人类，并附上您的 PR 链接，我会将其合并。感谢您的理解。
...
* 如需下载免费机器学习书籍列表，请访问[此处](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md)。

* 如需专业机器学习活动列表，请访问[此处](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md)。

* 有关（大部分）在线免费机器学习课程的列表，请访问[此处](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md)。

* 有关数据科学和机器学习的博客和新闻通讯列表，请访问[此处](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md)。

* 如需免费参加聚会和本地活动的列表，请访问[此处](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md)。
...
<!-- MarkdownTOC depth=4 -->
<!-- Contents-->
- [很棒的机器学习！[很棒](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](#awesome-machine-learning-)
  - [目录](#table-of-contents)
    - [框架和库](#frameworks-and-libraries)
    - [Tools](#tools)
  - [APL](#apl)
      - [通用机器学习](#apl-general-purpose-machine-learning)
  - [C](#c)
      - [通用机器学习](#c-general-purpose-machine-learning)
      - [计算机视觉](#c-computer-vision)
  - [C++](#cpp)
      - [计算机视觉](#cpp-computer-vision)
      - [通用机器学习](#cpp-general-purpose-machine-learning)
      - [自然语言处理](#cpp-natural-language-processing)
      - [语音识别](#cpp-speech-recognition)
      - [序列分析](#cpp-sequence-analysis)
      - [手势检测](#cpp-gesture-detection)
      - [强化学习](#cpp-reinforcement-learning)
  - [通用语言](#common-lisp)
      - [通用机器学习](#common-lisp-general-purpose-machine-learning)
  - [Clojure](#clojure)
      - [自然语言处理](#clojure-natural-language-processing)
      - [通用机器学习](#clojure-general-purpose-machine-learning)
      - [深度学习](#clojure-deep-learning)
      - [数据分析](#clojure-data-analysis--data-visualization)
      - [数据可视化](#clojure-data-visualization)
      - [Interop](#clojure-interop)
      - [Misc](#clojure-misc)
      - [Extra](#clojure-extra)
  - [Crystal](#crystal)
      - [通用机器学习](#crystal-general-purpose-machine-learning)
  - [CUDA PTX](#cuda-ptx)
      - [神经符号人工智能](#cuda-ptx-neurosymbolic-ai)
  - [Elixir](#elixir)
      - [通用机器学习](#elixir-general-purpose-machine-learning)
      - [自然语言处理](#elixir-natural-language-processing)
  - [Erlang](#erlang)
      - [通用机器学习](#erlang-general-purpose-machine-learning)
  - [Fortran](#fortran)
      - [通用机器学习](#fortran-general-purpose-machine-learning)
      - [数据分析/数据可视化](#fortran-data-analysis--data-visualization)
  - [Go](#go)
      - [自然语言处理](#go-natural-language-processing)
      - [通用机器学习](#go-general-purpose-machine-learning)
      - [空间分析和几何](#go-spatial-analysis-and-geometry)
      - [数据分析/数据可视化](#go-data-analysis--data-visualization)
      - [计算机视觉](#go-computer-vision)
      - [强化学习](#go-reinforcement-learning)
  - [Haskell](#haskell)
      - [通用机器学习](#haskell-general-purpose-machine-learning)
  - [Java](#java)
      - [自然语言处理](#java-natural-language-processing)
      - [通用机器学习](#java-general-purpose-machine-learning)
      - [语音识别](#java-speech-recognition)
      - [数据分析/数据可视化](#java-data-analysis--data-visualization)
      - [深度学习](#java-deep-learning)
  - [Javascript](#javascript)
      - [自然语言处理](#javascript-natural-language-processing)
      - [数据分析/数据可视化](#javascript-data-analysis--data-visualization)
      - [通用机器学习](#javascript-general-purpose-machine-learning)
      - [Misc](#javascript-misc)
      - [演示和脚本](#javascript-demos-and-scripts)
  - [Julia](#julia)
      - [通用机器学习](#julia-general-purpose-machine-learning)
      - [自然语言处理](#julia-natural-language-processing)
      - [数据分析/数据可视化](#julia-data-analysis--data-visualization)
      - [杂项/演示文稿](#julia-misc-stuff--presentations)
  - [Kotlin](#kotlin)
      - [深度学习](#kotlin-deep-learning)
  - [Lua](#lua)
      - [通用机器学习](#lua-general-purpose-machine-learning)
      - [演示和脚本](#lua-demos-and-scripts)
  - [Matlab](#matlab)
      - [计算机视觉](#matlab-computer-vision)
      - [自然语言处理](#matlab-natural-language-processing)
      - [通用机器学习](#matlab-general-purpose-machine-learning)
      - [数据分析/数据可视化](#matlab-data-analysis--data-visualization)
  - [.NET](#net)
      - [计算机视觉](#net-computer-vision)
      - [自然语言处理](#net-natural-language-processing)
      - [通用机器学习](#net-general-purpose-machine-learning)
      - [数据分析/数据可视化](#net-data-analysis--data-visualization)
  - [目标C](#objective-c)
    - [通用机器学习](#objective-c-general-purpose-machine-learning)
  - [OCaml](#ocaml)
    - [通用机器学习](#ocaml-general-purpose-machine-learning)
  - [OpenCV](#opencv)
    - [计算机视觉](#opencv-Computer-Vision)
    - [Text-Detection](#Text-Character-Number-Detection)
  - [Perl](#perl)
    - [数据分析/数据可视化](#perl-data-analysis--data-visualization)
    - [通用机器学习](#perl-general-purpose-machine-learning)
  - [珀尔6](#perl-6)
    - [数据分析/数据可视化](#perl-6-data-analysis--data-visualization)
    - [通用机器学习](#perl-6-general-purpose-machine-learning)
  - [PHP](#php)
    - [自然语言处理](#php-natural-language-processing)
    - [通用机器学习](#php-general-purpose-machine-learning)
  - [Python](#python)
      - [计算机视觉](#python-computer-vision)
      - [自然语言处理](#python-natural-language-processing)
      - [通用机器学习](#python-general-purpose-machine-learning)
      - [数据分析/数据可视化](#python-data-analysis--data-visualization)
      - [其他脚本/iPython 笔记本/代码库](#python-misc-scripts--ipython-notebooks--codebases)
      - [神经网络](#python-neural-networks)
      - [生存分析](#python-survival-analysis)
      - [联邦学习](#python-federated-learning)
      - [Kaggle 竞赛源代码](#python-kaggle-competition-source-code)
      - [强化学习](#python-reinforcement-learning)
      - [语音识别](#python-speech-recognition)
  - [Ruby](#ruby)
      - [自然语言处理](#ruby-natural-language-processing)
      - [通用机器学习](#ruby-general-purpose-machine-learning)
      - [数据分析/数据可视化](#ruby-data-analysis--data-visualization)
      - [Misc](#ruby-misc)
  - [Rust](#rust)
      - [通用机器学习](#rust-general-purpose-machine-learning)
      - [深度学习](#rust-deep-learning)
      - [自然语言处理](#rust-natural-language-processing)
  - [R](#r)
      - [通用机器学习](#r-general-purpose-machine-learning)
      - [数据分析/数据可视化](#r-data-analysis--data-visualization)
  - [SAS](#sas)
      - [通用机器学习](#sas-general-purpose-machine-learning)
      - [数据分析/数据可视化](#sas-data-analysis--data-visualization)
      - [自然语言处理](#sas-natural-language-processing)
      - [演示和脚本](#sas-demos-and-scripts)
  - [Scala](#scala)
      - [自然语言处理](#scala-natural-language-processing)
      - [数据分析/数据可视化](#scala-data-analysis--data-visualization)
      - [通用机器学习](#scala-general-purpose-machine-learning)
  - [Scheme](#scheme)
      - [神经网络](#scheme-neural-networks)
  - [Swift](#swift)
      - [通用机器学习](#swift-general-purpose-machine-learning)
  - [TensorFlow](#tensorflow)
      - [通用机器学习](#tensorflow-general-purpose-machine-learning)

### 工具

- [教育工具](#tools-educational-tools)
- [神经网络](#tools-neural-networks)
- [Misc](#tools-misc)
...
* [Recommender](https://github.com/GHamrouni/Recommender) - 使用协作过滤 (CF) 进行产品推荐/建议的 C 库。
* [Hybrid Recommender System](https://github.com/SeniorSA/hybrid-rs-trainner) - 基于 scikit-learn 算法的混合推荐系统。 **[已弃用]**
* [neonrvm](https://github.com/siavashserver/neonrvm) - neonrvm 是一个基于 RVM 技术的开源机器学习库。它是用 C 编程语言编写的，并附带 Python 编程语言绑定。
...
* [libonnx](https://github.com/xboot/libonnx) - 一款轻量级、便携式纯 C99 onnx 推理引擎，适用于具有硬件加速支持的嵌入式设备。
* [onnx-c](https://github.com/onnx/onnx-c) - 用于 ONNX 模型推理的轻量级 C 库，针对跨平台的性能和可移植性进行了优化。
* [qsmm](http://qsmm.org) - 一个 C 库，实现了用于处理自适应概率汇编程序的工具链的基础。

<a name="c-computer-vision"></a>
#### 计算机视觉

* [CCV](https://github.com/liuliu/ccv) - 基于C/缓存/核心计算机视觉库，现代计算机视觉库。
* [VLFeat](http://www.vlfeat.org/) - VLFeat 是一个开放且可移植的计算机视觉算法库，其中有一个 Matlab 工具箱。
* [YOLOv8](https://github.com/ultralytics/ultralytics) - Ultralytics 的 YOLOv8 实现具有 C++ 支持，可实现实时对象检测和跟踪，并针对边缘设备进行了优化。
* [SpecX](https://specx.pro) - 用于将工程规格从 PDF/JPG 提取到 Excel 的专业 AI 视觉。
...
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) - 上下文学习框架，允许代理从执行反馈中学习。
...
* [Caffe](https://github.com/BVLC/caffe) - 一个深度学习框架的开发考虑了整洁、可读性和速度。 [深度学习]
* [CatBoost](https://github.com/catboost/catboost) - 决策树库上的通用梯度提升具有开箱即用的分类特征支持。它易于安装，包含快速推理实现，并支持 CPU 和 GPU（甚至多 GPU）计算。
...
* [DLib](http://dlib.net/ml.html) - 一套机器学习工具，旨在轻松嵌入其他应用程序中。
* [DSSTNE](https://github.com/amznlabs/amazon-dsstne) - Amazon 创建的软件库，用于使用 GPU 训练和部署深度神经网络，强调速度和规模而不是实验灵活性。
* [DyNet](https://github.com/clab/dynet) - 动态神经网络库与具有随每个训练实例而变化的动态结构的网络配合良好。用 C++ 编写，并用 Python 进行绑定。
* [Fido](https://github.com/FidoProject/Fido) - 用于嵌入式电子和机器人技术的高度模块化 C++ 机器学习库。
* [FlexML](https://github.com/ozguraslank/flexml) - 易于使用且灵活的 Python AutoML 库。
...
* [MCGrad](https://github.com/facebookincubator/MCGrad/) - 用于机器学习模型中的多重校准、公平性和偏差校正的生产就绪库。
...
* [MXNet](https://github.com/apache/incubator-mxnet) - 轻量级、便携式、灵活的分布式/移动深度学习，具有动态、突变感知数据流 Dep Scheduler；适用于 Python、R、Julia、Go、JavaScript 等。
...
* [Opik](https://www.comet.com/site/products/opik/) - 开源工程平台，可通过全面的跟踪、自动评估和生产就绪的仪表板来调试、评估和监控您的 LLM 应用程序、RAG 系统和代理工作流程。 ([源代码](https://github.com/comet-ml/opik/))
* [Ombre](https://github.com/pypl0/Ombre) - 开源人工智能基础设施层。八个代理自动运行：安全、缓存、内存、幻觉检测和防篡改审计跟踪。在本地运行。
  * [ParaMonte](https://github.com/cdslaborg/paramonte) - 具有 C/C++ 接口的通用库，用于通过串行/并行蒙特卡罗和 MCMC 模拟进行贝叶斯数据分析和可视化。文档可以在[此处](https://www.cdslab.org/paramonte/)找到。
...
* [Timbl](https://languagemachines.github.io/timbl/) - 一个软件包/C++库，实现了多种基于内存的学习算法，其中IB1-IG是k近邻分类的实现，IGTree是IB1-IG的决策树近似。常用于 NLP。
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) - 快速的核心外学习系统。
* [Warp-CTC](https://github.com/baidu-research/warp-ctc) - 在 CPU 和 GPU 上快速并行实现联结时序分类 (CTC)。
...
* [LKYDeepNN](https://github.com/mosdeo/LKYDeepNN) - 仅包含头文件的 C++11 神经网络库。低依赖性，原生繁体中文文档。
...
* [skynet](https://github.com/Tyill/skynet) - 一个用于学习神经网络的库，具有 C 接口，网络设置为 JSON。用 C++ 编写，并绑定 Python、C++ 和 C#。
* [Feast](https://github.com/gojek/feast) - 用于管理、发现和访问机器学习功能的功能存储。 Feast 为模型训练和模型服务提供一致的特征数据视图。
* [Hopsworks](https://github.com/logicalclocks/hopsworks) - 一个人工智能数据密集型平台，拥有业界第一个开源特征存储。 Hopsworks Feature Store 既提供了基于 Apache Hive 的用于训练和批处理的特征仓库，也提供了基于 MySQL Cluster 的用于在线应用程序的特征服务数据库。
...
* [XAD](https://github.com/auto-differentiation/XAD) - C++ 的综合反向传播工具。
* [Truss](https://truss.baseten.co) - 用于打包和服务 ML 模型的开源框架。
* [nndeploy](https://github.com/nndeploy/nndeploy) - 易于使用、高性能的AI部署框架。
* [ols-regression-engine](https://github.com/VojtechNovakk/ols-regression-engine) - 利用普通最小二乘法 (OLS) 方法和 QR 分解的低级线性回归引擎。
...
* [CRF++](https://taku910.github.io/crfpp/) - 用于分段/标记顺序数据和其他自然语言处理任务的条件随机场 (CRF) 的开源实现。 **[已弃用]**
...
* [MeTA](https://github.com/meta-toolkit/meta) - [MeTA：ModErn 文本分析](https://meta-toolkit.org/) 是一个 C++ 数据科学工具包，有助于挖掘大文本数据。
...
* [SentencePiece](https://github.com/google/sentencepiece) - 用于无监督文本标记化和去标记化的 C++ 库，广泛用于现代 NLP 模型。
...
* [Vosk](https://github.com/alphacep/vosk-api) - 支持 C++ 的离线语音识别工具包，专为低资源设备和多种语言而设计。
...
#### 强化学习
* [RLtools](https://github.com/rl-tools/rl-tools) - 用于连续控制的最快的深度强化学习库，仅以纯头文件实现，无依赖的 C++（也提供 Python 绑定）。
...
* [scicloj.ml](https://github.com/scicloj/scicloj.ml) - 一个基于 tech.ml.dataset 的惯用 Clojure 机器学习库，具有用于不可变数据处理管道的独特方法。
* [clj-ml](https://github.com/joshuaeckroth/clj-ml/) - 一个基于 Weka 和朋友构建的 Clojure 机器学习库。
...
* [clortex](https://github.com/htm-community/clortex) - 使用 Numenta 皮质学习算法的通用机器学习库。 **[已弃用]**
...
* [Delight](https://github.com/datamechanics/delight) - 一个监听器，可以流式传输 Spark 事件日志以取悦您，这是一个免费且改进的 Spark UI
...
* [Knowledge3D (K3D)](https://github.com/danielcamposramos/Knowledge3D) - 主权 GPU 原生空间 AI 架构，具有 PTX 优先认知引擎（RPN/TRM 推理）、三模态融合（文本/视觉/音频）和 3D 持久内存（“Houses”）。具有低于 100μs 的推理、程序性知识压缩（69:1 比率）和多代理群架构。核心推理路径的外部依赖性为零。
...
* [emel](https://github.com/mrdimosthenis/emel) - 一个用 Elixir 编写的简单且实用的机器学习库。
...
* [Disco](https://github.com/discoproject/disco/) - Erlang 中的 MapReduce。 **[已弃用]**
...
请阅读[此处](https://arxiv.org/abs/1902.06714) 的论文。

<a name="fortran-data-analysis--data-visualization"></a>
#### 数据分析/数据可视化

* [ParaMonte](https://github.com/cdslaborg/paramonte) - 通用 Fortran 库，用于通过串行/并行蒙特卡罗和 MCMC 模拟进行贝叶斯数据分析和可视化。文档可以在[此处](https://www.cdslab.org/paramonte/)找到。
...
* [snowball](https://github.com/tebeka/snowball) - Go 的雪球词干分析器。
...
* [anneal](https://github.com/georgebuilds/anneal) - tinygrad 的从头开始 Go 端口：具有反向模式自动差异和 WebGPU 后端的图形重写 ML 编译器。
...
* [globe](https://github.com/mmcloughlin/globe) - 地球仪线框可视化。
...
#### 通用机器学习
* [haskell-ml](https://github.com/ajtulloch/haskell-ml) - 各种 ML 算法的 Haskell 实现。 **[已弃用]**
...
* [IRIS](https://github.com/cortical-io/Iris) - [Cortical.io 的](https://cortical.io) 免费 NLP、Retina API 分析工具（用 JavaFX 编写！）- [查看教程视频](https://www.youtube.com/watch?v=CsF4pd7fGF0)。
...
* [Stanford POS Tagger](https://nlp.stanford.edu/software/tagger.shtml) - 词性标注器（POS 标注器）。
...
* [斯坦福短语：基于短语的翻译系统](https://nlp.stanford.edu/phrasal/)
...
* [ClearTK](https://github.com/ClearTK/cleartk) - ClearTK 提供了一个用 Java 开发统计自然语言处理 (NLP) 组件的框架，并构建在 Apache UIMA 之上。 **[已弃用]**
...
* [CogcompNLP](https://github.com/CogComp/cogcomp-nlp) - 该项目收集了伊利诺伊大学认知计算小组开发的多个自然语言处理（NLP）核心库，例如“illinois-core-utilities”提供了一组NLP友好的数据结构和一些与NLP相关的实用程序，支持编写NLP应用程序、运行实验等，“illinois-edison”用于从illinois-core-utilities数据结构和许多其他包中提取特征的库。

<a name="java-general-purpose-machine-learning"></a>
#### 通用机器学习

* [aerosolve](https://github.com/airbnb/aerosolve) - Airbnb 的机器学习库从头开始就以人性化设计。
...
* [H2O](https://github.com/h2oai/h2o-3) - ML 引擎支持通过 R、Python、Scala、REST/JSON 中的 API 在 Hadoop、Spark 或笔记本电脑上进行分布式学习。
* [htm.java](https://github.com/numenta/htm.java) - 使用 Numenta 皮质学习算法的通用机器学习库。
* [jSciPy](https://github.com/hissain/jscipy) - SciPy 信号处理模块的 Java 端口，提供过滤器、转换和其他科学计算实用程序。
* [liblinear-java](https://github.com/bwaldvogel/liblinear-java) - Java 版本的 lib Linear。
...
* [Samoa](https://samoa.incubator.apache.org/) SAMOA 是一个框架，其中包括用于数据流的分布式机器学习，并具有可插入不同流处理平台的接口。
...
#### 语音识别
* [CMU Sphinx](https://cmusphinx.github.io) - Open Source Toolkit For Speech Recognition 纯粹基于 Java 语音识别库。
...
* [博士。 Michael Thomas Flanagan 的 Java 科学图书馆。](https://www.ee.ucl.ac.uk/~mflanaga/java/) **[已弃用]**
...
* [nlp.js](https://github.com/axa-group/nlp.js) - 一个内置于 Node over Natural 的 NLP 库，具有实体提取、情感分析、自动语言识别等功能。
...
* [Catniff](https://github.com/nguyenphuminh/catniff) - 类似于 Torch 的 Javascript 深度学习框架，支持张量、自动求导、优化器和其他神经网络结构。
* [Convnet.js](https://cs.stanford.edu/people/karpathy/convnetjs/) - ConvNetJS 是一个用于训练深度学习模型的 JavaScript 库[深度学习] **[已弃用]**
* [Creatify MCP](https://github.com/TSavo/creatify-mcp) - 模型上下文协议服务器，向 AI 助手公开 Creatify AI 的视频生成功能，从而支持自然语言视频创建工作流程。
...
* [Brain.js](https://github.com/BrainJS/brain.js) - JavaScript 中的神经网络 - [Brain](https://github.com/harthur/brain) 的持续社区分支。
...
* [JSMLT](https://github.com/jsmlt/jsmlt) - 具有 Node.js 分类和聚类功能的机器学习工具包；支持可视化（请参阅 [visualml.io](https://visualml.io)）。
...
* [WebNN](https://webnn.dev) - 一种新的 Web 标准，允许 Web 应用程序和框架使用 GPU、CPU 或专用 AI 加速器等设备上硬件加速深度神经网络。
* [Kandle](https://github.com/final-kk/kandle) - 与 JavaScript 本机 PyTorch 一致的机器学习框架，在 WebGPU 上从头开始构建。
...
* [regression-js](https://github.com/Tom-Alexander/regression-js) - 一个 JavaScript 库，包含一组最小二乘拟合方法，用于查找一组数据中的趋势。
* [Lyric](https://github.com/flurry/Lyric) - 线性回归库。 **[已弃用]**
* [GreatCircle](https://github.com/mwgg/GreatCircle) - 用于计算大圆距离的库。
* [MLPleaseHelp](https://github.com/jgreenemi/MLPleaseHelp) - MLPleaseHelp 是一个简单的 ML 资源搜索引擎。您现在可以通过 GitHub Pages 提供的 [https://jgreenemi.github.io/MLPleaseHelp/](https://jgreenemi.github.io/MLPleaseHelp/) 使用此搜索引擎。
* [Pipcook](https://github.com/alibaba/pipcook) - 用于机器学习及其工程的 JavaScript 应用程序框架。

<a name="javascript-demos-and-scripts"></a>
#### 演示和脚本
* [The Bot](https://github.com/sta-ger/TheBot) - 神经网络如何学习预测使用 [Synaptic](https://github.com/cazala/synaptic) 创建的两点之间的角度的示例。
* [Half Beer](https://github.com/sta-ger/HalfBeer) - 使用 [Synaptic](https://github.com/cazala/synaptic) 创建的啤酒杯分类器。
* [NSFWJS](http://nsfwjs.com) - 使用 TensorFlow.js 进行不雅内容检查
...
* [Gaussian Processes](https://github.com/STOR-i/GaussianProcesses.jl) - 高斯过程的 Julia 包。
* [在线学习](https://github.com/lendle/OnlineLearning.jl) **[已弃用]**
...
* [XGBoost](https://github.com/dmlc/XGBoost.jl) - Julia 中的 eXtreme 梯度增强包。
...
* [CluGen](https://github.com/clugen/CluGen.jl/) - Julia 中的多维集群生成。
...
* [Embeddings](https://github.com/JuliaText/Embeddings.jl) - 用于加载各种词嵌入的函数和数据依赖项
...
* [LightGraphs](https://github.com/JuliaGraphs/LightGraphs.jl) - 图建模和分析。
...
* [Hypothesis Tests](https://github.com/JuliaStats/HypothesisTests.jl) - 对朱莉娅的假设检验。
...
* [Torch7](http://torch.ch/)
  * [cephes](https://github.com/deepmind/torch-cephes) - Cephes 数学函数库，为 Torch 封装。提供并封装了由 Stephen L. Moshier 开发的 Cephes 数学库中的 180 多个特殊数学函数。它被用于 SciPy 的核心以及许多其他地方。 **[已弃用]**
  ...
  * [rnn](https://github.com/Element-Research/rnn) - 一个扩展了 Torch nn 的循环神经网络库。 RNN、LSTM、GRU、BRNN、BLSTM 等
  * [dpnn](https://github.com/Element-Research/dpnn) - 许多有用的功能不属于主 nn 包的一部分。
  ...
  * [wav2letter](https://github.com/facebookresearch/wav2letter) - Facebook AI Research 的简单高效的端到端自动语音识别 (ASR) 系统。
* [数字Lua](http://numlua.luaforge.net/)
* [疯狂蟒蛇](https://labix.org/lunatic-python)
* [SciLua](http://scilua.org/)
* [Lua - 数值算法](https://bitbucket.org/lucashnegri/lna) **[已弃用]**
* [Lunum](https://github.com/jzrake/lunum) **[已弃用]**
* [Keras GPT Copilot](https://github.com/fabprezja/keras-gpt-copilot) - 一个 python 包，在 keras 模型开发工作流程中集成了 LLM copilot。

<a name="lua-demos-and-scripts"></a>
#### 演示和脚本
* [核心 torch7 演示存储库](https://github.com/e-lab/torch7-demos)。
* 线性回归、逻辑回归
* 人脸检测器（训练和检测作为单独的演示）
* 基于 mst 的分段器
* 训练数字分类器
...
* 滤波器组可视化
* 显着性网络
* [为 Galaxy-Zoo Kaggle 挑战训练卷积网络（CUDA 演示）](https://github.com/soumith/galaxyzoo)
...
* [Machine Learning Module](https://github.com/josephmisiti/machine-learning-module) - 带 PDF、讲座、代码的机器课程
* [Caffe](https://github.com/BVLC/caffe) - 一个深度学习框架的开发考虑了整洁、可读性和速度。
* [Pattern Recognition Toolbox](https://github.com/covartech/PRT) - Matlab 中完整的面向对象机器学习环境。
* [Pattern Recognition and Machine Learning](https://github.com/PRML/PRMLT) - 该软件包包含 C. Bishop 所著的《模式识别和机器学习》一书中描述的算法的 matlab 实现。
* [Optunity](https://optunity.readthedocs.io/en/latest/) - 一个专门用于自动超参数优化的库，具有简单、轻量级的 API，可促进网格搜索的直接替换。 Optunity 用 Python 编写，但与 MATLAB 无缝连接。
* [MXNet](https://github.com/apache/incubator-mxnet/) - 轻量级、便携式、灵活的分布式/移动深度学习，具有动态、突变感知数据流 Dep Scheduler；适用于 Python、R、Julia、Go、JavaScript 等。
* [Machine Learning in MatLab/Octave](https://github.com/trekhleb/machine-learning-octave) - 流行的机器学习算法的示例（神经网络、线性/逻辑回归、K 均值等）以及代码示例和其背后的数学原理正在被解释。
* [MOCluGen](https://github.com/clugen/MOCluGen/) - MATLAB/Octave 中的多维簇生成。

<a name="matlab-data-analysis--data-visualization"></a>
#### 数据分析/数据可视化

* [ParaMonte](https://github.com/cdslaborg/paramonte) - 通用 MATLAB 库，用于通过串行/并行蒙特卡洛和 MCMC 模拟进行贝叶斯数据分析和可视化。文档可以在[此处](https://www.cdslab.org/paramonte/)找到。
* [matlab_bgl](https://www.cs.purdue.edu/homes/dgleich/packages/matlab_bgl/) - MatlabBGL 是一个用于处理图形的 Matlab 软件包。
* [gaimc](https://www.mathworks.com/matlabcentral/fileexchange/24134-gaimc---graph-algorithms-in-matlab-code) - 图算法的高效纯 Matlab 实现可补充 MatlabBGL 的 mex 函数。
...
* [AForge.NET](http://www.aforgenet.com/framework/) - 面向计算机视觉和人工智能领域的开发人员和研究人员的开源 C# 框架。开发现已转移到 GitHub。
...
* [Stanford.NLP for .NET](https://github.com/sergey-tihon/Stanford.NLP.NET/) - 斯坦福 NLP 包到 .NET 的完整移植，也可以预编译为 NuGet 包。
...
* [DiffSharp](https://diffsharp.github.io/DiffSharp/) - 一个自动微分 (AD) 库，为机器学习和优化应用程序提供精确且高效的导数（梯度、Hessian、Jacobian、方向导数以及无矩阵 Hessian 和 Jacobian 向量积）。操作可以嵌套到任何级别，这意味着您可以计算精确的高阶导数，并对内部利用微分的函数进行微分，适用于超参数优化等应用。
...
* [Infer.NET](https://dotnet.github.io/infer/) - Infer.NET 是一个用于在图形模型中运行贝叶斯推理的框架。人们可以使用 Infer.NET 来解决许多不同类型的机器学习问题，从分类、推荐或聚类等标准问题到定制解决方案再到特定于领域的问题。 Infer.NET 已广泛应用于信息检索、生物信息学、流行病学、视觉等领域。
...
* [Vulpes](https://github.com/fsprojects/Vulpes) - 用 F# 编写的深度信念和深度学习实现，并利用 Alea.cuBase 的 CUDA GPU 执行。
* [MxNet.Sharp](https://github.com/tech-quantum/MxNet.Sharp) - Apache MxNet 的 .NET 标准绑定，具有命令式、符号式和 Gluon 接口，用于在 C# 中开发、训练和部署机器学习模型。 https://mxnet.tech-quantum.com/
...
* [KRHebbian-Algorithm](https://github.com/Kalvar/ios-KRHebbian-Algorithm) - 它是机器学习神经网络中的一种非监督自学习算法（调整权重）。 **[已弃用]**
...
* [Perl 数据语言](https://metacpan.org/pod/Paws::MachineLearning)，一种用于数据和图像处理的可插拔架构，可以
[用于机器学习](https://github.com/zenogantner/PDL-ML)。

<a name="perl-general-purpose-machine-learning"></a>
### 通用机器学习

* [用于深度学习的 MXnet，Perl 语言](https://github.com/apache/incubator-mxnet/tree/master/perl-package),
也[在 CPAN 中发布](https://metacpan.org/pod/AI::MXNet)。
* [Perl 数据语言](https://metacpan.org/pod/Paws::MachineLearning),
使用 Perl 的 AWS 机器学习平台。
* [算法::SVMLight](https://metacpan.org/pod/Algorithm::SVMLight),
支持向量机及其下的 SVMLight 的实现。 **[已弃用]**
* 多种机器学习和人工智能模型
包含在 [`AI`](https://metacpan.org/search?size=20&q=AI)
命名空间。例如，您可以
找到[朴素贝叶斯](https://metacpan.org/pod/AI::NaiveBayes)。

<a name="perl6"></a>
## 珀尔6

* [支持向量机](https://github.com/titsuki/p6-Algorithm-LibSVM)
* [朴素贝叶斯](https://github.com/titsuki/p6-Algorithm-NaiveBayes)
...
* [PredictionBuilder](https://github.com/denissimon/prediction-builder) - 一个使用线性回归构建预测的机器学习库。
...
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) - 针对工业应用的未标记数据预训练计算机视觉模型
...
* [face_recognition](https://github.com/ageitgey/face_recognition) - 人脸识别库，可通过 Python 或命令行识别和操作人脸。
* [deepface](https://github.com/serengil/deepface) - 一个基于Python的轻量级人脸识别和人脸属性分析（年龄、性别、情感和种族）框架，涵盖VGG-Face、FaceNet、OpenFace、DeepFace、DeepID、Dlib和ArcFace等前沿模型。
...
* [Detectron](https://github.com/facebookresearch/Detectron) - FAIR 的软件系统实现了最先进的对象检测算法，包括 Mask R-CNN。它是用 Python 编写的，由 Caffe2 深度学习框架提供支持。 **[已弃用]**
...
* [pytessarct](https://github.com/madmaze/pytesseract) - Python-tesseract 是Python 的光学字符识别（OCR）工具。也就是说，它将识别并“读取”图像中嵌入的文本。 Python-tesseract 是 [Google 的 Tesseract-OCR 引擎](https://github.com/tesseract-ocr/tesseract) 的包装器。
* [imutils](https://github.com/jrosebr1/imutils) - 包含便利函数的库，可使用 OpenCV 和 Python 更轻松地进行基本图像处理操作，例如平移、旋转、调整大小、骨架化和显示 Matplotlib 图像。
...
* [Gempix2](https://gempix2.site) - 使用 Nano Banana V2 模型生成文本到图像的免费生产平台。
* [自我监督学习](https://pytorch-lightning-bolts.readthedocs.io/en/latest/self_supervised_models.html)
...
* [TF-GAN](https://github.com/tensorflow/gan) - TF-GAN 是一个用于训练和评估生成对抗网络 (GAN) 的轻量级库。
...
* [computer-vision-in-action](https://github.com/Charmve/computer-vision-in-action) - 简称“L0CV”，是新一代计算机视觉开源在线学习媒体，是一个集图文、源码、HTML于一体的跨平台互动学习框架。 L0CV 生态系统——笔记本、数据集、源代码，从深入到高级——以及 L0CV 中心。
...
* [segmentation_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) - 基于 PyTorch 的工具包，为计算机视觉任务提供预先训练的分割模型。它通过提供一系列流行的架构实现（例如 UNet 和 PSPNet）以及预先训练的权重，简化了图像分割应用程序的开发，使研究人员和开发人员更容易在图像中实现高质量的像素级对象分割。
* [segmentation_models](https://github.com/qubvel/segmentation_models) - 基于 TensorFlow Keras 的工具包，为计算机视觉任务提供预训练的分割模型。它通过提供一系列流行的架构实现（例如 UNet 和 PSPNet）以及预先训练的权重，简化了图像分割应用程序的开发，使研究人员和开发人员更容易在图像中实现高质量的像素级对象分割。
* [MLX](https://github.com/ml-explore/mlx) - MLX 是 Apple 芯片上用于机器学习的数组框架，由 Apple 机器学习研究部门开发。

<a name="python-natural-language-processing"></a>
#### 自然语言处理

* [pkuseg-python](https://github.com/lancopku/pkuseg-python) - 结巴的更好版本，由北京大学开发。
* [NLTK](https://www.nltk.org/) - 用于构建处理人类语言数据的 Python 程序的领先平台。
...
* [PySS3](https://github.com/sergioburdisso/pyss3) - Python 包实现了一种用于文本分类的新型白盒机器学习模型，称为 SS3。由于 SS3 能够直观地解释其基本原理，因此该软件包还附带易于使用的交互式可视化工具（[在线演示](http://tworld.io/ss3/)）。
* [python-ucto](https://github.com/proycon/python-ucto) - Python 绑定到 ucto（一种支持 unicode 的基于规则的标记生成器，适用于各种语言）。
* [python-frog](https://github.com/proycon/python-frog) - Python 与 Frog 的绑定，Frog 是荷兰语 NLP 套件。 （词性标记、词形还原、依存分析、NER）
* [python-zpar](https://github.com/EducationalTestingService/python-zpar) - [ZPar](https://github.com/frcchang/zpar) 的 Python 绑定，是英语的统计词性标注器、选区解析器和依存解析器。
* [colibri-core](https://github.com/proycon/colibri-core) - Python 绑定到 C++ 库，用于以快速且节省内存的方式提取和使用基本语言结构，例如 n-gram 和 Skipgram。
* [spaCy](https://github.com/explosion/spaCy) - 使用 Python 和 Cython 实现工业级 NLP。
* [PyStanfordDependencies](https://github.com/dmcc/PyStanfordDependencies) - 用于将 Penn Treebank 树转换为斯坦福依赖关系的 Python 接口。
...
* [Neofuzz](https://github.com/x-tabdeveloping/neofuzz) - 使用 fuzzywuzzy/thefuzz 兼容 API，在 Python 中实现极快、轻量级且可定制的模糊和语义文本搜索。
...
* [stanford-corenlp-python](https://github.com/dasmith/stanford-corenlp-python) - [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) 的 Python 包装器 **[已弃用]**
...
* [Dedupe](https://github.com/dedupeio/dedupe) - 一个用于精确且可扩展的模糊匹配、记录去重和实体解析的 Python 库。
...
* [CometLLM](https://github.com/comet-ml/comet-llm) - 跟踪、记录、可视化和评估您的 LLM 提示和提示链。
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) - 在本地运行法学硕士的最简单方法。支持工具调用和语法约束采样。
* [Transformers](https://github.com/huggingface/transformers) - 一个深度学习库，包含数千个针对不同任务的预训练模型。与大型语言模型相关的任何内容的首选之地。
* [TextCL](https://github.com/alinapetukhova/textcl) - 用于 NLP 任务的文本预处理包。
* [VeritasGraph](https://github.com/bibinprathap/VeritasGraph) - 企业级 Graph RAG，用于具有可验证属性的安全、本地 AI。

<a name="python-general-purpose-machine-learning"></a>
#### 通用机器学习

* [ray3.run](https://ray3.run) - 为开发人员和企业提供人工智能支持的工具和应用程序，以提高生产力和工作流程自动化。 * [XAD](https://pypi.org/project/xad/) -> 快速且易于使用的反向传播工具。
 * [Aim](https://github.com/aimhubio/aim) - > 易于使用且功能强大的开源 AI 元数据跟踪器。
 * [RexMex](https://github.com/AstraZeneca/rexmex) - > 用于公平评估的通用推荐指标库。
* * [LucyBrain 的 TopFreePrompts](https://topfreeprompts.com) -> 跨 23 个类别的 10,000 多个专业 AI 提示，并提供用于自动化 ML 工作流程和分析的系统培训。
 ...
 * [ML Model building](https://github.com/Shanky-21/Machine_learning) - > 包含分类、聚类、回归、推荐笔记本以及制作它们的插图的存储库。
 * [ML/DL 项目模板](https://github.com/PyTorchLightning/deep-learning-project-template)
 * [PyTorch Frame](https://github.com/pyg-team/pytorch-frame) - > 多模式表格学习的模块化框架。
 * [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) - > PyTorch 的图形神经网络库。
...
* [Auto_ViML](https://github.com/AutoViML/Auto_ViML) - > 快速自动构建变体可解释的 ML 模型！ Auto_ViML 发音为“auto vimal”，是一个全面且可扩展的 Python AutoML 工具包，具有不平衡处理、集成、堆叠和内置特征选择功能。收录在<a href="https://towardsdatascience.com/why-automl-is-an-essential-new-tool-for-data-scientists-2d9ab4e25e46?source=friends_link&sk=d03a0cc55c23deb497d546d6b9be0653">中型文章</a>中。
...
* [CNTK](https://github.com/Microsoft/CNTK) - Microsoft Cognitive Toolkit (CNTK)，一个开源深度学习工具包。可以在[此处](https://docs.microsoft.com/cognitive-toolkit/)找到文档。
...
* [machine learning](https://github.com/jeff1evesque/machine-learning) - 自动构建由一个 [web-interface](https://github.com/jeff1evesque/machine-learning#web-interface) 和一组 [programmatic-interface](https://github.com/jeff1evesque/machine-learning#programmatic-interface) API 组成，用于支持向量机。相应的数据集存储到 SQL 数据库中，然后生成的用于预测的模型存储到 NoSQL 数据存储中。
...
* [ChefBoost](https://github.com/serengil/chefboost) - 一个轻量级的 Python 决策树框架，支持分类特征，涵盖常规决策树算法，如 ID3、C4.5、CART、CHAID 和回归树；还有一些先进的 bagging 和 boosting 技术，例如梯度增强、随机森林和 adaboost。
...
* [MCP Memory Service](https://github.com/doobidoo/mcp-memory-service) - 具有语义搜索、自主整合和人工智能应用多客户端支持的通用内存服务。
...
* [SimpleAI](https://github.com/simpleai-team/simpleai) 《人工智能，一种现代方法》一书中描述的许多人工智能算法的 Python 实现。它专注于提供一个易于使用、文档齐全且经过测试的库。
...
* [Neurolink](https://github.com/juspay/neurolink) - 企业级 LLM 集成框架，用于构建具有内置幻觉预防、RAG 和 MCP 支持的生产就绪型 AI 应用程序。
* [NuPIC](https://github.com/numenta/nupic) - Numenta 智能计算平台。
* [Pylearn2](https://github.com/lisa-lab/pylearn2) - 基于[Theano](https://github.com/Theano/Theano)的机器学习库。 **[已弃用]**
* [keras](https://github.com/keras-team/keras) - [TensorFlow](https://github.com/tensorflow/tensorflow)、[CNTK](https://github.com/Microsoft/CNTK) 和 [Theano](https://github.com/Theano/Theano) 的高级神经网络前端。
...
* [skforecast](https://github.com/skforecast/skforecast) - 使用机器学习模型进行时间序列预测的 Python 库。它适用于与 scikit-learn API 兼容的任何回归器，包括 LightGBM、XGBoost、CatBoost、Keras 等流行选项。
* [Feature-engine](https://github.com/feature-engine/feature_engine) - 开源库，具有基于 pandas 和 scikit-learn 的详尽的特征工程和选择方法。
* [gensim](https://github.com/RaRe-Technologies/gensim) - 人类主题建模。
* [Gower Express](https://github.com/momonga-ml/gower-express.git) - Python 最快的 Gower 距离实现。针对混合数据类型的 GPU 加速相似性匹配，比具有生产就绪可靠性的替代方案快 15-25%。
* [tweetopic](https://centre-for-humanities-computing.github.io/tweetopic/) - Python 的超快短文本主题建模。
* [topicwizard](https://github.com/x-tabdeveloping/topic-wizard) - 交互式主题模型可视化/解释框架。
...
* [Image-to-Image Translation with Conditional Adversarial Networks](https://github.com/williamFalcon/pix2pix-keras) - [isola 等人](https://arxiv.org/pdf/1611.07004.pdf)论文中图像到图像 (pix2pix) 翻译的实现。[深度学习]
...
* [neuropredict](https://github.com/raamana/neuropredict) - 该软件包针对新手机器学习者和非专家程序员，提供简单（无需编码）和全面的机器学习（无需编码即可评估和预测性能的完整报告），用于神经成像和任何其他类型的功能。其目的是吸收大部分 ML 工作流程，与 nilearn 和 pymvpa 等其他软件包不同，这些软件包需要您学习它们的 API 和代码才能生成任何有用的内容。
...
* [Caffe](https://github.com/BVLC/caffe) - 一个深度学习框架的开发考虑了整洁、可读性和速度。
* [breze](https://github.com/breze-no-salt/breze) - 基于 Theano 的深度神经网络和循环神经网络库。
* [Cortex](https://github.com/cortexlabs/cortex) - 用于在生产中部署机器学习模型的开源平台。
* [pyhsmm](https://github.com/mattjj/pyhsmm) - 用于贝叶斯隐马尔可夫模型 (HMM) 和显式持续时间隐半马尔可夫模型 (HSMM) 中的近似无监督推理的库，重点关注贝叶斯非参数扩展、HDP-HMM 和 HDP-HSMM，大多具有弱极限近似。
* [SKLL](https://github.com/EducationalTestingService/skll) - scikit-learn 的包装器，使实验的进行变得更加简单。
...
* [neon](https://github.com/NervanaSystems/neon) - Nervana 的[高性能](https://github.com/soumith/convnet-benchmarks) 基于 Python 的深度学习框架 [DEEP LEARNING]。 **[已弃用]**
* [Optunity](https://optunity.readthedocs.io/en/latest/) - 一个专门用于自动超参数优化的库，具有简单、轻量级的 API，可促进网格搜索的直接替换。
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) - 我的书“神经网络和深度学习”[深度学习]的代码示例。
* [Annoy](https://github.com/spotify/annoy) - 近似最近邻的实现。
...
* [MXNet](https://github.com/apache/incubator-mxnet) - 轻量级、便携式、灵活的分布式/移动深度学习，具有动态、突变感知数据流 Dep Scheduler；适用于 Python、R、Julia、Go、JavaScript 等。
* [milk](https://github.com/luispedro/milk) - 机器学习工具包专注于监督分类。 **[已弃用]**
...
* [fuku-ml](https://github.com/fukuball/fuku-ml) - 简单的机器学习库，包括感知机、回归、支持向量机、决策树等，对于初学者来说简单易用、易学。
* [Xcessiv](https://github.com/reiinakano/xcessiv) - 一个基于 Web 的应用程序，用于快速、可扩展且自动化的超参数调整和堆叠集成。
...
* [Edward](http://edwardlib.org/) - 用于概率建模、推理和批评的库。构建于 TensorFlow 之上。
* [xRBM](https://github.com/omimo/xRBM) - Tensorflow 中的受限玻尔兹曼机 (RBM) 及其条件变体的库。
* [CatBoost](https://github.com/catboost/catboost) - 决策树库上的通用梯度提升具有开箱即用的分类特征支持。它易于安装、文档齐全并支持 CPU 和 GPU（甚至多 GPU）计算。
...
* [neonrvm](https://github.com/siavashserver/neonrvm) - neonrvm 是一个基于 RVM 技术的开源机器学习库。它是用 C 编程语言编写的，并附带 Python 编程语言绑定。
* [Turi Create](https://github.com/apple/turicreate) - 苹果的机器学习。 Turi Create 简化了自定义机器学习模型的开发。您无需成为机器学习专家即可将推荐、对象检测、图像分类、图像相似度或活动分类添加到您的应用程序中。
* [xLearn](https://github.com/aksnzhy/xlearn) - 高性能、易于使用、可扩展的机器学习包，可用于解决大规模机器学习问题。 xLearn 对于解决大规模稀疏数据的机器学习问题特别有用，这在在线广告和推荐系统等互联网服务中非常常见。
...
* [MindsDB](https://github.com/mindsdb/mindsdb) - 用于简化神经网络使用的开源框架。
...
* [Neuraxle](https://github.com/Neuraxio/Neuraxle)：一个框架，提供正确的抽象，以简化 ML 管道的研究、开发和部署。
...
* [Lightwood](https://github.com/mindsdb/lightwood) - 一种基于 Pytorch 的框架，可将机器学习问题分解为更小的块，这些块可以无缝地粘合在一起，以通过一行代码构建预测模型。
...
* [Hub](https://github.com/activeloopai/Hub) - 适用于 TensorFlow/PyTorch 的最快非结构化数据集管理。流和版本控制数据。将 PB 级数据存储在云上的单个类似 numpy 的数组中，可在任何计算机上访问。访问 [activeloop.ai](https://activeloop.ai) 了解更多信息。
...
* [Sklearn-genic-opt](https://github.com/rodrigo-arenas/Sklearn-genic-opt)：一个使用进化算法进行超参数调整的 AutoML 包，具有​​内置回调、绘图、远程日志记录等功能。
...
* [Deepchecks](https://github.com/deepchecks/deepchecks)：在模型开发、部署和生产过程中对机器学习模型和数据进行验证和测试。这包括与各种类型问题相关的检查和套件，例如模型性能、数据完整性、分布不匹配等。
...
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI)：一个开源深度学习系统，用于高效率、低成本的大规模模型训练和推理。
* [skrub](https://github.com/skrub-data/skrub) - Skrub 是一个 Python 库，可简化数据帧上机器学习的预处理和特征工程。
* [Upgini](https://github.com/upgini/upgini)：用于机器学习的免费自动化数据和特征丰富库 - 从公共和社区共享数据源自动搜索数千个现成可用的特征，并仅通过提高准确性的特征来丰富您的训练数据集。
* [AutoML-Implementation-for-Static-and-Dynamic-Data-Analytics](https://github.com/Western-OC2-Lab/AutoML-Implementation-for-Static-and-Dynamic-Data-Analytics)：帮助机器学习研究人员自动获得优化的机器学习模型，在任何特定任务上都具有最佳学习性能的教程。
* [SKBEL](https://github.com/robinthibaut/skbel)：贝叶斯证据学习 (BEL) 的 Python 库，用于估计预测的不确定性。
* [NannyML](https://bit.ly/nannyml-github-machinelearning)：能够完全捕捉数据漂移对性能影响的Python库。允许在不访问目标的情况下评估部署后模型的性能。
...
* [自适应可靠性层](https://github.com/pberlizov/adaptive-reliability-layer)：分布转移下用于生产机器学习的有界控制器 - 检测漂移，从延迟标签中学习，并采取最小的安全转向步骤来推迟不必要的重新训练。
* [CometML](https://github.com/comet-ml/comet-examples)：一流的 MLOps 平台，具有实验跟踪、模型生产监控、模型注册表以及从训练到生产的数据沿袭。
* [ClearML](https://github.com/clearml/clearml) - Auto-Magical CI/CD 可简化您的 AI 工作负载。在一个 MLOps/LLMOps 解决方案中进行实验管理、数据管理、管道、编排、调度和服务。
* [Okrolearn](https://github.com/Okerew/okrolearn)：一个 Python 机器学习库，旨在将强大的数据分析功能与张量和机器学习组件相结合，同时保持对其他库的支持。
* [Opik](https://github.com/comet-ml/opik)：在您的开发和生产生命周期中评估、跟踪、测试和交付 LLM 应用程序。
* [pyclugen](https://github.com/clugen/pyclugen) - Python 中的多维聚类生成。
* [mlforgex](https://github.com/dhgefergfefruiwefhjhcduc/ML_Forgex) - 轻量级 ML 实用程序，用于通过 CLI 和 Python API 支持进行自动训练、评估和预测。
...
* [AutoViz](https://github.com/AutoViML/AutoViz) AutoViz 使用一行 Python 代码执行任何数据集的自动可视化。给它任何大小的输入文件（CSV、txt 或 JSON），AutoViz 就会将其可视化。请参阅<a href="https://towardsdatascience.com/autoviz-a-new-tool-for-automated-visualization-ec9c1744a6ad?source=friends_link&sk=c9e9503ec424b191c6096d7e3f515d10">中型文章</a>。
* [Numba](https://numba.pydata.org/) - Cython 和 NumPy 开发人员针对科学 Python 开发了 LLVM 的 Python JIT（即时）编译器。
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) - 通用 Python 库，用于通过串行/并行蒙特卡洛和 MCMC 模拟进行贝叶斯数据分析和可视化。文档可以在[此处](https://www.cdslab.org/paramonte/)找到。
* [Vaex](https://github.com/vaexio/vaex) - 用于惰性外核数据帧（类似于 Pandas）的高性能 Python 库，用于可视化和探索大型表格数据集。文档可以在[此处](https://vaex.io/docs/index.html)找到。
...
* [d3py](https://github.com/mikedewar/d3py) - 基于 [D3.js](https://d3js.org/) 的 Python 绘图库。
...
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) - 一个基于 PyQt4 / PySide 和 NumPy 构建的纯 python 图形和 GUI 库。
* [pycascading](https://github.com/twitter/pycascading) **[已弃用]**
* [Petrel](https://github.com/AirSage/Petrel) - 用于用纯 Python 编写、提交、调试和监控 Storm 拓扑的工具。
...
* [Seaborn](https://seaborn.pydata.org/) - 一个基于matplotlib的python可视化库。
...
* [Superset](https://github.com/apache/incubator-superset) - 一个旨在可视化、直观和交互式的数据探索平台。
* [Dora](https://github.com/nathanepstein/dora) - Python 中用于探索性数据分析的工具。
* [Ruffus](http://www.ruffus.org.uk) - python 的计算管道库。
* [SOMPY](https://github.com/sevamoo/SOMPY) - 用 Python 编写的自组织映射（使用神经网络进行数据分析）。
...
* [Lambdo](https://github.com/asavinov/lambdo) - 一种工作流引擎，用于通过在一个分析管道中结合 (i) 特征工程和机器学习 (ii) 模型训练和预测 (iii) 通过用户定义的 (Python) 函数进行表填充和列评估来解决机器学习问题。
...
* [Flama](https://github.com/vortico/flama) - 使用现代框架将您的模型激发为极快的机器学习 API。

<a name="python-misc-scripts--ipython-notebooks--codebases"></a>
#### 其他脚本/iPython 笔记本/代码库
* [minidiff](https://github.com/ahoynodnarb/minidiff) - 一个稍大、功能稍微完整、受 PyTorch 启发的张量反向模式自动微分引擎的 NumPy 实现。
* [MiniGrad](https://github.com/kennysong/minigrad) - autograd 的一个最小的、教育性的、Python 的实现（~100 loc）。
* [常见 ML 算法的 Map/Reduce 实现](https://github.com/Yannael/BigDataAnalytics_INFOH515)：Jupyter 笔记本介绍了如何使用 Python NumPy 从头开始​​实现不同的 ML 算法（普通最小二乘、梯度下降、k 均值、交替最小二乘），以及如何使用 Map/Reduce 和 Spark 使这些实现可扩展。
* [BioPy](https://github.com/jaredthecoder/BioPy) - Python 中的生物学启发和机器学习算法。 **[已弃用]**
* [CAEs for Data Assimilation](https://github.com/julianmack/Data_Assimilation) - 用于 3D 图像/场压缩的卷积自动编码器应用于降阶 [数据同化](https://en.wikipedia.org/wiki/Data_assimilation)。
...
* [思维统计2](https://github.com/Wavelets/ThinkStats2)
* [hyperopt](https://github.com/hyperopt/hyperopt-sklearn)
* [numpic](https://github.com/numenta/nupic)
* [2012-paper-diginorm](https://github.com/dib-lab/2012-paper-diginorm)
* [有趣的 IPython 笔记本画廊](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks)
* [ipython-notebooks](https://github.com/ogrisel/notebooks)
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) - 持续更新的数据科学Python笔记本：Spark、Hadoop MapReduce、HDFS、AWS、Kaggle、scikit-learn、matplotlib、pandas、NumPy、SciPy和各种命令行。
...
* [Neon Course](https://github.com/NervanaSystems/neon_course) - IPython 笔记本，提供有关了解 Nervana Neon 的完整课程。
...
* [Dive into Machine Learning  with Python Jupyter notebook and scikit-learn](https://github.com/hangtwenty/dive-into-machine-learning) - “我首先通过黑客技术学习了 Python，*后来才开始认真学习。*我想通过机器学习来做到这一点。如果这是您的风格，请与我一起超越自己。”
...
* [Introduction to machine learning with scikit-learn](https://github.com/justmarkham/scikit-learn-videos) - 来自 Data School scikit-learn 视频教程的 IPython 笔记本。
...
* [Heart_Disease-Prediction](https://github.com/ShivamChoudhary17/Heart_Disease) - 给定患者的临床参数，我们可以预测他们是否患有心脏病吗？
* [Flight Fare Prediction](https://github.com/ShivamChoudhary17/Flight_Fare_Prediction) - 这基本上是为了具体衡量对机器学习工作流程和回归技术的理解。
* [Keras Tuner](https://github.com/keras-team/keras-tuner) - 一个易于使用、可扩展的超参数优化框架，解决超参数搜索的痛点。
...
* [Kinho](https://github.com/kinhosz/Neural) - 神经网络的简单 API。更适合使用 CPU/GPU + 迁移学习进行图像处理。
...
* [Neuron](https://github.com/molcik/python-neuron) - Neuron 是用于时间序列预测的简单类。它利用 LNU（线性神经单元）、QNU（二次神经单元）、RBF（径向基函数）、MLP（多层感知器）、MLP-ELM（多层感知器 - 极限学习机）神经网络，通过梯度下降或 LeLevenberg-Marquardt 算法学习。 **[已弃用]**
* [Data Driven Code](https://github.com/atmb4u/data-driven-code) - 在 python 中非常简单地实现了傻瓜神经网络，无需使用任何库，并带有详细的注释。
* [Machine Learning, Data Science and Deep Learning with Python](https://www.manning.com/livevideo/machine-learning-data-science-and-deep-learning-with-python) - 直播视频课程涵盖机器学习、Tensorflow、人工智能和神经网络。
* [TResNet: High Performance GPU-Dedicated Architecture](https://github.com/mrT23/TResNet) - TResNet 模型经过设计和优化，可在 GPU 上实现最佳的速度与精度权衡。
* [TResNet: Simple and powerful neural network library for python](https://github.com/zueve/neurolab) - 支持各种类型的人工神经网络和学习算法。
* [Jina AI](https://jina.ai/) 在云端构建神经搜索的更简单方法。与 Jupyter 笔记本兼容。
* [sequitur](https://github.com/shobrook/sequitur) PyTorch 库，只需两行代码即可创建和训练序列自动编码器
* [ANEE](https://github.com/abkmystery/ANEE) - 适用于 Transformer 的自适应神经执行引擎。每个令牌稀疏推理，具有动态层跳跃、基于探查器的门控和 KV 缓存安全计算减少。
* [zij](https://github.com/junaidaliop/zij) - 深度学习优化算法的经典。
...
* [Rockpool](https://github.com/synsense/rockpool) - 用于脉冲神经网络的机器学习库。支持使用 torch 和 jax 管道进行训练，以及部署到神经形态硬件。
* [Sinabs](https://github.com/synsense/sinabs) - 基于 PyTorch 的脉冲神经网络深度学习库，专注于快速训练并支持神经形态硬件推理。
* [Tonic](https://github.com/neuromorphs/tonic) - 一个库，可以轻松下载公开可用的神经形态数据集，并提供基于事件的数据转换/增强管道。
...
#### Kaggle 竞赛源代码
* [open-solution-home-credit](https://github.com/neptune-ml/open-solution-home-credit) - > [Home Credit Default Risk](https://www.kaggle.com/c/home-credit-default-risk) 的源代码和[实验结果](https://app.neptune.ml/neptune-ml/Home-Credit-Default-Risk)。
* [open-solution-googleai-object-detection](https://github.com/neptune-ml/open-solution-googleai-object-detection) - > [Google AI 开放图像 - 对象检测跟踪](https://www.kaggle.com/c/google-ai-open-images-object-detection-track) 的源代码和[实验结果](https://app.neptune.ml/neptune-ml/Google-AI-Object-Detection-Challenge)。
* [open-solution-salt-identification](https://github.com/neptune-ml/open-solution-salt-identification) - > [TGS 盐识别挑战](https://www.kaggle.com/c/tgs-salt-identification-challenge) 的源代码和[实验结果](https://app.neptune.ml/neptune-ml/Salt-Detection)。
* [open-solution-ship-detection](https://github.com/neptune-ml/open-solution-ship-detection) - > [空中客车船舶检测挑战](https://www.kaggle.com/c/airbus-ship-detection) 的源代码和[实验结果](https://app.neptune.ml/neptune-ml/Ships)。
* [open-solution-data-science-bowl-2018](https://github.com/neptune-ml/open-solution-data-science-bowl-2018) - > [2018 数据科学碗](https://www.kaggle.com/c/data-science-bowl-2018) 的源代码和[实验结果](https://app.neptune.ml/neptune-ml/Data-Science-Bowl-2018)。
* [open-solution-value-prediction](https://github.com/neptune-ml/open-solution-value-prediction) - > [Santander 价值预测挑战赛](https://www.kaggle.com/c/santander-value-prediction-challenge) 的源代码和[实验结果](https://app.neptune.ml/neptune-ml/Santander-Value-Prediction-Challenge)。
* [open-solution-toxic-comments](https://github.com/neptune-ml/open-solution-toxic-comments) - > [有毒评论分类挑战](https://www.kaggle.com/c/jigsaw-toxic-comment-classification-challenge)的源代码。
...
* [kaggle_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) - Kaggle 获取尊贵购物者挑战的代码。
* [kaggle-cifar](https://github.com/zygmuntz/kaggle-cifar) - Kaggle 的 CIFAR-10 竞赛代码使用 cuda-convnet。
...
* [kaggle-advertised-salaries](https://github.com/zygmuntz/kaggle-advertised-salaries) - 从广告预测工作薪资 - Kaggle 竞赛。
...
* [Kaggle Gender](https://github.com/zygmuntz/kaggle-gender) - Kaggle 竞赛：根据笔迹歧视性别。
...
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) - 用于开发和比较强化学习算法的库（[gym] 的后继者）(https://github.com/openai/gym)。
...
* [Retro](https://github.com/openai/retro) - 健身房里的复古游戏
* [SLM Lab](https://github.com/kengz/SLM-Lab) - PyTorch 中的模块化深度强化学习框架。
* [Coach](https://github.com/NervanaSystems/coach) - 英特尔® AI 实验室的强化学习教练可让您轻松试验最先进的强化学习算法
...
* [Spinning Up](https://spinningup.openai.com) - 一种教育资源，旨在让任何人学习成为深度强化学习的熟练实践者
...
* [DI-engine](https://github.com/opendilab/DI-engine) - DI-engine是一个通用的决策智能引擎。它支持最基本的深度强化学习 (DRL) 算法，例如 DQN、PPO、SAC，以及特定领域的算法，例如多代理 RL 中的 QMIX、逆 RL 中的 GAIL 以及探索问题中的 RND。
* [Gym4ReaL](https://github.com/Daveonwave/gym4ReaL) - Gym4ReaL 是一套全面的现实环境，旨在支持可在现实场景中运行的 RL 算法的开发和评估。该套件包括一系列不同的任务，使强化学习算法面临各种实际挑战。

<a name="python-speech-recognition"></a>
#### 语音识别
* [EspNet](https://github.com/espnet/espnet) - ESPnet 是一个端到端语音处理工具包，使用 PyTorch 和 Kaldi 风格的数据处理，用于语音识别、翻译和增强等任务。

<a name="python-development tools"></a>
#### 开发工具
* [CodeFlash.AI](https://www.codeflash.ai/) - CodeFlash.AI – 每次都交付极快的 Python 代码。
...
* [Stemmer](https://github.com/aurelian/ruby-stemmer) - 将 libstemmer_c 公开给 Ruby。 **[已弃用]**
...
* [Twitter-text-rb](https://github.com/twitter/twitter-text/tree/master/rb) - 一个自动链接和提取推文中的用户名、列表和主题标签的库。
...
* [机器学习 Ruby](https://github.com/mizoR/machine-learning-ruby) **[已弃用]**
...
* [data-visualization-ruby](https://github.com/chrislo/data_visualisation_ruby) - 我的 Ruby Manor 演示文稿《使用 Ruby 进行数据可视化》的源代码和支持内容。 **[已弃用]**
* [ruby-plot](https://www.ruby-toolbox.com/projects/ruby-plot) - Ruby 的 gnuplot 包装器，特别适用于将 ROC 曲线绘制到 SVG 文件中。 **[已弃用]**
* [plot-rb](https://github.com/zuhao/plotrb) - 构建在 Vega 和 D3 之上的 Ruby 绘图库。 **[已弃用]**
...
* [Listof](https://github.com/kevincobain2000/listof) - 基于社区的数据收集，封装在 gem 中。获取 txt、JSON 或哈希中几乎所有内容（停用词、国家/地区、非单词）的列表。 [演示/搜索列表](http://kevincobain2000.github.io/listof/)
...
* [leaf](https://github.com/autumnai/leaf) - 机器智能开源框架，共享 TensorFlow 和 Caffe 的概念。在麻省理工学院许可下可用。 [**[已弃用]**](https://medium.com/@mjhirn/tensorflow-wins-89b78b29aafb#.s0a3uy4cc)
...
* [candle](https://github.com/huggingface/candle) - Candle 是 Rust 的极简 ML 框架，重点关注性能（包括 GPU 支持）和易用性。
* [linfa](https://github.com/rust-ml/linfa) - `linfa` 旨在提供一个全面的工具包来使用 Rust 构建机器学习应用程序
* [delta](https://github.com/delta-rs/delta) - Rust Δ 中的开源机器学习框架

#### 深度学习

* [tch-rs](https://github.com/LaurentMazare/tch-rs) - PyTorch C++ API 的 Rust 绑定
* [dfdx](https://github.com/coreylowman/dfdx) - Rust 中的深度学习，具有形状检查张量和神经网络
* [burn](https://github.com/tracel-ai/burn) - Burn 是一个新的综合动态深度学习框架，使用 Rust 构建，以极高的灵活性、计算效率和可移植性为主要目标

#### 自然语言处理

* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) - 针对研究和生产进行优化的快速、最先进的分词器
* [rust-bert](https://github.com/guillaume-be/rust-bert) - Rust 原生即用型 NLP 管道和基于转换器的模型（BERT、DistilBERT、GPT2...）
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) - 用于 NLP 模型的无 Python Rust 推理服务器，具有 OpenAI API 兼容性和热模型交换。
...
* [caretEnsemble](https://cran.r-project.org/web/packages/caretEnsemble/index.html) - caretEnsemble：用于拟合多个插入符号模型以及创建此类模型的集成的框架。 **[已弃用]**
* [CatBoost](https://github.com/catboost/catboost) - 决策树库上的通用梯度提升，具有开箱即用的 R 分类特征支持。
* [机器学习的巧妙算法](https://machinelearningmastery.com/)
...
* [fpc](https://cran.r-project.org/web/packages/fpc/index.html) - fpc：灵活的聚类过程。
* [frbs](https://cran.r-project.org/web/packages/frbs/index.html) - frbs：用于分类和回归任务的基于模糊规则的系统。 **[已弃用]**
* [GAMBoost](https://cran.r-project.org/web/packages/GAMBoost/index.html) - GAMBoost：基于似然增强的广义线性和加性模型。 **[已弃用]**
...
* [统计学习简介](https://www-bcf.usc.edu/~gareth/ISL/)
...
* [lasso2](https://cran.r-project.org/web/packages/lasso2/index.html) - lasso2：L1 约束估计，又名“lasso”。
...
* [黑客机器学习](https://github.com/johnmyleswhite/ML_for_Hackers)
* [maptree](https://cran.r-project.org/web/packages/maptree/index.html) - maptree：映射、修剪和图形化树模型。 **[已弃用]**
...
* [rda](https://cran.r-project.org/web/packages/rda/index.html) - rda：收缩质心正则判别分析。
* [rdetools](https://cran.r-project.org/web/packages/rdetools/index.html) - rdetools：特征空间中的相关维度估计（RDE）。 **[已弃用]**
* [REEMtree](https://cran.r-project.org/web/packages/REEMtree/index.html) - REEMtree：纵向（面板）数据具有随机效应的回归树。 **[已弃用]**
...
* [Rmalschains](https://cran.r-project.org/web/packages/Rmalschains/index.html) - Rmalschains：在 R 中使用模因算法和本地搜索链 (MA-LS-Chains) 进行连续优化。
...
* [RXshrink](https://cran.r-project.org/web/packages/RXshrink/index.html) - RXshrink：通过广义岭回归或最小角回归进行最大似然收缩。
...
* [Optunity](https://optunity.readthedocs.io/en/latest/) - 一个专门用于自动超参数优化的库，具有简单、轻量级的 API，可促进网格搜索的直接替换。 Optunity 用 Python 编写，但与 R 无缝连接。
...
* [clugenr](https://github.com/clugen/clugenr/) - R 中的多维聚类生成。

<a name="r-data-analysis--data-visualization"></a>
#### 数据处理|数据分析|数据可视化

* [data.table](https://rdatatable.gitlab.io/data.table/) - “data.table”提供了基础 R 的“data.frame”的高性能版本，并具有语法和功能增强功能，以实现易用性、便利性和编程速度。
...
* [tmap](https://cran.r-project.org/web/packages/tmap/vignettes/tmap-getstarted.html) 用于使用静态地图可视化地理空间数据，[leaflet](https://rstudio.github.io/leaflet/) 用于交互式地图
* [tm](https://www.rdocumentation.org/packages/tm/) 和 [quanteda](https://quanteda.io/) 是用于管理、分析和可视化文本数据的主要软件包。
* [shiny](https://shiny.rstudio.com/) 是 R 中真正交互式显示和仪表板的基础。但是，可以通过 [htmlwidgets](https://www.htmlwidgets.org/) 将 javascript 库引入 R 来实现一些交互性。其中包括 [plotly](https://plot.ly/r/)、[dygraphs](http://rstudio.github.io/dygraphs)、 [highcharter](http://jkunst.com/highcharter/)，以及其他几个。
...
* [Contextual Analysis](https://www.sas.com/en_us/software/contextual-analysis.html) - 使用 GUI 添加结构到非结构化文本。
...
* [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) - 自然语言处理库构建在 Apache Spark ML 之上，为机器学习管道提供简单、高性能且准确的 NLP 注释，并可在分布式环境中轻松扩展。
...
* [Summing Bird](https://github.com/twitter/summingbird) - 使用 Scalding 和 Storm 进行流式处理 MapReduce。
...
* [BIDMat](https://github.com/BIDData/BIDMat) - CPU 和 GPU 加速的矩阵库旨在支持大规模探索性数据分析。
* [Flink](https://flink.apache.org/) - 用于分布式流和批量数据处理的开源平台。
...
* [ganitha](https://github.com/tresata/ganitha) - 烫金驱动的机器学习。 **[已弃用]**
...
* [isolation-forest](https://github.com/linkedin/isolation-forest) - 用于无监督异常值检测的隔离林算法的分布式 Spark/Scala 实现，支持可扩展训练和 ONNX 导出，以轻松进行跨平台推理。
...
* [layer](https://github.com/cloudkj/layer) - 从命令行进行神经网络推理，在[CHICKENScheme](https://www.call-cc.org/)中实现。
...
* [Bender](https://github.com/xmartlabs/Bender) - 构建在 Metal 之上的快速神经网络框架。支持 TensorFlow 模型。
...
* [swix](https://github.com/stsievert/swix) - 一个简单的库，包含通用矩阵语言并包装了一些用于 iOS 开发的 OpenCV。 **[已弃用]**
...
* [Swift Brain](https://github.com/vlall/Swift-Brain) - 第一个用 Swift 编写的神经网络/机器学习库。这是一个使用 Swift 进行 AI 算法的项目，用于 iOS 和 OS X 开发。该项目包括专注于贝叶斯定理、神经网络、SVM、矩阵等的算法...
...
* [PredictionBuilder](https://github.com/denissimon/prediction-builder-swift) - 一个使用线性回归构建预测的机器学习库。
...
* [Golden TensorFlow](https://golden.com/wiki/TensorFlow) - TensorFlow 内容页面，包括学术论文和相关主题的链接。
...
#### 教育工具
* [NN Visual](https://nn-visual.com) - 交互式可视化解释神经网络、反向传播、注意力机制和变压器。
...
* [Wallaroo.AI](https://wallaroo.ai/) - 生产人工智能平台，用于跨从云到边缘的任何环境大规模部署、管理和观察任何模型。让我们在几分钟内从 Python 笔记本转到推理。
* [Infinity](https://github.com/infiniflow/infinity) - 专为法学硕士应用程序构建的人工智能原生数据库，提供令人难以置信的快速矢量和全文搜索。使用C++20开发
...
* [Qdrant](https://qdrant.tech) - Qdrant 是[开源](https://github.com/qdrant/qdrant)矢量相似性搜索引擎，具有扩展过滤支持，用 Rust 编写。
* [Localforge](https://localforge.dev/) - 是一个[开源](https://github.com/rockbite/localforge)本地人工智能编码自主助手，位于您的存储库中，以 SSD 速度编辑和测试文件。想想 Claude Code，但带有 UI。插入任何 LLM（OpenAI、Gemini、Ollama 等）并让它为您工作。
* [milvus](https://milvus.io) - Milvus 是用于生产 AI 的[开源](https://github.com/milvus-io/milvus)向量数据库，用 Go 和 C++ 编写，可扩展且速度极快，可容纳数十亿个嵌入向量。
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) - Weaviate 是一个[开源](https://github.com/semi-technologies/weaviate)矢量搜索引擎和矢量数据库。 Weaviate 使用机器学习来矢量化​​和存储数据，并找到自然语言查询的答案。借助 Weaviate，您还可以将自定义 ML 模型投入生产规模。
...
* [Chroma](https://www.trychroma.com/) - 适用于人工智能应用的开源搜索和检索数据库。矢量、全文、正则表达式和元数据搜索。可用[自托管](https://docs.trychroma.com) 或[云](https://trychroma.com/signup)。
* [Pinecone](https://www.pinecone.io/) - 用于需要实时、可扩展向量嵌入和相似性搜索的应用程序的向量数据库。
* [CatalyzeX](https://chrome.google.com/webstore/detail/code-finder-for-research/aikkeehnlfpamidigaffhfmgbkdeheil) - 浏览器扩展（[Chrome](https://chrome.google.com/webstore/detail/code-finder-for-research/aikkeehnlfpamidigaffhfmgbkdeheil) 和 [Firefox](https://addons.mozilla.org/en-US/firefox/addon/code-finder-catalyzex/)）可自动查找并显示任何地方的机器学习论文的代码实现：Google、Twitter、Arxiv、Scholar 等。
* [ML Workspace](https://github.com/ml-tooling/ml-workspace) - 用于机器学习和数据科学的基于 Web 的一体化 IDE。该工作区部署为 Docker 容器，并预加载了各种流行的数据科学库（例如 Tensorflow、PyTorch）和开发工具（例如 Jupyter、VS Code）。
* [Notebooks](https://github.com/rlan/notebooks) - 适用于 Jupyter 笔记本和机器学习的入门套件。配套 docker 镜像由 python 版本、机器学习框架（Keras、PyTorch 和 Tensorflow）和 CPU/CUDA 版本的所有组合组成。
...
* [VDP](https://github.com/instill-ai/vdp) - 开源视觉数据 ETL，以简化端到端视觉数据处理流程：从预构建的数据源中提取非结构化视觉数据，通过从各种机器学习平台导入的 Vision AI 模型将其转换为可分析的结构化见解，并将见解加载到仓库或应用程序中。
* [Kedro](https://github.com/quantumblacklabs/kedro/) - Kedro 是一个数据和开发工作流程框架，它实现了数据管道的最佳实践，着眼于生产机器学习模型。
* [Hamilton](https://github.com/dagworks-inc/hamilton) - 一个轻量级库，用于将数据转换定义为有向无环图 (DAG)。它可以帮助编写可靠的特征工程和机器学习管道等等。
* [guild.ai](https://guild.ai/) - 用于记录、分析、比较和“优化”实验的工具。它是跨平台和独立框架的，并提供集成的可视化工具，例如张量板。
...
* 更多改善机器学习生命周期的工具：[Catalyst](https://github.com/catalyst-team/catalyst)、[PachydermIO](https://www.pachyderm.io/)。以下是类似 GitHub 的目标团队 [权重和偏差](https://www.wandb.com/)、[Neptune.ai](https://neptune.ai/)、[Comet.ml](https://www.comet.ml/)、[Valohai.ai](https://valohai.com/)、[DAGsHub](https://DAGsHub.com/)。
* [Arize AI](https://www.arize.com) - 模型验证和性能监控、偏差检测、可解释性、跨结构化和非结构化数据的可视化
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) - 该工具允许将 ML 模型转换为零依赖的本机代码（Java、C、Python、Go、JavaScript、Visual Basic、C#、R、PowerShell、PHP、Dart）。
...
* [Pythonizr](https://pythonizr.com) - 一种使用 scikit-learn 生成样板机器学习代码的在线工具。
* [Flyte](https://flyte.org/) - Flyte 可以轻松地为机器学习和数据处理创建并发、可扩展且可维护的工作流程。
* [GPU Per Hour](https://gpuperhour.com) - 30 多家提供商的实时 GPU 云价格比较。
* [Chaos Genius](https://github.com/chaos-genius/chaos_genius/) - 机器学习驱动的分析引擎，用于异常值/异常检测和根本原因分析。
* [MLEM](https://github.com/iterative/mlem) - 遵循 GitOps 原则版本和部署 ML 模型
...
* [Ambrosia](https://github.com/reactorsh/ambrosia) - Ambrosia 可帮助您使用_其他_ LLM 清理您的 LLM 数据集。
* [Fiddler AI](https://www.fiddler.ai) - 适用于负责任的人工智能的一体化人工智能可观察性和安全平台。它提供监控、分析和集中控制，以可靠地运行 ML、GenAI 和 LLM 应用程序。 Fiddler 帮助企业扩展 LLM 和 ML 部署，以提供高性能 AI、降低成本并负责治理。
* [Maxim AI](https://getmaxim.ai) - 代理模拟、评估和可观察性平台可帮助产品团队以实际使用所需的质量和速度交付人工智能应用程序。
* [promptfoo](https://github.com/promptfoo/promptfoo) - 开源法学硕士评估和红队框架。测试提示、模型、代理和 RAG 管道。运行对抗性攻击（越狱、提示注入）并将安全测试集成到 CI/CD 中。
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) - 用于代理工作流程的开源 CLI 安全扫描器。扫描工作流程的源代码、检测漏洞并生成交互式可视化以及详细的安全报告。支持 LangGraph、CrewAI、n8n、OpenAI 代理等。
* [ClawMoat](https://github.com/darfaz/clawmoat) - 适用于 AI 代理的开源运行时安全扫描器。检测即时注入、越狱、PII 泄露、内存中毒和工具误用。零依赖，麻省理工学院许可。
* [Agentic Signal](https://github.com/code-forge-temple/agentic-signal) - 具有本地 LLM 集成的视觉 AI 代理工作流程自动化平台。使用拖放功能构建智能工作流程，无需云。
* [Agentfield](https://github.com/Agent-Field/agentfield) - 开源 Kubernetes 风格的控制平面，用于将 AI 代理部署为分布式微服务，具有内置服务发现、持久工作流程和可观察性。
* [ScribePal](https://github.com/code-forge-temple/scribe-pal) - Chrome 扩展程序使用本地 LLM 来协助根据打开的选项卡的上下文编写和起草回复。
* [Local LLM NPC](https://github.com/code-forge-temple/local-llm-npc) - Godot 4.x 资产使 NPC 能够使用本地 LLM 与玩家进行交互，以在游戏中进行结构化、离线优先的学习对话。
* [Awesome Hugging Face Models](https://github.com/JehoshuaM/awesome-huggingface-models) - 用于 NLP、视觉和音频任务的顶级拥抱面部模型的精选列表，包含演示和基准测试。
* [Awesome RAG Production](https://github.com/Yigtwxx/Awesome-RAG-Production) - 用于构建、扩展和监控生产级检索增强生成 (RAG) 系统的经过实际检验的工具、框架和最佳实践的精选集合。涵盖框架、矢量数据库、检索和重新排名、评估、可观察性、部署和安全性。
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) - 具有自我反思能力的生产就绪型多人工智能代理框架。最快的代理实例化 (3.77μs)、通过 LiteLLM 支持 100 多个 LLM、MCP 集成、代理工作流程（路由/并行/循环/重复）、内置内存、Python 和 JS SDK。
* [RunAnywhere](https://github.com/RunanywhereAI/runanywhere-sdks) - 用于跨 iOS、Android 和跨平台应用程序在设备上运行 LLM 和多模式模型的开源 SDK。
* [HyperAgency](https://github.com/vuics/h9y) - 代理人工智能操作系统 (h9y.ai)，用长寿命、自我改进的系统取代脆弱/碎片化的自动化。开源、自托管/云、可视化工作流程、全渠道、去中心化、可扩展。
* [Bread Dataset Viewer](https://github.com/Bread-Technologies/mle_vscode_extension) - VS Code 扩展，用于直接在编辑器中查看和探索大型机器学习数据集（CSV、JSON、Parquet 等），而不会导致 VS Code 在干净的 UI 中崩溃。
* [Bread WandB Viewer](https://github.com/Bread-Technologies/bread_wandb_viewer_extension) - VS Code 扩展，用于在 IDE 中查看权重和偏差实验、日志和工件，无需切换到 Web UI 并保持数据私密性。

<a name="books"></a>
## 书籍

* [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns) - 本书教您如何将机器学习模型从个人笔记本电脑转移到大型分布式集群中。您将探索成功的分布式机器学习系统背后的关键概念和模式，并直接从关键维护者和贡献者那里通过真实场景和实践项目学习 TensorFlow、Kubernetes、Kubeflow 和 Argo 工作流等技术。
...
* [Machine Learning Books for Beginners](https://www.appliedaicourse.com/blog/machine-learning-books/) - 该博客提供了一系列精选的介绍性书籍，帮助有抱负的机器学习专业人士掌握基本的机器学习概念和技术。
...
* [Pollinations.AI](https://pollinations.ai) - 免费、免注册的 API，用于生成文本、图像和音频，无需 API 密钥。提供与 OpenAI 兼容的接口和 React hooks，以便于集成。
* [Model Zoo](https://modelzoo.co/) - 发现开源深度学习代码和预训练模型。

## 制作人员

* 一些 python 库是从 [vinta](https://github.com/vinta/awesome-python) 剪切并粘贴的
* Go 的参考资料大部分是从 [gopherdata](https://github.com/gopherdata/resources/tree/master/tooling) 剪切并粘贴的
