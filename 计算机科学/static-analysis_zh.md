...
官方网站 [analysis-tools.dev](https://analysis-tools.dev/) 基于此存储库，并为每个工具添加了排名、用户评论和视频等其他资源。
...
| [阿达](#阿达) | [F#](#fsharp) | [Perl](#perl) |
| [组装](#asm) | [Fortran](#fortran) | [Python](#python) |
| [awk](#awk) | [走](#走) | [R](#r) |
| [C](#c) | [Groovy](#groovy) | [雷戈](#rego) |
| [C#](#csharp) | [哈斯克尔](#haskell) | [红宝石](#红宝石) |
| [C++](#cpp) | [哈克斯](#haxe) | [铁锈](#铁锈) |
| [Clojure](#clojure) | [Java](#java) | [SQL](#sql) |
| [CoffeeScript](#coffeescript) | [JavaScript](#javascript) | [Scala](#scala) |
| [ColdFusion](#coldfusion) | [朱莉娅](#朱莉娅) | [外壳](#shell) |
| [水晶](#crystal) | [科特林](#kotlin) | [斯威夫特](#斯威夫特)|
| [飞镖](#dart) | [Lua](#lua) | [Tcl](#tcl) |
| [德尔福](#delphi) | [MATLAB](#matlab) | [TypeScript](#typescript) |
| [Dlang](#dlang) | [尼姆](#尼姆) | [Verilog/SystemVerilog](#verilog) |
| [长生不老药](#长生不老药) | [Ocaml](#ocaml) | [Vim 脚本](#vim-script) |
| [榆树](#榆树) | [PHP](#php) | [WebAssembly](#wasm) |
...
| | | |
|---|---|---|
| [.env](#dotenv) | [嵌入式 Ruby（又名 ERB、eRuby）](#erb) | [普罗米修斯](#prometheus) |
| [Ansible](#ansible) | [小黄瓜](#小黄瓜) | [协议缓冲区](#protobuf) |
| [存档](#archive) | [HTML](#html) | [木偶](#puppet) |
| [Azure 资源管理器](#arm) | [JSON](#json) | [导轨](#rails) |
| [二进制文件](#binary) | [Kubernetes](#kubernetes) | [安全/先科](#安全) |
| [构建工具](#buildtool) | [乳胶](#乳胶) | [智能合约](#smart-contracts) |
| [CSS/SASS/SCSS](#css) | [Laravel](#laravel) | [支持](#support) |
| [配置文件](#configfile) | [Makefiles](#make) | [模板语言](#template) |
| [配置管理](#configmanagement) | [Markdown](#markdown) | [地形](#terraform) |
| [容器](#container) | [金属烧结](#meta) | [翻译](#translation) |
| [持续集成](#ci) | [移动](#mobile) | [Vue.js](#vue) |
| [德诺](#deno) | [尼克斯](#nix) | [写作](#写作) |
| [Dockerfile](#dockerfile) | [Node.js](#nodejs) | [YAML](#yaml) |
| [嵌入式](#embedded) | [包](#package) | [git](#git) |
